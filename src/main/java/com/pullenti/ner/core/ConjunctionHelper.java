...
public class ConjunctionHelper {
    ...
    public static ConjunctionToken tryParse(com.pullenti.ner.Token t) {
        ...
        if (tok != null) {
            ...
            return ConjunctionToken._new549(t, tok.getEndToken(), tok.termin.getCanonicText(), (ConjunctionType)tok.termin.tag);
        }
        if (!t.getMorphClassInDictionary().isConjunction()) 
            return null;
        if (t.isAnd() || t.isOr()) 
            return ConjunctionToken._new549(t, t, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, (t.isOr() ? ConjunctionType.OR : ConjunctionType.AND));

...
public class CityItemToken extends com.pullenti.ner.MetaToken {
            ...
            if (ci0 == null) {
                ...
                if (ci.typ == ItemType.NOUN && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, false, false)) {
                    ...
                    if ((br != null && (br.getLengthChar() < 50) && t.getNext().chars.isCyrillicLetter()) && !t.getNext().chars.isAllLower()) {
                        ci0 = _new1123(br.getBeginToken(), br.getEndToken(), ItemType.PROPERNAME);
        ...
        if ((prev != null && prev.typ == ItemType.NOUN && m_Recursive == 0) && ((com.pullenti.unisharp.Utils.stringsNe(prev.value, "ГОРОД") && com.pullenti.unisharp.Utils.stringsNe(prev.value, "МІСТО")))) {
            if (res == null || ((res.typ != ItemType.NOUN && res.typ != ItemType.MISC && res.typ != ItemType.CITY))) {
                ...
                if (det != null) {
                    ...
                    if (cou < 6) {
                        CityItemToken re = _new1123(det.getBeginToken(), det.getEndToken(), ItemType.PROPERNAME);
        ...
        if (res == null) {
            ...
            if (geoPrev != null || MiscLocationHelper.checkNearBefore(t.getPrevious()) != null) 
                ...
                if ((tt instanceof com.pullenti.ner.TextToken) && !tt.chars.isAllLower()) {
                    if (MiscLocationHelper.checkGeoObjectAfter(tt)) 
                        ooo = true;
                }
            }
            if (ooo) {
                ...
                if (tt instanceof com.pullenti.ner.TextToken) {
                    ...
                    if (tt.chars.isAllLower() && (((com.pullenti.unisharp.Utils.stringsEq(txt, "Д") || com.pullenti.unisharp.Utils.stringsEq(txt, "С") || com.pullenti.unisharp.Utils.stringsEq(txt, "C")) || com.pullenti.unisharp.Utils.stringsEq(txt, "П") || com.pullenti.unisharp.Utils.stringsEq(txt, "Х")))) {
                        ...
                        if (ok) {
                            res = _new1125(tt0, tt1, ItemType.NOUN, true);
                    ...
                    if ((com.pullenti.unisharp.Utils.stringsEq(txt, "СП") || com.pullenti.unisharp.Utils.stringsEq(txt, "РП") || com.pullenti.unisharp.Utils.stringsEq(txt, "ГП")) || com.pullenti.unisharp.Utils.stringsEq(txt, "ДП")) {
                        ...
                        if (tt.getNext() != null && tt.getNext().chars.isCapitalUpper()) 
                            return _new1126(tt0, tt, ItemType.NOUN, true, (com.pullenti.unisharp.Utils.stringsEq(txt, "РП") ? "РАБОЧИЙ ПОСЕЛОК" : ((com.pullenti.unisharp.Utils.stringsEq(txt, "ГП") ? "ГОРОДСКОЕ ПОСЕЛЕНИЕ" : ((com.pullenti.unisharp.Utils.stringsEq(txt, "ДП") ? "ДАЧНЫЙ ПОСЕЛОК" : "СЕЛЬСКОЕ ПОСЕЛЕНИЕ"))))));
                    }
                    ...
                    if (tt.chars.isAllUpper() && tt.getLengthChar() > 2 && tt.chars.isCyrillicLetter()) 
                        return _new1127(tt, tt, ItemType.PROPERNAME, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term);
                }
            }
            if ((t instanceof com.pullenti.ner.NumberToken) && t.getNext() != null) {
                ...
                if (net != null && net.exTyp == com.pullenti.ner.core.NumberExType.KILOMETER) 
                    return _new1127(t, net.getEndToken(), ItemType.PROPERNAME, ((((Integer)((int)net.getRealValue())).toString()) + "КМ"));
            }
            ...
            if ((rt != null && (rt.referent instanceof com.pullenti.ner.geo.GeoReferent) && rt.getBeginToken() == rt.getEndToken()) && (((com.pullenti.ner.geo.GeoReferent)com.pullenti.unisharp.Utils.cast(rt.referent, com.pullenti.ner.geo.GeoReferent.class))).isState()) {
                ...
                if (t.getPrevious().getMorph().getNumber() == com.pullenti.morph.MorphNumber.SINGULAR && t.getMorph().getCase().isNominative() && !t.getMorph().getCase().isGenitive()) 
                    return _new1127(t, t, ItemType.PROPERNAME, rt.getSourceText().toUpperCase());
            }
            return null;
        }
        if (res.typ == ItemType.NOUN) {
    ...
    private static CityItemToken _TryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection loc, boolean canBeLowChar, CityItemToken prev) {
            ...
            if ((t instanceof com.pullenti.ner.ReferentToken) && (t.getReferent() instanceof com.pullenti.ner.date.DateReferent)) {
                ...
                if (aii != null) {
                    if (aii.size() > 1 && aii.get(0).typ == com.pullenti.ner.address.internal.StreetItemType.NUMBER && aii.get(1).typ == com.pullenti.ner.address.internal.StreetItemType.STDNAME) {
                        CityItemToken res2 = _new1123(t, aii.get(1).getEndToken(), ItemType.PROPERNAME);
                ...
                for (com.pullenti.ner.core.IntOntologyToken nt : li) {
                    if (nt.item != null && com.pullenti.unisharp.Utils.stringsEq(nt.item.getCanonicText(), tt.term)) {
                        if (canBeLowChar || !com.pullenti.ner.core.MiscHelper.isAllCharactersLower(nt.getBeginToken(), nt.getEndToken(), false)) {
                            CityItemToken ci = _new1131(nt.getBeginToken(), nt.getEndToken(), ItemType.CITY, nt.item, nt.getMorph());
            ...
            if (li != null) {
                for (com.pullenti.ner.core.IntOntologyToken nt : li) {
                    if (nt.item == null) {
                        ...
                        CityItemToken ci = _new1133(nt.getBeginToken(), nt.getEndToken(), ty, nt.getMorph());
        ...
        if (com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "СПБ") && !t.chars.isAllLower() && m_StPeterburg != null) 
            return _new1134(t, t, ItemType.CITY, m_StPeterburg, m_StPeterburg.getCanonicText());
        ...
        if (k > 0) {
            if (k > 2) 
                return null;
            CityItemToken reee = _new1135(t, t1, ItemType.PROPERNAME, name.toString(), doubt);
            if (altname != null) 
        ...
        if ((npt != null && npt.getEndToken() != t && npt.adjectives.size() > 0) && !npt.adjectives.get(0).getEndToken().getNext().isComma()) {
            ...
            if (cit != null && cit.typ == ItemType.NOUN && ((com.pullenti.morph.LanguageHelper.endsWithEx(cit.value, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК") || t.getNext().isValue("ГОРОДОК", null)))) 
                return _new1136(t, t, ItemType.CITY, t.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
            else {
                ...
                if (npt1 == null || npt1.adjectives.size() == 0) {
                    ...
                    if (si == null || si.typ != com.pullenti.ner.address.internal.StreetItemType.NOUN) {
                        ...
                        return _new1137(t, t1, ItemType.PROPERNAME, npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), doubt, npt.getMorph());
                    }
                }
            }
        }
            ...
            if (ok && (t.getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if (ok1) {
                    ...
                    if (tne != null && tne.typ == ItemType.NOUN) {
                        ...
                        t1 = t.getNext();
                        return _new1138(t, t1, ItemType.PROPERNAME, name.toString(), (altname == null ? null : altname.toString()), doubt, t.getNext().getMorph());
                    }
                }
            }
        }
        ...
        if (com.pullenti.ner.core.MiscHelper.isEngArticle(t)) 
            return null;
        CityItemToken res = _new1138(t, t1, ItemType.PROPERNAME, name.toString(), (altname == null ? null : altname.toString()), doubt, t.getMorph());
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("ГОРОД-ГЕРОЙ", "ГОРОД");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("МІСТО-ГЕРОЙ", com.pullenti.morph.MorphLang.UA, "МІСТО");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("ГОРОД-КУРОРТ", "ГОРОД");
        t.addAbridge("Г.К.");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("МІСТО-КУРОРТ", com.pullenti.morph.MorphLang.UA, "МІСТО");
        t.addAbridge("М.К.");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new143("ПОСЕЛКОВОЕ ПОСЕЛЕНИЕ", "ПОСЕЛОК", ItemType.NOUN);
        m_Ontology.add(t);
        ...
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("СТОЛИЦА", "ГОРОД");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("СТОЛИЦЯ", com.pullenti.morph.MorphLang.UA, "МІСТО");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        ...
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("РАЙОННЫЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("РАЙОННИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("ГОРОДСКОЙ ОКРУГ", "НАСЕЛЕННЫЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("МІСЬКИЙ ОКРУГ", com.pullenti.morph.MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1106("ОБЛАСТНОЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new1141("ОБЛАСНИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ");
        t.tag = ItemType.NOUN;
        m_Ontology.add(t);
        ...
        for (String s : new String[] {"ЖИТЕЛЬ", "МЭР"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new119(s, ItemType.MISC));
        }
        for (String s : new String[] {"ЖИТЕЛЬ", "МЕР"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new457(s, com.pullenti.morph.MorphLang.UA, ItemType.MISC));
        }
        t = com.pullenti.ner.core.Termin._new119("АДМИНИСТРАЦИЯ", ItemType.MISC);
        t.addAbridge("АДМ.");
        m_Ontology.add(t);
    ...
    private static void loadBigCity(org.w3c.dom.Node xml) {
        ...
        if (!com.pullenti.unisharp.Utils.isNullOrEmpty(adj)) {
            ...
            if (spb) 
                cityAdj.add(com.pullenti.ner.core.Termin._new457(adj.substring(6), lang, ci));
        }
    }
    ...
    public static CityItemToken _new1123(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static CityItemToken _new1125(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, boolean _arg4) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static CityItemToken _new1126(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, boolean _arg4, String _arg5) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.geoObjectBefore = _arg4;
        res.value = _arg5;
    ...
    public static CityItemToken _new1127(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static CityItemToken _new1131(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.core.IntOntologyItem _arg4, com.pullenti.ner.MorphCollection _arg5) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ontoItem = _arg4;
        res.setMorph(_arg5);
    ...
    public static CityItemToken _new1133(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static CityItemToken _new1134(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.core.IntOntologyItem _arg4, String _arg5) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ontoItem = _arg4;
        res.value = _arg5;
    ...
    public static CityItemToken _new1135(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, boolean _arg5) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.doubtful = _arg5;
    ...
    public static CityItemToken _new1136(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static CityItemToken _new1137(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, boolean _arg5, com.pullenti.ner.MorphCollection _arg6) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.doubtful = _arg5;
    ...
    public static CityItemToken _new1138(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, String _arg5, boolean _arg6, com.pullenti.ner.MorphCollection _arg7) {
        CityItemToken res = new CityItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.altValue = _arg5;

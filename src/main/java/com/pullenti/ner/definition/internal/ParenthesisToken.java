...
public class ParenthesisToken extends com.pullenti.ner.MetaToken {
    ...
    public static ParenthesisToken tryAttach(com.pullenti.ner.Token t) {
        ...
        if (t1 != null) {
            ...
            if (r != null) {
                ParenthesisToken res = _new1105(t, t1, r);
    ...
    public static ParenthesisToken _new1105(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3) {

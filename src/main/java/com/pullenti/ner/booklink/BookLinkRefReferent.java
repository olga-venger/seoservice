...
public class BookLinkRefReferent extends com.pullenti.ner.Referent {
    ...
    public static Integer getNumberDiff(com.pullenti.ner.Referent r1, com.pullenti.ner.Referent r2) {
        ...
        int n1;
        int n2;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapn1400 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres401 = com.pullenti.unisharp.Utils.parseInteger(num1, 0, null, wrapn1400);
        com.pullenti.unisharp.Outargwrapper<Integer> wrapn2402 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres403 = com.pullenti.unisharp.Utils.parseInteger(num2, 0, null, wrapn2402);
        n1 = (wrapn1400.value != null ? wrapn1400.value : 0);
        n2 = (wrapn2402.value != null ? wrapn2402.value : 0);
        if (!inoutres401 || !inoutres403) 
            return null;
        return n2 - n1;
    }

    public static BookLinkRefReferent _new391(com.pullenti.ner.Referent _arg1) {

...
public class KeywordAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext(),cur++) {
            ...
            if (npt == null) {
                ...
                if (mc.isVerb() && !mc.isPreposition()) {
                    ...
                    if (t.isValue("МОЧЬ", null) || t.isValue("WOULD", null)) 
                        continue;
                    KeywordReferent kref = KeywordReferent._new1573(KeywordType.PREDICATE);
                    ...
                    com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new738(ad.registerReferent(kref), t, t, t.getMorph());
                    kit.embedToken(rt1);
                    t = rt1;
                    continue;
                }
            ...
            for (com.pullenti.ner.Token tt = t; tt != null && tt.endChar <= npt.endChar; tt = tt.getNext()) {
                ...
                KeywordReferent kref = KeywordReferent._new1573(KeywordType.OBJECT);
                ...
                kref = (KeywordReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(kref), KeywordReferent.class);
                _setRank(kref, cur, max);
                com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new738(kref, tt, tt, tt.getMorph());
                kit.embedToken(rt1);
                if (tt == t && li.size() == 0) 
                    t0 = rt1;
                t = rt1;
            ...
            if (li.size() > 1) {
                ...
                kref = (KeywordReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(kref), KeywordReferent.class);
                _setRank(kref, cur, max);
                com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new738(kref, t0, t, npt.getMorph());
                kit.embedToken(rt1);
                t = rt1;
            }
        }
        ...
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext(),cur++) {
            ...
            com.pullenti.ner.ReferentToken rt1 = com.pullenti.ner.ReferentToken._new738(kwUn, t, t1, t.getMorph());
            kit.embedToken(rt1);
            t = rt1;
        }
    ...
    private com.pullenti.ner.Token _addReferents(com.pullenti.ner.core.AnalyzerData ad, com.pullenti.ner.Token t, int cur, int max) {
        ...
        if (r instanceof com.pullenti.ner.denomination.DenominationReferent) {
            ...
            KeywordReferent kref0 = KeywordReferent._new1573(KeywordType.REFERENT);
        ...
        if (r instanceof com.pullenti.ner.money.MoneyReferent) {
            ...
            KeywordReferent kref0 = KeywordReferent._new1573(KeywordType.OBJECT);
        ...
        KeywordReferent kref = KeywordReferent._new1573(KeywordType.REFERENT);
        String norm = null;

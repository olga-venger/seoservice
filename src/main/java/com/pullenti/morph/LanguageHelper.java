...
public class LanguageHelper {
    ...
    public static MorphCase getCaseAfterPreposition(String prep) {
        MorphCase mc;
        com.pullenti.unisharp.Outargwrapper<MorphCase> wrapmc45 = new com.pullenti.unisharp.Outargwrapper<MorphCase>();
        boolean inoutres46 = com.pullenti.unisharp.Utils.tryGetValue(m_PrepCases, prep, wrapmc45);
        mc = wrapmc45.value;
        if (inoutres46) 
            return mc;
        else 
    ...
    public static String normalizePreposition(String prep) {
        String res;
        com.pullenti.unisharp.Outargwrapper<String> wrapres47 = new com.pullenti.unisharp.Outargwrapper<String>();
        boolean inoutres48 = com.pullenti.unisharp.Utils.tryGetValue(m_PrepNorms, prep, wrapres47);
        res = wrapres47.value;
        if (inoutres48) 
            return res;
        else 

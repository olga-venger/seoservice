...
public class MiscLocationHelper {
    ...
    public static com.pullenti.ner.geo.GeoReferent getGeoReferentByName(String name) {
        ...
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.geo.GeoReferent> wrapres1157 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.geo.GeoReferent>();
        boolean inoutres1158 = com.pullenti.unisharp.Utils.tryGetValue(m_GeoRefByName, name, wrapres1157);
    ...
    public static com.pullenti.ner.MetaToken tryAttachNordWest(com.pullenti.ner.Token t) {
        ...
        if (tok == null) 
            return null;
        com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new572(t, t, t.getMorph());

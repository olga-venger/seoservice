...
public class SentimentReferent extends com.pullenti.ner.Referent {
    ...
    public int getCoef() {
        ...
        if (val == null) 
            return 0;
        int i;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapi2625 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres2626 = com.pullenti.unisharp.Utils.parseInteger(val, 0, null, wrapi2625);
        i = (wrapi2625.value != null ? wrapi2625.value : 0);
        if (!inoutres2626) 
            return 0;
        return i;
    }

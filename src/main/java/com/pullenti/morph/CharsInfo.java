...
public class CharsInfo {
    ...
    public static CharsInfo _new2309(boolean _arg1) {
        CharsInfo res = new CharsInfo(null);
        res.setCapitalUpper(_arg1);
        return res;
    }

    public static CharsInfo _new2484(boolean _arg1) {
        CharsInfo res = new CharsInfo(null);
        res.setCyrillicLetter(_arg1);
        return res;
    }

    public static CharsInfo _new2490(boolean _arg1, boolean _arg2) {
        CharsInfo res = new CharsInfo(null);
        res.setCyrillicLetter(_arg1);
    ...
    public static CharsInfo _new2495(boolean _arg1, boolean _arg2, boolean _arg3, boolean _arg4) {
        CharsInfo res = new CharsInfo(null);
        res.setCapitalUpper(_arg1);
    ...
    public static CharsInfo _new2518(boolean _arg1) {
        CharsInfo res = new CharsInfo(null);
        res.setLatinLetter(_arg1);
        return res;
    }

    public static CharsInfo _new2793(short _arg1) {
        CharsInfo res = new CharsInfo(null);
        res.value = _arg1;
        return res;
    }

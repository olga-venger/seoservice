...
public class ShortNameHelper {
    ...
    public static class ShortnameVar {
        ...
        public static ShortnameVar _new2536(String _arg1, com.pullenti.morph.MorphGender _arg2) {
    ...
    public static java.util.ArrayList<ShortnameVar> getNamesForShortname(String shortname) {
        ...
        com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>> wrapres2534 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>>();
        boolean inoutres2535 = com.pullenti.unisharp.Utils.tryGetValue(m_Shorts_Names, shortname, wrapres2534);
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                if (t.isNewlineBefore()) {
                    ...
                    for (String s : shos) {
                        ...
                        com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>> wrapli2537 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<ShortnameVar>>();
                        boolean inoutres2538 = com.pullenti.unisharp.Utils.tryGetValue(m_Shorts_Names, s, wrapli2537);
                        li = wrapli2537.value;
                        if (!inoutres2538) 
                            m_Shorts_Names.put(s, (li = new java.util.ArrayList<ShortnameVar>()));
                        li.add(ShortnameVar._new2536(nam, g));
                    }
                    if (t == null) 
                        break;
                    t = t.getPrevious();

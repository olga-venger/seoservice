...
public class BookLinkAnalyzer extends com.pullenti.ner.Analyzer {
        ...
        try {
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                if (re.getNumber() != null) {
                    ...
                    boolean inoutres388 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, re.getNumber(), wrapli387);
                    li = wrapli387.value;
                    if (!inoutres388) 
            ...
            for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
                ...
                java.util.ArrayList<BookLinkRefReferent> li;
                com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>> wrapli389 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<BookLinkRefReferent>>();
                boolean inoutres390 = com.pullenti.unisharp.Utils.tryGetValue(refsByNum, (String)com.pullenti.unisharp.Utils.notnull(re.getNumber(), ""), wrapli389);
                li = wrapli389.value;
                if (!inoutres390) 
                    continue;
                int i;
    ...
    private static java.util.ArrayList<com.pullenti.ner.ReferentToken> tryParse(com.pullenti.ner.Token t, boolean isInLit, int maxChar) throws NumberFormatException {
        ...
        String nextNum = null;
        int nn;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnn395 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres396 = com.pullenti.unisharp.Utils.parseInteger((num != null ? num : ""), 0, null, wrapnn395);
        nn = (wrapnn395.value != null ? wrapnn395.value : 0);
        if (inoutres396) 
        ...
        if (tn1 == null && startOfName == null) {
            if (isElectrRes) {
                ...
                BookLinkRefReferent bref0 = BookLinkRefReferent._new391(uriRe);
                if (num != null) 
                    bref0.setNumber(num);
            ...
            if (decree != null && num != null) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                BookLinkRefReferent bref0 = BookLinkRefReferent._new391(decree.getReferent());
                if (num != null) 
                    bref0.setNumber(num);
            ...
            if (bookPrev != null) {
                ...
                if (blt0 != null && blt0.typ == com.pullenti.ner.booklink.internal.BookLinkTyp.PAGERANGE) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> rts0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    BookLinkRefReferent bref0 = BookLinkRefReferent._new391(bookPrev);
                    if (num != null) 
                        bref0.setNumber(num);
        ...
        BookLinkRefReferent bref = BookLinkRefReferent._new391(res);
        if (num != null) 
            bref.setNumber(num);

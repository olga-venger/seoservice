...
public class Processor implements AutoCloseable {
    ...
    public Analyzer findAnalyzer(String name) {
        Analyzer a;
        com.pullenti.unisharp.Outargwrapper<Analyzer> wrapa2803 = new com.pullenti.unisharp.Outargwrapper<Analyzer>();
        boolean inoutres2804 = com.pullenti.unisharp.Utils.tryGetValue(m_AnalyzersHash, (name != null ? name : ""), wrapa2803);
        a = wrapa2803.value;
        if (!inoutres2804) 
            return null;
        else 
    ...
    public void processNext(AnalysisResult ar) {
        if (ar == null) 
            return;
        com.pullenti.ner.core.AnalysisKit kit = com.pullenti.ner.core.AnalysisKit._new2805(this, ar.ontology);
        kit.initFrom(ar);
    ...
    public AnalysisResult _process(SourceOfAnalysis text, boolean noEntitiesRegine, boolean noLog, ExtOntology extOntology, com.pullenti.morph.MorphLang lang) {
        ...
        com.pullenti.ner.core.AnalysisKit kit = com.pullenti.ner.core.AnalysisKit._new2806(text, false, lang, _ProgressChangedEventHandler_OnProgressHandler, extOntology, this);
    ...
    private void prepareProgress() {
        synchronized (m_ProgressPeacesLock) {
            ...
            max /= ((float)total);
            m_ProgressPeaces.put(this, com.pullenti.ner.core.internal.ProgressPeace._new2807(0.0F, max));
            for (Analyzer wf : getAnalyzers()) {
                float min = max;
                ...
                if (!m_ProgressPeaces.containsKey(wf)) 
                    m_ProgressPeaces.put(wf, com.pullenti.ner.core.internal.ProgressPeace._new2807(min, max));
            }
        }
    }
    ...
    private void onProgressHandler(Object sender, com.pullenti.unisharp.ProgressEventArgs e) {
        ...
        if (e.getProgressPercentage() >= 0) {
            ...
            synchronized (m_ProgressPeacesLock) {
                com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.internal.ProgressPeace> wrappi2809 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.internal.ProgressPeace>();
                boolean inoutres2810 = com.pullenti.unisharp.Utils.tryGetValue(m_ProgressPeaces, (sender != null ? sender : this), wrappi2809);
                pi = wrappi2809.value;
                if (inoutres2810) {
    ...
    public void manageReferentLinks() {
        if (m_Refs != null) {
            for (ProxyReferent pr : m_Refs) {
                Referent r;
                com.pullenti.unisharp.Outargwrapper<Referent> wrapr2813 = new com.pullenti.unisharp.Outargwrapper<Referent>();
                boolean inoutres2814 = com.pullenti.unisharp.Utils.tryGetValue(m_Links2, pr.identity, wrapr2813);
                r = wrapr2813.value;
                if (pr.identity != null && m_Links2 != null && inoutres2814) 
                    pr.ownerReferent.uploadSlot(pr.ownerSlot, r);
                else {
                    com.pullenti.unisharp.Outargwrapper<Referent> wrapr2811 = new com.pullenti.unisharp.Outargwrapper<Referent>();
                    boolean inoutres2812 = com.pullenti.unisharp.Utils.tryGetValue(m_Links, pr.value, wrapr2811);
                    r = wrapr2811.value;
                    if (m_Links != null && inoutres2812) 
                        pr.ownerReferent.uploadSlot(pr.ownerSlot, r);
                    else {
                    }
                }
        ...
        try {
            ...
            for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.getChildNodes())).arr) {
                ...
                if (att != null && com.pullenti.unisharp.Utils.stringsEq(att.getNodeValue(), "true")) {
                    ProxyReferent pr = ProxyReferent._new2815(x.getTextContent(), res);
                ...
                if ((((att = com.pullenti.unisharp.Utils.getXmlAttrByName(x.getAttributes(), "count")))) != null) {
                    int cou;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapcou2816 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    boolean inoutres2817 = com.pullenti.unisharp.Utils.parseInteger(att.getNodeValue(), 0, null, wrapcou2816);
                    cou = (wrapcou2816.value != null ? wrapcou2816.value : 0);
                    if (inoutres2817) 
                        slot.setCount(cou);
                }
            }

...
public class RepositoryBase implements AutoCloseable {
    ...
    public void initialize() {
        ...
        sw.stop();
        this._sendMessage(("Load " + m_Refs.size() + " model by " + ((int)sw.getElapsedMilliseconds()) + "ms"), false);
    }
    ...
    public java.util.ArrayList<RepositoryItem> getOutgoingItems(int itemId) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wrapr2590 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
        boolean inoutres2591 = com.pullenti.unisharp.Utils.tryGetValue(m_Refs, itemId, wrapr2590);
        r = wrapr2590.value;
        if (!inoutres2591) 
            return null;
    ...
    public java.util.ArrayList<RepositoryItem> getIncomingItems(int itemId) throws Exception, javax.xml.stream.XMLStreamException {
        com.pullenti.ner.Referent r;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wrapr2592 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
        boolean inoutres2593 = com.pullenti.unisharp.Utils.tryGetValue(m_Refs, itemId, wrapr2592);
        r = wrapr2592.value;
        if (!inoutres2593) 
            return null;
        java.util.ArrayList<RepositoryItem> res = null;
    ...
    public void saveReferents(java.util.Collection<RepositoryInputItem> input) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        for (com.pullenti.ner.Referent r : refs4load) {
            ...
            com.pullenti.unisharp.Outargwrapper<Boolean> wraphasGenerals2594 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
            com.pullenti.ner.Referent exRef = this._findExistReferent(r, wraphasGenerals2594);
            hasGenerals = (wraphasGenerals2594.value != null ? wraphasGenerals2594.value : false);
            RepositoryItem ri;
            if (exRef != null) {
        ...
        sw.stop();
        this._sendMessage(("Manage " + input.size() + " input model -> " + res.size() + " items by " + ((int)sw.getElapsedMilliseconds()) + "ms"), false);
    }
    ...
    public java.util.ArrayList<RepositoryItem> findItems(com.pullenti.ner.Referent referent, boolean includeGenerals) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapdi2597 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
        boolean inoutres2598 = com.pullenti.unisharp.Utils.tryGetValue(m_RefsHash, referent.getTypeName(), wrapdi2597);
        di = wrapdi2597.value;
        if (!inoutres2598) 
            return null;
        ...
        for (String s : strs) {
            ...
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2595 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
            boolean inoutres2596 = com.pullenti.unisharp.Utils.tryGetValue(di, s, wrapli2595);
            li = wrapli2595.value;
            if (!inoutres2596) 
                continue;
    ...
    private RepositoryItem _getItem(com.pullenti.ner.Referent r, java.util.ArrayList<RepositoryItemSample> samples, Object addData) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        RepositoryItem res;
        if (id > 0) {
            com.pullenti.unisharp.Outargwrapper<RepositoryItem> wrapres2599 = new com.pullenti.unisharp.Outargwrapper<RepositoryItem>();
            boolean inoutres2600 = com.pullenti.unisharp.Utils.tryGetValue(m_Items, id, wrapres2599);
            res = wrapres2599.value;
            if (inoutres2600) 
                return res;
            res = this.getItem(id);
            if (res == null) {
    ...
    private void _addReferent(com.pullenti.ner.Referent r) {
        ...
        com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapdi2605 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
        boolean inoutres2606 = com.pullenti.unisharp.Utils.tryGetValue(m_RefsHash, r.getTypeName(), wrapdi2605);
        di = wrapdi2605.value;
        if (!inoutres2606) 
        ...
        for (String s : r.getCompareStrings()) {
            java.util.ArrayList<com.pullenti.ner.Referent> li;
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2601 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
            boolean inoutres2602 = com.pullenti.unisharp.Utils.tryGetValue(di, s, wrapli2601);
            li = wrapli2601.value;
            if (!inoutres2602) 
        ...
        if (r.repositoryItemId > 0) {
            ...
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wraprr2603 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
            boolean inoutres2604 = com.pullenti.unisharp.Utils.tryGetValue(m_Refs, r.repositoryItemId, wraprr2603);
            rr = wraprr2603.value;
            if (!inoutres2604) 
                m_Refs.put(r.repositoryItemId, r);
            else if (r != rr) 
                this._sendMessage(("Id=" + r.repositoryItemId + " has 2 model: (" + r.toString() + ") and (" + rr.toString() + ")"), true);
        }
    }

    private void _RemoveReferent(com.pullenti.ner.Referent r) {
        java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> di = null;
        com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapdi2609 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
        boolean inoutres2610 = com.pullenti.unisharp.Utils.tryGetValue(m_RefsHash, r.getTypeName(), wrapdi2609);
        di = wrapdi2609.value;
        if (!inoutres2610) 
            return;
        for (String s : r.getCompareStrings()) {
            java.util.ArrayList<com.pullenti.ner.Referent> li;
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2607 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
            boolean inoutres2608 = com.pullenti.unisharp.Utils.tryGetValue(di, s, wrapli2607);
            li = wrapli2607.value;
            if (inoutres2608) {
                if (li.contains(r)) 
                    li.remove(r);
    ...
    private com.pullenti.ner.Referent _findReferentById(int id) {
        com.pullenti.ner.Referent r;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wrapr2611 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
        boolean inoutres2612 = com.pullenti.unisharp.Utils.tryGetValue(m_Refs, id, wrapr2611);
        r = wrapr2611.value;
        if (inoutres2612) 
            return r;
        return null;
    ...
    private com.pullenti.ner.Referent _findExistReferent(com.pullenti.ner.Referent r, com.pullenti.unisharp.Outargwrapper<Boolean> hasGenerals) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> di;
        com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapdi2615 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
        boolean inoutres2616 = com.pullenti.unisharp.Utils.tryGetValue(m_RefsHash, r.getTypeName(), wrapdi2615);
        di = wrapdi2615.value;
        if (!inoutres2616) 
            return null;
        java.util.ArrayList<com.pullenti.ner.Referent> res = new java.util.ArrayList<com.pullenti.ner.Referent>();
        ...
        for (String s : strs) {
            java.util.ArrayList<com.pullenti.ner.Referent> li;
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2613 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
            boolean inoutres2614 = com.pullenti.unisharp.Utils.tryGetValue(di, s, wrapli2613);
            li = wrapli2613.value;
            if (!inoutres2614) 
                continue;
            if (li.size() > 100) {
    ...
    private void _updateGenerals(RepositoryItem ri) throws Exception, javax.xml.stream.XMLStreamException {
        java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> di;
        com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapdi2619 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
        boolean inoutres2620 = com.pullenti.unisharp.Utils.tryGetValue(m_RefsHash, ri.referent.getTypeName(), wrapdi2619);
        di = wrapdi2619.value;
        if (!inoutres2620) 
            return;
        ...
        for (String s : strs) {
            java.util.ArrayList<com.pullenti.ner.Referent> li;
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2617 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
            boolean inoutres2618 = com.pullenti.unisharp.Utils.tryGetValue(di, s, wrapli2617);
            li = wrapli2617.value;
            if (!inoutres2618) 
                continue;
            for (com.pullenti.ner.Referent rr : li) {
    ...
    private void _mergeEntities(java.util.ArrayList<com.pullenti.ner.Referent> res, int level, boolean remove) throws Exception, javax.xml.stream.XMLStreamException {
        ...
        if (baseItem == null) 
            return;
        this._sendMessage(("Merge equal " + res.size() + " model:"), false);
    ...
    private void _sendMessage(String msg, boolean err) {
        ...
        if (messageOccured.size() > 0) 
            for(int iiid = 0; iiid < messageOccured.size(); iiid++) messageOccured.get(iiid).call(this, RepositoryMessageArgs._new2621(msg, err));
    }

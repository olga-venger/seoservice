...
public class DateReferent extends com.pullenti.ner.Referent {
    ...
    public static DateReferent _new721(DateReferent _arg1, int _arg2) {
    ...
    public static DateReferent _new722(int _arg1, int _arg2) {
        DateReferent res = new DateReferent();
        res.setMonth(_arg1);
        res.setDay(_arg2);
        return res;
    ...
    public static DateReferent _new723(int _arg1) {
        DateReferent res = new DateReferent();
        res.setYear(_arg1);
        return res;
    }

    public static DateReferent _new726(int _arg1, int _arg2) {
        DateReferent res = new DateReferent();
        res.setHour(_arg1);
        res.setMinute(_arg2);
        return res;
    ...
    public static DateReferent _new727(DatePointerType _arg1) {
        DateReferent res = new DateReferent();
        res.setPointer(_arg1);
        return res;
    }

    public static DateReferent _new739(int _arg1, DateReferent _arg2) {
        DateReferent res = new DateReferent();
        res.setMonth(_arg1);
        res.setHigher(_arg2);
        return res;
    ...
    public static DateReferent _new744(int _arg1, DateReferent _arg2) {
        DateReferent res = new DateReferent();
        res.setDay(_arg1);
        res.setHigher(_arg2);
        return res;
    ...
    public static DateReferent _new761(int _arg1) {
        DateReferent res = new DateReferent();
        res.setCentury(_arg1);
        return res;
    }

    public static DateReferent _new767(int _arg1) {
        DateReferent res = new DateReferent();
        res.setDay(_arg1);
        return res;
    }

    public static DateReferent _new769(DateReferent _arg1) {
        DateReferent res = new DateReferent();
        res.setHigher(_arg1);
        return res;
    }

    public static DateReferent _new770(DateReferent _arg1, int _arg2) {
        DateReferent res = new DateReferent();
        res.setHigher(_arg1);
        res.setMonth(_arg2);
        return res;
    ...
    public static DateReferent _new779(int _arg1) {
        DateReferent res = new DateReferent();

...
public class GeneralRelationHelper {
    ...
    public static void refreshGenerals(com.pullenti.ner.Processor proc, com.pullenti.ner.core.AnalysisKit kit) {
        ...
        for (com.pullenti.ner.Analyzer a : proc.getAnalyzers()) {
            ...
            for (com.pullenti.ner.Referent r : ad.getReferents()) {
                Node nod = Node._new464(r, ad);
                allRefs.add(nod);
                r.setTag(nod);
                java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>> si;
                com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>> wrapsi467 = new com.pullenti.unisharp.Outargwrapper<java.util.HashMap<String, java.util.ArrayList<com.pullenti.ner.Referent>>>();
                boolean inoutres468 = com.pullenti.unisharp.Utils.tryGetValue(all, a.getName(), wrapsi467);
                si = wrapsi467.value;
                if (!inoutres468) 
                ...
                for (String s : strs) {
                    ...
                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli465 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                    boolean inoutres466 = com.pullenti.unisharp.Utils.tryGetValue(si, s, wrapli465);
                    li = wrapli465.value;
                    if (!inoutres466) 
    ...
    public static class Node {
        ...
        public static Node _new464(com.pullenti.ner.Referent _arg1, com.pullenti.ner.core.AnalyzerData _arg2) {
            Node res = new Node();
            res.ref = _arg1;
            res.ad = _arg2;
            return res;

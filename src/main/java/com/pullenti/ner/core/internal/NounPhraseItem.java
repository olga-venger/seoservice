...
public class NounPhraseItem extends com.pullenti.ner.MetaToken {
        ...
        for (com.pullenti.morph.MorphBaseInfo it : getMorph().getItems()) {
            ...
            if (singleNumber && v.singleNumberValue != null) {
                if (mc != null && ((gender == com.pullenti.morph.MorphGender.NEUTER || gender == com.pullenti.morph.MorphGender.FEMINIE)) && mc.isAdjective()) {
                    com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new469(new com.pullenti.morph.MorphClass(mc), gender, com.pullenti.morph.MorphNumber.SINGULAR, com.pullenti.morph.MorphCase.NOMINATIVE, this.getMorph().getLanguage());
            ...
            if (Character.isDigit(v.normalValue.charAt(0)) && mc != null && mc.isAdjective()) {
                int val;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapval470 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres471 = com.pullenti.unisharp.Utils.parseInteger(v.normalValue, 0, null, wrapval470);
                val = (wrapval470.value != null ? wrapval470.value : 0);
                if (inoutres471) {
    ...
    public static NounPhraseItem tryParse(com.pullenti.ner.Token t, java.util.ArrayList<NounPhraseItem> items, com.pullenti.ner.core.NounPhraseParseAttr attrs) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            NounPhraseItem it = _new472(t0, t, _canBeSurname);
            ...
            for (com.pullenti.morph.MorphBaseInfo v : t.getMorph().getItems()) {
                ...
                if (_canBeNoun) {
                    ...
                    else if ((items != null && items.size() > 1 && (((attrs.value()) & (com.pullenti.ner.core.NounPhraseParseAttr.MULTINOUNS.value()))) != (com.pullenti.ner.core.NounPhraseParseAttr.NO.value())) && (((v.getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) == (com.pullenti.morph.MorphNumber.PLURAL.value())) {
                        boolean ok1 = true;
    ...
    public boolean tryAccordVar(com.pullenti.morph.MorphBaseInfo v, boolean multinouns) {
        for (NounPhraseItemTextVar vv : adjMorph) {
            if (vv.checkAccord(v, false, multinouns)) {
                if (multinouns) {
                    if ((((vv.getNumber().value()) & (com.pullenti.morph.MorphNumber.SINGULAR.value()))) == (com.pullenti.morph.MorphNumber.UNDEFINED.value())) 
                        continue;
                    if ((((v.getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) == (com.pullenti.morph.MorphNumber.UNDEFINED.value())) 
                        continue;
                }
                return true;
            }
    ...
    public static NounPhraseItem _new472(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {

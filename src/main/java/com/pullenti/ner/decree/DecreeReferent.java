...
public class DecreeReferent extends com.pullenti.ner.Referent {
    ...
    private java.util.ArrayList<Integer> _allYears() {
        ...
        for (com.pullenti.ner.Slot s : getSlots()) {
            if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), ATTR_DATE)) {
                ...
                com.pullenti.unisharp.Outargwrapper<Integer> wrapi1103 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1104 = com.pullenti.unisharp.Utils.parseInteger(str, 0, null, wrapi1103);
                i = (wrapi1103.value != null ? wrapi1103.value : 0);
                if (inoutres1104) 
                    res.add(i);
            }
        }
    ...
    public static DecreeReferent _new1087(String _arg1) {

...
public class MetaToken extends Token {
            ...
            for (Token t = begin.getNext(); t != null; t = t.getNext()) {
                if (t.chars.isLetter()) {
                    if (chars.isCapitalUpper() && t.chars.isAllLower()) {
                        ...
                        chars = com.pullenti.morph.CharsInfo._new2793((short)((((int)chars.value) & ((int)t.chars.value))));
                }
                if (t == end) 
                    break;
            }
    ...
    public static MetaToken _new572(Token _arg1, Token _arg2, MorphCollection _arg3) {
        MetaToken res = new MetaToken(_arg1, _arg2, null);
        res.setMorph(_arg3);
        return res;
    }

    public static MetaToken _new828(Token _arg1, Token _arg2, Object _arg3) {
        MetaToken res = new MetaToken(_arg1, _arg2, null);
        res.tag = _arg3;
        return res;
    }

    public static MetaToken _new2286(Token _arg1, Token _arg2, Object _arg3, MorphCollection _arg4) {
        MetaToken res = new MetaToken(_arg1, _arg2, null);
        res.tag = _arg3;
        res.setMorph(_arg4);
        return res;

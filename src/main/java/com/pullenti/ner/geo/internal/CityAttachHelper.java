...
public class CityAttachHelper {
    ...
    public static com.pullenti.ner.ReferentToken tryAttachCity(java.util.ArrayList<CityItemToken> li, com.pullenti.ner.core.AnalyzerDataWithOntology ad, boolean always) {
        ...
        if (res == null) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> wrapoi1114 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem>();
            res = try1(li, wrapoi1114, ad);
            oi = wrapoi1114.value;
        }
        if (res == null) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> wrapoi1115 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem>();
            res = _tryNounName(li, wrapoi1115, false);
            oi = wrapoi1115.value;
        }
        if (res == null) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> wrapoi1116 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem>();
            res = _tryNameExist(li, wrapoi1116, false);
            oi = wrapoi1116.value;
        }
        if (res == null) 
            res = try4(li);
        if (res == null && always) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> wrapoi1117 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem>();
            res = _tryNounName(li, wrapoi1117, true);
            oi = wrapoi1117.value;
        }
        if (res == null && always) {
            if (com.pullenti.ner.address.internal.AddressItemToken.tryAttachOrg(li.get(0).getBeginToken()) != null) {
                ...
                com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> wrapoi1118 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem>();
                res = _tryNameExist(li, wrapoi1118, true);
                oi = wrapoi1118.value;
            }
        }
        if (res == null) 
    ...
    private static com.pullenti.ner.ReferentToken try1(java.util.ArrayList<CityItemToken> li, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, com.pullenti.ner.core.AnalyzerDataWithOntology ad) {
        ...
        if (oi.value == null) {
            ...
            rt = com.pullenti.ner.ReferentToken._new738((com.pullenti.ner.geo.GeoReferent)com.pullenti.unisharp.Utils.cast(oi.value.referent, com.pullenti.ner.geo.GeoReferent.class), li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
        else if (typ == null) 
            typ = oi.value.typ;
        if (rt == null) {
            ...
            if (alttyp != null) 
                city.addTyp(alttyp);
            rt = com.pullenti.ner.ReferentToken._new738(city, li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
        }
    ...
    private static com.pullenti.ner.ReferentToken _tryNounName(java.util.ArrayList<CityItemToken> li, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, boolean always) {
            ...
            if (!li.get(0).doubtful) {
                ...
                if (li.get(i1).doubtful && !li.get(i1).geoObjectAfter && !li.get(0).geoObjectBefore) {
                    if (li.get(i1).getMorph().getCase().isGenitive()) {
                        if (li.get(i1).getEndToken().getNext() == null || MiscLocationHelper.checkGeoObjectAfter(li.get(i1).getEndToken().getNext()) || com.pullenti.ner.address.internal.AddressItemToken.checkHouseAfter(li.get(i1).getEndToken().getNext(), false, true)) {
                        }
        ...
        if (li.get(0).typ == CityItemToken.ItemType.MISC) 
            li.remove(0);
        com.pullenti.ner.ReferentToken res = com.pullenti.ner.ReferentToken._new738(city, li.get(0).getBeginToken(), li.get(li.size() - 1).getEndToken(), mc);
    ...
    private static com.pullenti.ner.ReferentToken _tryNameExist(java.util.ArrayList<CityItemToken> li, com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.IntOntologyItem> oi, boolean always) {
        ...
        return com.pullenti.ner.ReferentToken._new738(city, li.get(0).getBeginToken(), li.get(0).getEndToken(), li.get(0).getMorph());
    }

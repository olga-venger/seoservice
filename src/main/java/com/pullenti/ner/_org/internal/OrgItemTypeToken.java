...
public class OrgItemTypeToken extends com.pullenti.ner.MetaToken {
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException, NumberFormatException {
        ...
        for (int i = 0; i < sovs.length; i++) {
            t = OrgItemTermin._new1794(sovs[i], com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.STATE, 4.0F, OrgItemTermin.Types.ORG, true, true);
            if (sov2[i] != null) {
        ...
        for (int i = 0; i < sovs.length; i++) {
            t = OrgItemTermin._new1794(sovs[i], com.pullenti.morph.MorphLang.UA, com.pullenti.ner._org.OrgProfile.STATE, 4.0F, OrgItemTermin.Types.ORG, true, true);
            if (sov2[i] != null) 
                t.addVariant(sov2[i], false);
        ...
        for (int i = 0; i < sovs.length; i++) {
            t = OrgItemTermin._new1794(sovs[i], com.pullenti.morph.MorphLang.EN, com.pullenti.ner._org.OrgProfile.STATE, 4.0F, OrgItemTermin.Types.ORG, true, true);
            m_Global.add(t);
        }
        t = OrgItemTermin._new1797("ГОСУДАРСТВЕННЫЙ КОМИТЕТ", OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.STATE, 2.0F);
        t.addVariant("ГОСКОМИТЕТ", false);
        t.addVariant("ГОСКОМ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1798("ДЕРЖАВНИЙ КОМІТЕТ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.STATE, 2.0F);
        t.addVariant("ДЕРЖКОМІТЕТ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1799("КРАЕВОЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.STATE, 3.0F, true);
        t.addVariant("КРАЙКОМСТАТ", false);
        t.setProfile(com.pullenti.ner._org.OrgProfile.UNIT);
        m_Global.add(t);
        t = OrgItemTermin._new1799("ОБЛАСТНОЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.STATE, 3.0F, true);
        t.addVariant("ОБЛКОМСТАТ", false);
        t.setProfile(com.pullenti.ner._org.OrgProfile.UNIT);
        m_Global.add(t);
        t = OrgItemTermin._new1799("РАЙОННЫЙ КОМИТЕТ ГОСУДАРСТВЕННОЙ СТАТИСТИКИ", OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.STATE, 3.0F, true);
        ...
        for (int i = 0; i < sovs.length; i++) {
            t = OrgItemTermin._new1802(sovs[i], 2.0F, OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.UNIT);
            if (i == 0) {
                t.acronym = "ЦК";
        ...
        for (String s : new String[] {"Standing Committee", "Political Bureau", "Central Committee"}) {
            m_Global.add(OrgItemTermin._new1803(s.toUpperCase(), 3.0F, OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.UNIT, true));
        }
        sovs = new String[] {"ЦЕНТРАЛЬНИЙ КОМІТЕТ", "РАЙОННИЙ КОМІТЕТ", "МІСЬКИЙ КОМІТЕТ", "КРАЙОВИЙ КОМІТЕТ", "ОБЛАСНИЙ КОМІТЕТ"};
        for (int i = 0; i < sovs.length; i++) {
            t = OrgItemTermin._new1804(sovs[i], com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.DEP, com.pullenti.ner._org.OrgProfile.UNIT);
            if (i == 0) {
                t.acronym = "ЦК";
                t.canBeNormalDep = true;
            }
        ...
        t = OrgItemTermin._new1805("КАЗНАЧЕЙСТВО", 3.0F, OrgItemTermin.Types.ORG, true);
        m_Global.add(t);
        t = OrgItemTermin._new1806("КАЗНАЧЕЙСТВО", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
        m_Global.add(t);
        t = OrgItemTermin._new1805("TREASURY", 3.0F, OrgItemTermin.Types.ORG, true);
        m_Global.add(t);
        t = OrgItemTermin._new1808("ГОСУДАРСТВЕННЫЙ ДЕПАРТАМЕНТ", 5.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ГОСДЕПАРТАМЕНТ", false);
        t.addVariant("ГОСДЕП", false);
        m_Global.add(t);
        t = OrgItemTermin._new1808("DEPARTMENT OF STATE", 5.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("STATE DEPARTMENT", false);
        m_Global.add(t);
        t = OrgItemTermin._new1810("ДЕРЖАВНИЙ ДЕПАРТАМЕНТ", com.pullenti.morph.MorphLang.UA, 5.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ДЕРЖДЕПАРТАМЕНТ", false);
        t.addVariant("ДЕРЖДЕП", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1811("ДЕПАРТАМЕНТ", 2.0F, OrgItemTermin.Types.ORG));
        t = OrgItemTermin._new1811("DEPARTMENT", 2.0F, OrgItemTermin.Types.ORG);
        t.addAbridge("DEPT.");
        m_Global.add(t);
        t = OrgItemTermin._new1813("АГЕНТСТВО", 1.0F, OrgItemTermin.Types.ORG, true);
        t.addVariant("АГЕНСТВО", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1813("ADGENCY", 1.0F, OrgItemTermin.Types.ORG, true));
        t = OrgItemTermin._new1802("АКАДЕМИЯ", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1816("АКАДЕМІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1802("ACADEMY", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1818("ГЕНЕРАЛЬНЫЙ ШТАБ", 3.0F, OrgItemTermin.Types.DEP, true, true, com.pullenti.ner._org.OrgProfile.ARMY);
        t.addVariant("ГЕНЕРАЛЬНИЙ ШТАБ", false);
        t.addVariant("ГЕНШТАБ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1818("GENERAL STAFF", 3.0F, OrgItemTermin.Types.DEP, true, true, com.pullenti.ner._org.OrgProfile.ARMY);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1820("ФРОНТ", 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1821("ВОЕННЫЙ ОКРУГ", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1822("ВІЙСЬКОВИЙ ОКРУГ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1820("ГРУППА АРМИЙ", 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1824("ГРУПА АРМІЙ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1820("АРМИЯ", 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1824("АРМІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1820("ARMY", 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1821("ГВАРДИЯ", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1822("ГВАРДІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_Global.add(OrgItemTermin._new1821("GUARD", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        m_MilitaryUnit = (t = OrgItemTermin._new1831("ВОЙСКОВАЯ ЧАСТЬ", 3.0F, "ВЧ", OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY));
        t.addAbridge("В.Ч.");
        t.addVariant("ВОИНСКАЯ ЧАСТЬ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1832("ВІЙСЬКОВА ЧАСТИНА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
        t.addAbridge("В.Ч.");
        m_Global.add(t);
        for (String s : new String[] {"ДИВИЗИЯ", "ДИВИЗИОН", "ПОЛК", "БАТАЛЬОН", "РОТА", "ВЗВОД", "АВИАДИВИЗИЯ", "АВИАПОЛК", "ПОГРАНПОЛК", "АРТБРИГАДА", "МОТОМЕХБРИГАДА", "ТАНКОВЫЙ КОРПУС", "ГАРНИЗОН", "ДРУЖИНА"}) {
            t = OrgItemTermin._new1833(s, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY);
        ...
        for (String s : new String[] {"ДИВІЗІЯ", "ДИВІЗІОН", "ПОЛК", "БАТАЛЬЙОН", "РОТА", "ВЗВОД", "АВІАДИВІЗІЯ", "АВІАПОЛК", "ПОГРАНПОЛК", "АРТБРИГАДА", "МОТОМЕХБРИГАДА", "ТАНКОВИЙ КОРПУС", "ГАРНІЗОН", "ДРУЖИНА"}) {
            t = OrgItemTermin._new1834(s, 3.0F, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY);
            if (com.pullenti.unisharp.Utils.stringsEq(s, "ГАРНІЗОН")) 
                t.canBeSingleGeo = true;
            m_Global.add(t);
        }
        for (String s : new String[] {"КОРПУС", "БРИГАДА"}) {
            t = OrgItemTermin._new1833(s, 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY);
            m_Global.add(t);
        }
        for (String s : new String[] {"КОРПУС", "БРИГАДА"}) {
            t = OrgItemTermin._new1834(s, 1.0F, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.ARMY);
            m_Global.add(t);
        }
        m_Global.add(OrgItemTermin._new1802("ГОСУДАРСТВЕННЫЙ УНИВЕРСИТЕТ", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1816("ДЕРЖАВНИЙ УНІВЕРСИТЕТ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1802("STATE UNIVERSITY", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1802("УНИВЕРСИТЕТ", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1816("УНІВЕРСИТЕТ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1842("UNIVERSITY", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true));
        m_Global.add(OrgItemTermin._new1843("УЧРЕЖДЕНИЕ", 1.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1844("УСТАНОВА", com.pullenti.morph.MorphLang.UA, 1.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1843("INSTITUTION", 1.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1811("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ", 3.0F, OrgItemTermin.Types.ORG));
        m_Global.add(OrgItemTermin._new1847("ДЕРЖАВНА УСТАНОВА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG));
        m_Global.add(OrgItemTermin._new1805("STATE INSTITUTION", 3.0F, OrgItemTermin.Types.ORG, true));
        t = OrgItemTermin._new1802("ИНСТИТУТ", 2.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1816("ІНСТИТУТ", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1802("INSTITUTE", 2.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.SCIENCE);
        m_Global.add(t);
        t = OrgItemTermin._new1852("ОТДЕЛ СУДЕБНЫХ ПРИСТАВОВ", OrgItemTermin.Types.PREFIX, "ОСП", com.pullenti.ner._org.OrgProfile.UNIT, true, true);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.JUSTICE);
        m_Global.add(t);
        t = OrgItemTermin._new1852("МЕЖРАЙОННЫЙ ОТДЕЛ СУДЕБНЫХ ПРИСТАВОВ", OrgItemTermin.Types.PREFIX, "МОСП", com.pullenti.ner._org.OrgProfile.UNIT, true, true);
        t.addVariant("МЕЖРАЙОННЫЙ ОСП", false);
        t.profiles.add(com.pullenti.ner._org.OrgProfile.JUSTICE);
        m_Global.add(t);
        t = OrgItemTermin._new1852("ОТДЕЛ ВНЕВЕДОМСТВЕННОЙ ОХРАНЫ", OrgItemTermin.Types.PREFIX, "ОВО", com.pullenti.ner._org.OrgProfile.UNIT, true, true);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1855("ЛИЦЕЙ", 2.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true));
        m_Global.add(OrgItemTermin._new1856("ЛІЦЕЙ", com.pullenti.morph.MorphLang.UA, 2.0F, com.pullenti.ner._org.OrgProfile.EDUCATION, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1855("ИНТЕРНАТ", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true));
        m_Global.add(OrgItemTermin._new1856("ІНТЕРНАТ", com.pullenti.morph.MorphLang.UA, 3.0F, com.pullenti.ner._org.OrgProfile.EDUCATION, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1859("HIGH SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        m_Global.add(OrgItemTermin._new1859("SECONDARY SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        m_Global.add(OrgItemTermin._new1859("MIDDLE SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        m_Global.add(OrgItemTermin._new1859("PUBLIC SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        m_Global.add(OrgItemTermin._new1859("JUNIOR SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        m_Global.add(OrgItemTermin._new1859("GRAMMAR SCHOOL", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true, true));
        t = OrgItemTermin._new1865("СРЕДНЯЯ ШКОЛА", 3.0F, "СШ", OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION, true);
        t.addVariant("СРЕДНЯЯ ОБРАЗОВАТЕЛЬНАЯ ШКОЛА", false);
        t.addAbridge("СОШ");
        t.addVariant("ОБЩЕОБРАЗОВАТЕЛЬНАЯ ШКОЛА", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1866("БИЗНЕС ШКОЛА", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1866("БІЗНЕС ШКОЛА", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1856("СЕРЕДНЯ ШКОЛА", com.pullenti.morph.MorphLang.UA, 3.0F, com.pullenti.ner._org.OrgProfile.EDUCATION, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1802("ВЫСШАЯ ШКОЛА", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1816("ВИЩА ШКОЛА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1833("НАЧАЛЬНАЯ ШКОЛА", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1872("ПОЧАТКОВА ШКОЛА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1833("СЕМИНАРИЯ", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1872("СЕМІНАРІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1833("ГИМНАЗИЯ", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1872("ГІМНАЗІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        t = OrgItemTermin._new1833("ДЕТСКИЙ САД", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.addVariant("ДЕТСАД", false);
        t.addAbridge("Д.С.");
        t.addAbridge("Д/С");
        m_Global.add(t);
        t = OrgItemTermin._new1872("ДИТЯЧИЙ САДОК", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.addVariant("ДИТСАДОК", false);
        t.addAbridge("Д.С.");
        t.addAbridge("Д/З");
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1833("ШКОЛА", 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1880("SCHOOL", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION, true));
        m_Global.add(OrgItemTermin._new1833("УЧИЛИЩЕ", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1833("КОЛЛЕДЖ", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1880("COLLEGE", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.EDUCATION, true));
        m_Global.add(OrgItemTermin._new1884("ЦЕНТР", OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1802("НАУЧНЫЙ ЦЕНТР", 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1816("НАУКОВИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1833("БОЛЬНИЦА", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("ЛІКАРНЯ", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1833("МОРГ", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("МОРГ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1833("ХОСПИС", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("ХОСПІС", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        t = OrgItemTermin._new1833("ГОРОДСКАЯ БОЛЬНИЦА", 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addAbridge("ГОР.БОЛЬНИЦА");
        t.addVariant("ГОРБОЛЬНИЦА", false);
        m_Global.add(t);
        t = OrgItemTermin._new1872("МІСЬКА ЛІКАРНЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        m_Global.add(t);
        t = OrgItemTermin._new1895("ГОРОДСКАЯ КЛИНИЧЕСКАЯ БОЛЬНИЦА", 3.0F, OrgItemTermin.Types.ORG, true, "ГКБ", com.pullenti.ner._org.OrgProfile.MEDICINE);
        m_Global.add(t);
        t = OrgItemTermin._new1896("МІСЬКА КЛІНІЧНА ЛІКАРНЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, "МКЛ", com.pullenti.ner._org.OrgProfile.MEDICINE);
        m_Global.add(t);
        t = OrgItemTermin._new1897("КЛАДБИЩЕ", 3.0F, OrgItemTermin.Types.ORG, true);
        m_Global.add(t);
        t = OrgItemTermin._new1832("КЛАДОВИЩЕ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1833("ПОЛИКЛИНИКА", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("ПОЛІКЛІНІКА", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1833("ГОСПИТАЛЬ", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("ГОСПІТАЛЬ", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1833("КЛИНИКА", 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1872("КЛІНІКА", com.pullenti.morph.MorphLang.UA, 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE));
        t = OrgItemTermin._new1833("МЕДИКО САНИТАРНАЯ ЧАСТЬ", 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addVariant("МЕДСАНЧАСТЬ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1872("МЕДИКО САНІТАРНА ЧАСТИНА", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addVariant("МЕДСАНЧАСТИНА", false);
        m_Global.add(t);
        t = OrgItemTermin._new1907("МЕДИЦИНСКИЙ ЦЕНТР", 2.0F, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addVariant("МЕДЦЕНТР", false);
        m_Global.add(t);
        t = OrgItemTermin._new1908("МЕДИЧНИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addVariant("МЕДЦЕНТР", false);
        m_Global.add(t);
        t = OrgItemTermin._new1833("РОДИЛЬНЫЙ ДОМ", 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        t.addVariant("РОДДОМ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1872("ПОЛОГОВИЙ БУДИНОК", com.pullenti.morph.MorphLang.UA, 1.0F, OrgItemTermin.Types.ORG, true, com.pullenti.ner._org.OrgProfile.MEDICINE);
        m_Global.add(t);
        m_Global.add((t = OrgItemTermin._new1911("АЭРОПОРТ", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true)));
        m_Global.add((t = OrgItemTermin._new1912("АЕРОПОРТ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, true, true)));
        for (String s : new String[] {"ТЕАТР", "ТЕАТР-СТУДИЯ", "КИНОТЕАТР", "МУЗЕЙ", "ГАЛЕРЕЯ", "КОНЦЕРТНЫЙ ЗАЛ", "ФИЛАРМОНИЯ", "КОНСЕРВАТОРИЯ", "ДОМ КУЛЬТУРЫ", "ДВОРЕЦ КУЛЬТУРЫ", "ДВОРЕЦ ПИОНЕРОВ"}) {
            m_Global.add(OrgItemTermin._new1813(s, 3.0F, OrgItemTermin.Types.ORG, true));
        }
        for (String s : new String[] {"ТЕАТР", "ТЕАТР-СТУДІЯ", "КІНОТЕАТР", "МУЗЕЙ", "ГАЛЕРЕЯ", "КОНЦЕРТНИЙ ЗАЛ", "ФІЛАРМОНІЯ", "КОНСЕРВАТОРІЯ", "БУДИНОК КУЛЬТУРИ", "ПАЛАЦ КУЛЬТУРИ", "ПАЛАЦ ПІОНЕРІВ"}) {
            m_Global.add(OrgItemTermin._new1914(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true));
        }
        m_Global.add(OrgItemTermin._new1915("БИБЛИОТЕКА", 3.0F, OrgItemTermin.Types.ORG, true, true));
        m_Global.add(OrgItemTermin._new1916("БІБЛІОТЕКА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true));
        for (String s : new String[] {"ЦЕРКОВЬ", "ХРАМ", "СОБОР", "МЕЧЕТЬ", "СИНАГОГА", "МОНАСТЫРЬ", "ЛАВРА", "ПАТРИАРХАТ", "СЕКТА", "РЕЛИГИОЗНАЯ ГРУППА", "РЕЛИГИОЗНОЕ ОБЪЕДИНЕНИЕ", "РЕЛИГИОЗНАЯ ОРГАНИЗАЦИЯ"}) {
            m_Global.add(OrgItemTermin._new1917(s, 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        }
        for (String s : new String[] {"ЦЕРКВА", "ХРАМ", "СОБОР", "МЕЧЕТЬ", "СИНАГОГА", "МОНАСТИР", "ЛАВРА", "ПАТРІАРХАТ", "СЕКТА", "РЕЛІГІЙНА ГРУПА", "РЕЛІГІЙНЕ ОБЄДНАННЯ", " РЕЛІГІЙНА ОРГАНІЗАЦІЯ"}) {
            m_Global.add(OrgItemTermin._new1918(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        }
        for (String s : new String[] {"ФЕДЕРАЛЬНАЯ СЛУЖБА", "ГОСУДАРСТВЕННАЯ СЛУЖБА", "ФЕДЕРАЛЬНОЕ УПРАВЛЕНИЕ", "ГОСУДАРСТВЕННЫЙ КОМИТЕТ", "ГОСУДАРСТВЕННАЯ ИНСПЕКЦИЯ"}) {
            t = OrgItemTermin._new1919(s, 3.0F, OrgItemTermin.Types.ORG, true);
            m_Global.add(t);
            t = OrgItemTermin._new1920(s, 3.0F, OrgItemTermin.Types.ORG, s);
            t.terms.add(1, com.pullenti.ner.core.Termin.Term._new1921(null, true));
            m_Global.add(t);
        }
        for (String s : new String[] {"ФЕДЕРАЛЬНА СЛУЖБА", "ДЕРЖАВНА СЛУЖБА", "ФЕДЕРАЛЬНЕ УПРАВЛІННЯ", "ДЕРЖАВНИЙ КОМІТЕТ УКРАЇНИ", "ДЕРЖАВНА ІНСПЕКЦІЯ"}) {
            t = OrgItemTermin._new1922(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
            m_Global.add(t);
            t = OrgItemTermin._new1923(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, s);
            t.terms.add(1, com.pullenti.ner.core.Termin.Term._new1921(null, true));
            m_Global.add(t);
        }
        t = OrgItemTermin._new1897("СЛЕДСТВЕННЫЙ ИЗОЛЯТОР", 5.0F, OrgItemTermin.Types.ORG, true);
        t.addVariant("СИЗО", false);
        m_Global.add(t);
        t = OrgItemTermin._new1832("СЛІДЧИЙ ІЗОЛЯТОР", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
        t.addVariant("СІЗО", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1897("КОЛОНИЯ-ПОСЕЛЕНИЕ", 3.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1832("КОЛОНІЯ-ПОСЕЛЕННЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1929("ТЮРЬМА", 3.0F, OrgItemTermin.Types.ORG, true, true, true));
        m_Global.add(OrgItemTermin._new1930("ВЯЗНИЦЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, true));
        m_Global.add(OrgItemTermin._new1897("КОЛОНИЯ", 2.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add(OrgItemTermin._new1832("КОЛОНІЯ", com.pullenti.morph.MorphLang.UA, 2.0F, OrgItemTermin.Types.ORG, true));
        m_Global.add((m_IsprKolon = OrgItemTermin._new1933("ИСПРАВИТЕЛЬНАЯ КОЛОНИЯ", 3.0F, OrgItemTermin.Types.ORG, "ИК", true)));
        m_Global.add(OrgItemTermin._new1832("ВИПРАВНА КОЛОНІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true));
        for (String s : new String[] {"ПОЛИЦИЯ", "МИЛИЦИЯ"}) {
            t = OrgItemTermin._new1935(s, OrgItemTermin.Types.ORG, 3.0F, true, false);
            m_Global.add(t);
        }
        for (String s : new String[] {"ПОЛІЦІЯ", "МІЛІЦІЯ"}) {
            t = OrgItemTermin._new1936(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, 3.0F, true, false);
            m_Global.add(t);
        }
        m_Global.add(OrgItemTermin._new1937("ПАЕВЫЙ ИНВЕСТИЦИОННЫЙ ФОНД", 2.0F, OrgItemTermin.Types.ORG, "ПИФ"));
        m_Global.add(OrgItemTermin._new1938("РОССИЙСКОЕ ИНФОРМАЦИОННОЕ АГЕНТСТВО", 3.0F, OrgItemTermin.Types.ORG, "РИА", com.pullenti.ner._org.OrgProfile.MEDIA));
        t = OrgItemTermin._new1938("ИНФОРМАЦИОННОЕ АГЕНТСТВО", 3.0F, OrgItemTermin.Types.ORG, "ИА", com.pullenti.ner._org.OrgProfile.MEDIA);
        t.addVariant("ИНФОРМАГЕНТСТВО", false);
        t.addVariant("ИНФОРМАГЕНСТВО", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1940("ОТДЕЛ", 1.0F, OrgItemTermin.Types.DEP, true, true));
        m_Global.add(OrgItemTermin._new1941("ВІДДІЛ", com.pullenti.morph.MorphLang.UA, 1.0F, OrgItemTermin.Types.DEP, true, true));
        t = OrgItemTermin._new1942("РАЙОННЫЙ ОТДЕЛ", 2.0F, "РО", OrgItemTermin.Types.DEP, true);
        t.addVariant("РАЙОТДЕЛ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1943("РАЙОННИЙ ВІДДІЛ", com.pullenti.morph.MorphLang.UA, 2.0F, "РВ", OrgItemTermin.Types.DEP, true);
        m_Global.add(t);
        t = OrgItemTermin._new1811("ФАКУЛЬТЕТ", 3.0F, OrgItemTermin.Types.DEP);
        t.addAbridge("ФАК.");
        m_Global.add(t);
        t = OrgItemTermin._new1811("КАФЕДРА", 3.0F, OrgItemTermin.Types.DEP);
        t.addAbridge("КАФ.");
        m_Global.add(t);
        t = OrgItemTermin._new1811("ЛАБОРАТОРИЯ", 1.0F, OrgItemTermin.Types.DEP);
        t.addAbridge("ЛАБ.");
        m_Global.add(t);
        t = OrgItemTermin._new1947("ЛАБОРАТОРІЯ", com.pullenti.morph.MorphLang.UA, 1.0F, OrgItemTermin.Types.DEP);
        t.addAbridge("ЛАБ.");
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1821("ПАТРИАРХИЯ", 3.0F, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        m_Global.add(OrgItemTermin._new1821("ПАТРІАРХІЯ", 3.0F, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        m_Global.add(OrgItemTermin._new1821("ЕПАРХИЯ", 3.0F, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        m_Global.add(OrgItemTermin._new1821("ЄПАРХІЯ", 3.0F, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.RELIGION));
        m_Global.add(OrgItemTermin._new1952("ПРЕДСТАВИТЕЛЬСТВО", OrgItemTermin.Types.DEPADD));
        m_Global.add(OrgItemTermin._new1953("ПРЕДСТАВНИЦТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD));
        t = OrgItemTermin._new1884("ОТДЕЛЕНИЕ", OrgItemTermin.Types.DEPADD, true);
        t.addAbridge("ОТД.");
        m_Global.add(t);
        t = OrgItemTermin._new1955("ВІДДІЛЕННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1884("ИНСПЕКЦИЯ", OrgItemTermin.Types.DEPADD, true));
        m_Global.add(OrgItemTermin._new1955("ІНСПЕКЦІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD, true));
        m_Global.add(OrgItemTermin._new1952("ФИЛИАЛ", OrgItemTermin.Types.DEPADD));
        m_Global.add(OrgItemTermin._new1953("ФІЛІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD));
        for (String s : new String[] {"ОТДЕЛ ПОЛИЦИИ", "ОТДЕЛ МИЛИЦИИ", "ОТДЕЛЕНИЕ ПОЛИЦИИ", "ОТДЕЛЕНИЕ МИЛИЦИИ"}) {
            m_Global.add(OrgItemTermin._new1960(s, OrgItemTermin.Types.DEP, 1.5F, true, true));
            if (s.startsWith("ОТДЕЛ ")) {
                t = OrgItemTermin._new1960("ГОРОДСКОЙ " + s, OrgItemTermin.Types.DEP, 3F, true, true);
                t.addVariant("ГОР" + s, false);
                m_Global.add(t);
                t = OrgItemTermin._new1962("РАЙОННЫЙ " + s, "РО", OrgItemTermin.Types.DEP, 3F, true, true);
                m_Global.add(t);
            }
        }
        for (String s : new String[] {"ВІДДІЛ ПОЛІЦІЇ", "ВІДДІЛ МІЛІЦІЇ", "ВІДДІЛЕННЯ ПОЛІЦІЇ", "ВІДДІЛЕННЯ МІЛІЦІЇ"}) {
            m_Global.add(OrgItemTermin._new1963(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, 1.5F, true, true));
        }
        t = OrgItemTermin._new1964("ГЛАВНОЕ УПРАВЛЕНИЕ", "ГУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1965("ГОЛОВНЕ УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, "ГУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1964("ГЛАВНОЕ ТЕРРИТОРИАЛЬНОЕ УПРАВЛЕНИЕ", "ГТУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1965("ГОЛОВНЕ ТЕРИТОРІАЛЬНЕ УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, "ГТУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1964("ОПЕРАЦИОННОЕ УПРАВЛЕНИЕ", "ОПЕРУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1965("ОПЕРАЦІЙНЕ УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, "ОПЕРУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1970("ТЕРРИТОРИАЛЬНОЕ УПРАВЛЕНИЕ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1971("ТЕРИТОРІАЛЬНЕ УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1964("РЕГИОНАЛЬНОЕ УПРАВЛЕНИЕ", "РУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1965("РЕГІОНАЛЬНЕ УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, "РУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1884("УПРАВЛЕНИЕ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1955("УПРАВЛІННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        t = OrgItemTermin._new1964("ПОГРАНИЧНОЕ УПРАВЛЕНИЕ", "ПУ", OrgItemTermin.Types.DEPADD, true);
        m_Global.add(t);
        for (String s : new String[] {"ПРЕСС-СЛУЖБА", "ПРЕСС-ЦЕНТР", "КОЛЛ-ЦЕНТР", "БУХГАЛТЕРИЯ", "МАГИСТРАТУРА", "АСПИРАНТУРА", "ДОКТОРАНТУРА", "ОРДИНАТУРА", "СОВЕТ ДИРЕКТОРОВ", "УЧЕНЫЙ СОВЕТ", "КОЛЛЕГИЯ", "ПЛЕНУМ", "АППАРАТ", "НАБЛЮДАТЕЛЬНЫЙ СОВЕТ", "ОБЩЕСТВЕННЫЙ СОВЕТ", "РУКОВОДСТВО", "ДИРЕКЦИЯ", "ПРАВЛЕНИЕ", "ЖЮРИ", "ПРЕЗИДИУМ", "СЕКРЕТАРИАТ", "СИНОД", "PRESS", "PRESS CENTER", "CLIENT CENTER", "CALL CENTER", "ACCOUNTING", "MASTER DEGREE", "POSTGRADUATE", "DOCTORATE", "RESIDENCY", "BOARD OF DIRECTORS", "DIRECTOR BOARD", "ACADEMIC COUNCIL", "BOARD", "PLENARY", "UNIT", "SUPERVISORY BOARD", "PUBLIC COUNCIL", "LEADERSHIP", "MANAGEMENT", "JURY", "BUREAU", "SECRETARIAT"}) {
            m_Global.add(OrgItemTermin._new1977(s, OrgItemTermin.Types.DEPADD, true, com.pullenti.ner._org.OrgProfile.UNIT));
        }
        for (String s : new String[] {"ПРЕС-СЛУЖБА", "ПРЕС-ЦЕНТР", "БУХГАЛТЕРІЯ", "МАГІСТРАТУРА", "АСПІРАНТУРА", "ДОКТОРАНТУРА", "ОРДИНАТУРА", "РАДА ДИРЕКТОРІВ", "ВЧЕНА РАДА", "КОЛЕГІЯ", "ПЛЕНУМ", "АПАРАТ", "НАГЛЯДОВА РАДА", "ГРОМАДСЬКА РАДА", "КЕРІВНИЦТВО", "ДИРЕКЦІЯ", "ПРАВЛІННЯ", "ЖУРІ", "ПРЕЗИДІЯ", "СЕКРЕТАРІАТ"}) {
            m_Global.add(OrgItemTermin._new1978(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEPADD, true, com.pullenti.ner._org.OrgProfile.UNIT));
        }
        t = OrgItemTermin._new1977("ОТДЕЛ ИНФОРМАЦИОННОЙ БЕЗОПАСНОСТИ", OrgItemTermin.Types.DEPADD, true, com.pullenti.ner._org.OrgProfile.UNIT);
        t.addVariant("ОТДЕЛ ИБ", false);
        m_Global.add(t);
        t = OrgItemTermin._new1977("ОТДЕЛ ИНФОРМАЦИОННЫХ ТЕХНОЛОГИЙ", OrgItemTermin.Types.DEPADD, true, com.pullenti.ner._org.OrgProfile.UNIT);
        t.addVariant("ОТДЕЛ ИТ", false);
        t.addVariant("ОТДЕЛ IT", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1884("СЕКТОР", OrgItemTermin.Types.DEP, true));
        m_Global.add(OrgItemTermin._new1982("КУРС", OrgItemTermin.Types.DEP, true, true));
        m_Global.add(OrgItemTermin._new1983("ГРУППА", OrgItemTermin.Types.DEP, true, true, true, true));
        m_Global.add(OrgItemTermin._new1984("ГРУПА", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, true, true, true, true));
        m_Global.add(OrgItemTermin._new1977("ДНЕВНОЕ ОТДЕЛЕНИЕ", OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1978("ДЕННЕ ВІДДІЛЕННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1977("ВЕЧЕРНЕЕ ОТДЕЛЕНИЕ", OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1978("ВЕЧІРНЄ ВІДДІЛЕННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, true, com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1970("ДЕЖУРНАЯ ЧАСТЬ", OrgItemTermin.Types.DEP, true));
        m_Global.add(OrgItemTermin._new1971("ЧЕРГОВА ЧАСТИНА", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, true));
        t = OrgItemTermin._new1991("ПАСПОРТНЫЙ СТОЛ", OrgItemTermin.Types.DEP, true);
        t.addAbridge("П/С");
        m_Global.add(t);
        t = OrgItemTermin._new1992("ПАСПОРТНИЙ СТІЛ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.DEP, true);
        t.addAbridge("П/С");
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1993("ВЫСШЕЕ УЧЕБНОЕ ЗАВЕДЕНИЕ", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.EDUCATION, "ВУЗ"));
        m_Global.add(OrgItemTermin._new1994("ВИЩИЙ НАВЧАЛЬНИЙ ЗАКЛАД", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.EDUCATION, "ВНЗ"));
        m_Global.add(OrgItemTermin._new1993("ВЫСШЕЕ ПРОФЕССИОНАЛЬНОЕ УЧИЛИЩЕ", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.EDUCATION, "ВПУ"));
        m_Global.add(OrgItemTermin._new1994("ВИЩЕ ПРОФЕСІЙНЕ УЧИЛИЩЕ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.EDUCATION, "ВПУ"));
        m_Global.add(OrgItemTermin._new1993("НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.SCIENCE, "НИИ"));
        m_Global.add(OrgItemTermin._new1994("НАУКОВО ДОСЛІДНИЙ ІНСТИТУТ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.SCIENCE, "НДІ"));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ЦЕНТР", OrgItemTermin.Types.PREFIX, "НИЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ДОСЛІДНИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НДЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("ЦЕНТРАЛЬНЫЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTermin.Types.PREFIX, "ЦНИИ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("ВСЕРОССИЙСКИЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTermin.Types.PREFIX, "ВНИИ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("РОССИЙСКИЙ НАУЧНО ИССЛЕДОВАТЕЛЬСКИЙ ИНСТИТУТ", OrgItemTermin.Types.PREFIX, "РНИИ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        t = OrgItemTermin._new2004("ИННОВАЦИОННЫЙ ЦЕНТР", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.SCIENCE);
        t.addVariant("ИННОЦЕНТР", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ТЕХНИЧЕСКИЙ ЦЕНТР", OrgItemTermin.Types.PREFIX, "НТЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ТЕХНІЧНИЙ ЦЕНТР", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НТЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ТЕХНИЧЕСКАЯ ФИРМА", OrgItemTermin.Types.PREFIX, "НТФ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ВИРОБНИЧА ФІРМА", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НВФ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ПРОИЗВОДСТВЕННОЕ ОБЪЕДИНЕНИЕ", OrgItemTermin.Types.PREFIX, "НПО", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ВИРОБНИЧЕ ОБЄДНАННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НВО", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2004("НАУЧНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО-ВИРОБНИЧИЙ КООПЕРАТИВ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НВК", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ПРОИЗВОДСТВЕННАЯ КОРПОРАЦИЯ", OrgItemTermin.Types.PREFIX, "НПК", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ТЕХНИЧЕСКИЙ КОМПЛЕКС", OrgItemTermin.Types.PREFIX, "НТК", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("МЕЖОТРАСЛЕВОЙ НАУЧНО ТЕХНИЧЕСКИЙ КОМПЛЕКС", OrgItemTermin.Types.PREFIX, "МНТК", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "НПП", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ВИРОБНИЧЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НВП", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ПРОИЗВОДСТВЕННЫЙ ЦЕНТР", OrgItemTermin.Types.PREFIX, "НПЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2000("НАУКОВО ВИРОБНИЧЕ ЦЕНТР", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "НВЦ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new1999("НАУЧНО ПРОИЗВОДСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "НПУП", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2021("ИНДИВИДУАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ИП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧП"));
        m_Global.add(OrgItemTermin._new2023("ПРИВАТНЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ПП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧУП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ПРОИЗВОДСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧПУП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ИНДИВИДУАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧИП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ОХРАННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧОП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНАЯ ОХРАННАЯ ОРГАНИЗАЦИЯ", OrgItemTermin.Types.PREFIX, "ЧОО"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ТРАНСПОРТНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧТУП"));
        m_Global.add(OrgItemTermin._new2021("ЧАСТНОЕ ТРАНСПОРТНО ЭКСПЛУАТАЦИОННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ЧТЭУП"));
        m_Global.add(OrgItemTermin._new2021("НАУЧНО ПРОИЗВОДСТВЕННОЕ КОРПОРАЦИЯ", OrgItemTermin.Types.PREFIX, "НПК"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ФГУП"));
        m_Global.add(OrgItemTermin._new2021("ГОСУДАРСТВЕННОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ГУП"));
        t = OrgItemTermin._new2021("ГОСУДАРСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ГП");
        t.addVariant("ГОСПРЕДПРИЯТИЕ", false);
        m_Global.add(t);
        t = OrgItemTermin._new2023("ДЕРЖАВНЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ДП");
        t.addVariant("ДЕРЖПІДПРИЄМСТВО", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ НАУЧНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГНУ", com.pullenti.ner._org.OrgProfile.SCIENCE));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГУ"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГКУ"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ КАЗЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГКОУ"));
        t = OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГБУ");
        t.addVariant("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ НАУКИ", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new2021("ВОЕННО ПРОМЫШЛЕННАЯ КОРПОРАЦИЯ", OrgItemTermin.Types.PREFIX, "ВПК"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФБУ"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "ФУП"));
        m_Global.add(OrgItemTermin._new2021("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФКУ"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ НЕКОММЕРЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МНУ"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МБУ"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МАУ"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МКУ"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ УНИТАРНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "МУП"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ УНИТАРНОЕ ПРОИЗВОДСТВЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "МУПП"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "МКП"));
        m_Global.add(OrgItemTermin._new2021("МУНИЦИПАЛЬНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, "МП"));
        m_Global.add(OrgItemTermin._new2021("НЕБАНКОВСКАЯ КРЕДИТНАЯ ОРГАНИЗАЦИЯ", OrgItemTermin.Types.PREFIX, "НКО"));
        m_Global.add(OrgItemTermin._new2021("РАСЧЕТНАЯ НЕБАНКОВСКАЯ КРЕДИТНАЯ ОРГАНИЗАЦИЯ", OrgItemTermin.Types.PREFIX, "РНКО"));
        m_Global.add(OrgItemTermin._new2021("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГБУ"));
        m_Global.add(OrgItemTermin._new2021("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГКУ"));
        m_Global.add(OrgItemTermin._new2021("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГАУ"));
        m_Global.add(OrgItemTermin._new1952("МАЛОЕ ИННОВАЦИОННОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX));
        m_Global.add(OrgItemTermin._new2021("НЕГОСУДАРСТВЕННЫЙ ПЕНСИОННЫЙ ФОНД", OrgItemTermin.Types.PREFIX, "НПФ"));
        m_Global.add(OrgItemTermin._new2023("ДЕРЖАВНА АКЦІОНЕРНА КОМПАНІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ДАК"));
        m_Global.add(OrgItemTermin._new2023("ДЕРЖАВНА КОМПАНІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ДК"));
        m_Global.add(OrgItemTermin._new2023("КОЛЕКТИВНЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "КП"));
        m_Global.add(OrgItemTermin._new2023("КОЛЕКТИВНЕ МАЛЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "КМП"));
        m_Global.add(OrgItemTermin._new2023("ВИРОБНИЧА ФІРМА", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ВФ"));
        m_Global.add(OrgItemTermin._new2023("ВИРОБНИЧЕ ОБЄДНАННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ВО"));
        m_Global.add(OrgItemTermin._new2023("ВИРОБНИЧЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ВП"));
        m_Global.add(OrgItemTermin._new2023("ВИРОБНИЧИЙ КООПЕРАТИВ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ВК"));
        m_Global.add(OrgItemTermin._new2023("СТРАХОВА КОМПАНІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "СК"));
        m_Global.add(OrgItemTermin._new2023("ТВОРЧЕ ОБЄДНАННЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ТО"));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ФГУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ФКУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГАУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГБУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГОБУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГКУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "ГОКУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "МУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("НЕГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "НУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "МБУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "МКУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "МОБУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ ЗДРАВООХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "МАУЗ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new2004("ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ФГУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ФКУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ГАУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ГБУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ГОБУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ГКУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ ОБЛАСТНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ГОКУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "МУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("НЕГОСУДАРСТВЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "НУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "МБУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "МКУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ ОБЛАСТНОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "МОБУК", com.pullenti.ner._org.OrgProfile.ART));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ АВТОНОМНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "МАУК", com.pullenti.ner._org.OrgProfile.ART));
        t = OrgItemTermin._new2021("ЧАСТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ", OrgItemTermin.Types.PREFIX, "ЧУК");
        t.addVariant("ЧАСТНОЕ УЧРЕЖДЕНИЕ КУЛЬТУРЫ ЛФП", false);
        t.addVariant("ЧУК ЛФП", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ОБРАЗОВАНИЯ", OrgItemTermin.Types.PREFIX, "ГБУО", com.pullenti.ner._org.OrgProfile.EDUCATION));
        t = OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ПРФЕСИОНАЛЬНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГБПОУ", com.pullenti.ner._org.OrgProfile.EDUCATION);
        t.addVariant("ГБ ПОУ", true);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБЩЕОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГБОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ ДОПОЛНИТЕЛЬНОГО ОБРАЗОВАНИЯ", OrgItemTermin.Types.PREFIX, "ГБУДО", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ КАЗЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МКОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("МУНИЦИПАЛЬНОЕ ЛЕЧЕБНО ПРОФИЛАКТИЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "МЛПУ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ КАЗЕННОЕ ЛЕЧЕБНО ПРОФИЛАКТИЧЕСКОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФКЛПУ", com.pullenti.ner._org.OrgProfile.MEDICINE));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ГБОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ ОБРАЗОВАТЕЛЬНОЕ УЧРЕЖДЕНИЕ", OrgItemTermin.Types.PREFIX, "ФГБОУ", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("ВЫСШЕЕ ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАНИЕ", OrgItemTermin.Types.PREFIX, "ВПО", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new1999("ДОПОЛНИТЕЛЬНОЕ ПРОФЕССИОНАЛЬНОЕ ОБРАЗОВАНИЕ", OrgItemTermin.Types.PREFIX, "ДПО", com.pullenti.ner._org.OrgProfile.EDUCATION));
        m_Global.add(OrgItemTermin._new2112("ДЕПАРТАМЕНТ ЕДИНОГО ЗАКАЗЧИКА", OrgItemTermin.Types.PREFIX, "ДЕЗ", true, true));
        t = OrgItemTermin._new2113("СОЮЗ АРБИТРАЖНЫХ УПРАВЛЯЮЩИХ", OrgItemTermin.Types.PREFIX, "САУ", true);
        t.addVariant("САМОРЕГУЛИРУЕМАЯ ОРГАНИЗАЦИЯ АРБИТРАЖНЫХ УПРАВЛЯЮЩИХ", false);
        t.addVariant("СОАУ", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "АО"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АТ"));
        m_Global.add((m_SovmPred = OrgItemTermin._new2114("СОВМЕСТНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, true, "СП")));
        m_Global.add(OrgItemTermin._new2115("СПІЛЬНЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "СП"));
        m_Global.add((m_AkcionComp = OrgItemTermin._new2118("АКЦИОНЕРНАЯ КОМПАНИЯ", OrgItemTermin.Types.PREFIX, true)));
        m_Global.add(OrgItemTermin._new2114("ЗАКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "ЗАО"));
        m_Global.add(OrgItemTermin._new2120("РОССИЙСКОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "РАО", "PAO"));
        m_Global.add(OrgItemTermin._new2114("РОССИЙСКОЕ ОТКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "РОАО"));
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНОЕ ОБЩЕСТВО ЗАКРЫТОГО ТИПА", OrgItemTermin.Types.PREFIX, true, "АОЗТ"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНЕ ТОВАРИСТВО ЗАКРИТОГО ТИПУ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АТЗТ"));
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНОЕ ОБЩЕСТВО ОТКРЫТОГО ТИПА", OrgItemTermin.Types.PREFIX, true, "АООТ"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНЕ ТОВАРИСТВО ВІДКРИТОГО ТИПУ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АТВТ"));
        m_Global.add(OrgItemTermin._new2114("ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ", OrgItemTermin.Types.PREFIX, true, "ОО"));
        m_Global.add(OrgItemTermin._new2115("ГРОМАДСЬКА ОРГАНІЗАЦІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ГО"));
        m_Global.add(OrgItemTermin._new2114("АВТОНОМНАЯ НЕКОММЕРЧЕСКАЯ ОРГАНИЗАЦИЯ", OrgItemTermin.Types.PREFIX, true, "АНО"));
        m_Global.add(OrgItemTermin._new2115("АВТОНОМНА НЕКОМЕРЦІЙНА ОРГАНІЗАЦІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АНО"));
        m_Global.add(OrgItemTermin._new2120("ОТКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "ОАО", "OAO"));
        m_Global.add(OrgItemTermin._new2131("ВІДКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ВАТ", "ВАТ"));
        m_Global.add(OrgItemTermin._new2120("ЧАСТНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "ЧАО", "ЧAO"));
        m_Global.add(OrgItemTermin._new2114("ОТКРЫТОЕ СТРАХОВОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "ОСАО"));
        m_Global.add(OrgItemTermin._new2120("ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ", OrgItemTermin.Types.PREFIX, true, "ООО", "OOO"));
        m_Global.add(OrgItemTermin._new2131("ТОВАРИСТВО З ОБМЕЖЕНОЮ ВІДПОВІДАЛЬНІСТЮ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ТОВ", "ТОВ"));
        m_Global.add(OrgItemTermin._new2131("ТОВАРИСТВО З ПОВНОЮ ВІДПОВІДАЛЬНІСТЮ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ТПВ", "ТПВ"));
        m_Global.add(OrgItemTermin._new2131("ТОВАРИСТВО З ОБМЕЖЕНОЮ ВІДПОВІДАЛЬНІСТЮ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ТЗОВ", "ТЗОВ"));
        m_Global.add(OrgItemTermin._new2131("ТОВАРИСТВО З ДОДАТКОВОЮ ВІДПОВІДАЛЬНІСТЮ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ТДВ", "ТДВ"));
        m_Global.add(OrgItemTermin._new2118("ЧАСТНОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2131("ПРИВАТНЕ АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ПРАТ", "ПРАТ"));
        m_Global.add(OrgItemTermin._new2118("ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2131("ПУБЛІЧНЕ АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ПАТ", "ПАТ"));
        m_Global.add(OrgItemTermin._new2118("ЗАКРЫТОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2131("ЗАКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ЗАТ", "ЗАТ"));
        m_Global.add(OrgItemTermin._new2118("ОТКРЫТОЕ АКЦИОНЕРНОЕ ТОВАРИЩЕСТВО", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2131("ВІДКРИТЕ АКЦІОНЕРНЕ ТОВАРИСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ВАТ", "ВАТ"));
        m_Global.add(OrgItemTermin._new2114("ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "ПАО"));
        m_Global.add(OrgItemTermin._new2114("СТРАХОВОЕ ПУБЛИЧНОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО", OrgItemTermin.Types.PREFIX, true, "СПАО"));
        m_Global.add(OrgItemTermin._new2149("ТОВАРИЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ", OrgItemTermin.Types.PREFIX, "ТОО", "TOO"));
        m_Global.add(OrgItemTermin._new2021("ПРЕДПРИНИМАТЕЛЬ БЕЗ ОБРАЗОВАНИЯ ЮРИДИЧЕСКОГО ЛИЦА", OrgItemTermin.Types.PREFIX, "ПБОЮЛ"));
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНЫЙ КОММЕРЧЕСКИЙ БАНК", OrgItemTermin.Types.PREFIX, true, "АКБ"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНИЙ КОМЕРЦІЙНИЙ БАНК", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АКБ"));
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНЫЙ БАНК", OrgItemTermin.Types.PREFIX, true, "АБ"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНИЙ БАНК", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АБ"));
        m_Global.add(OrgItemTermin._new2118("КОММЕРЧЕСКИЙ БАНК", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2156("КОМЕРЦІЙНИЙ БАНК", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2118("КОНСТРУКТОРСКОЕ БЮРО", OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2156("КОНСТРУКТОРСЬКЕ БЮРО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true));
        m_Global.add(OrgItemTermin._new2114("ОПЫТНО КОНСТРУКТОРСКОЕ БЮРО", OrgItemTermin.Types.PREFIX, true, "ОКБ"));
        m_Global.add(OrgItemTermin._new2115("ДОСЛІДНО КОНСТРУКТОРСЬКЕ БЮРО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ДКБ"));
        m_Global.add(OrgItemTermin._new2113("СПЕЦИАЛЬНОЕ КОНСТРУКТОРСКОЕ БЮРО", OrgItemTermin.Types.PREFIX, "СКБ", true));
        m_Global.add(OrgItemTermin._new2162("СПЕЦІАЛЬНЕ КОНСТРУКТОРСЬКЕ БЮРО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "СКБ", true));
        m_Global.add(OrgItemTermin._new2114("АКЦИОНЕРНАЯ СТРАХОВАЯ КОМПАНИЯ", OrgItemTermin.Types.PREFIX, true, "АСК"));
        m_Global.add(OrgItemTermin._new2115("АКЦІОНЕРНА СТРАХОВА КОМПАНІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "АСК"));
        m_Global.add(OrgItemTermin._new2165("АВТОТРАНСПОРТНОЕ ПРЕДПРИЯТИЕ", OrgItemTermin.Types.PREFIX, true, true, "АТП"));
        m_Global.add(OrgItemTermin._new2166("АВТОТРАНСПОРТНЕ ПІДПРИЄМСТВО", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, true, "АТП"));
        m_Global.add(OrgItemTermin._new2114("ТЕЛЕРАДИОКОМПАНИЯ", OrgItemTermin.Types.PREFIX, true, "ТРК"));
        m_Global.add(OrgItemTermin._new2115("ТЕЛЕРАДІОКОМПАНІЯ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, true, "ТРК"));
        t = OrgItemTermin._new2113("ОРГАНИЗОВАННАЯ ПРЕСТУПНАЯ ГРУППИРОВКА", OrgItemTermin.Types.PREFIX, "ОПГ", true);
        t.addVariant("ОРГАНИЗОВАННАЯ ПРЕСТУПНАЯ ГРУППА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2113("ОРГАНИЗОВАННОЕ ПРЕСТУПНОЕ СООБЩЕСТВО", OrgItemTermin.Types.PREFIX, "ОПС", true);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new2171("ПОДРОСТКОВО МОЛОДЕЖНЫЙ КЛУБ", OrgItemTermin.Types.PREFIX, "ПМК", true, true));
        m_Global.add(OrgItemTermin._new2171("СКЛАД ВРЕМЕННОГО ХРАНЕНИЯ", OrgItemTermin.Types.PREFIX, "СВХ", true, true));
        m_Global.add(OrgItemTermin._new2171("ЖИЛИЩНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ЖСК", true, true));
        m_Global.add(OrgItemTermin._new2171("ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ГСК", true, true));
        m_Global.add(OrgItemTermin._new2171("ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ГЭК", true, true));
        m_Global.add(OrgItemTermin._new2171("ГАРАЖНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ГПК", true, true));
        m_Global.add(OrgItemTermin._new2171("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ПГСК", true, true));
        m_Global.add(OrgItemTermin._new2171("ГАРАЖНЫЙ СТРОИТЕЛЬНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ГСПК", true, true));
        m_Global.add(OrgItemTermin._new2171("ДАЧНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", OrgItemTermin.Types.PREFIX, "ДСК", true, true));
        t = OrgItemTermin._new2171("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", OrgItemTermin.Types.PREFIX, "СНТ", true, true);
        t.addAbridge("САДОВОЕ НЕКОМ-Е ТОВАРИЩЕСТВО");
        t.addVariant("СНТ ПМК", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new2171("ПРЕДПРИЯТИЕ ПОТРЕБИТЕЛЬСКОЙ КООПЕРАЦИИ", OrgItemTermin.Types.PREFIX, "ППК", true, true));
        m_Global.add(OrgItemTermin._new2182("ПІДПРИЄМСТВО СПОЖИВЧОЇ КООПЕРАЦІЇ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ПСК", true, true));
        m_Global.add(OrgItemTermin._new2183("ФІЗИЧНА ОСОБА ПІДПРИЄМЕЦЬ", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.PREFIX, "ФОП", true, true));
        t = OrgItemTermin._new2184("ЖЕЛЕЗНАЯ ДОРОГА", OrgItemTermin.Types.ORG, com.pullenti.ner._org.OrgProfile.TRANSPORT, true, 3.0F);
        ...
        for (String s : new String[] {"ЗАВОД", "ФАБРИКА", "БАНК", "КОМБИНАТ", "МЯСОКОМБИНАТ", "БАНКОВСКАЯ ГРУППА", "БИРЖА", "ФОНДОВАЯ БИРЖА", "FACTORY", "MANUFACTORY", "BANK"}) {
            m_Global.add((t = OrgItemTermin._new2185(s, (float)3.5, OrgItemTermin.Types.ORG, true, true)));
        ...
        for (String s : new String[] {"ЗАВОД", "ФАБРИКА", "БАНК", "КОМБІНАТ", "БАНКІВСЬКА ГРУПА", "БІРЖА", "ФОНДОВА БІРЖА"}) {
            m_Global.add((t = OrgItemTermin._new2186(s, com.pullenti.morph.MorphLang.UA, (float)3.5, OrgItemTermin.Types.ORG, true, true)));
        ...
        for (String s : new String[] {"ТУРФИРМА", "ТУРАГЕНТСТВО", "ТУРКОМПАНИЯ", "АВИАКОМПАНИЯ", "КИНОСТУДИЯ", "БИЗНЕС-ЦЕНТР", "КООПЕРАТИВ", "РИТЕЙЛЕР", "ОНЛАЙН РИТЕЙЛЕР", "МЕДИАГИГАНТ", "МЕДИАКОМПАНИЯ", "МЕДИАХОЛДИНГ"}) {
            t = OrgItemTermin._new2187(s, (float)3.5, OrgItemTermin.Types.ORG, true, true, true);
        ...
        for (String s : new String[] {"ТУРФІРМА", "ТУРАГЕНТСТВО", "ТУРКОМПАНІЯ", "АВІАКОМПАНІЯ", "КІНОСТУДІЯ", "БІЗНЕС-ЦЕНТР", "КООПЕРАТИВ", "РІТЕЙЛЕР", "ОНЛАЙН-РІТЕЙЛЕР", "МЕДІАГІГАНТ", "МЕДІАКОМПАНІЯ", "МЕДІАХОЛДИНГ"}) {
            t = OrgItemTermin._new2188(s, com.pullenti.morph.MorphLang.UA, (float)3.5, OrgItemTermin.Types.ORG, true, true, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"ТУРОПЕРАТОР"}) {
            t = OrgItemTermin._new2187(s, (float)0.5, OrgItemTermin.Types.ORG, true, true, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"ТУРОПЕРАТОР"}) {
            t = OrgItemTermin._new2188(s, com.pullenti.morph.MorphLang.UA, (float)0.5, OrgItemTermin.Types.ORG, true, true, true);
            m_Global.add(t);
        }
        m_SberBank = (t = OrgItemTermin._new2191("СБЕРЕГАТЕЛЬНЫЙ БАНК", 4.0F, OrgItemTermin.Types.ORG, true));
        t.addVariant("СБЕРБАНК", false);
        m_Global.add(t);
        t = OrgItemTermin._new2192("ОЩАДНИЙ БАНК", com.pullenti.morph.MorphLang.UA, 4.0F, OrgItemTermin.Types.ORG, true);
        ...
        for (String s : new String[] {"ОРГАНИЗАЦИЯ", "ПРЕДПРИЯТИЕ", "КОМИТЕТ", "КОМИССИЯ", "ПРОИЗВОДИТЕЛЬ", "ГИГАНТ", "ORGANIZATION", "ENTERPRISE", "COMMITTEE", "COMMISSION", "MANUFACTURER"}) {
            m_Global.add((t = OrgItemTermin._new2193(s, OrgItemTermin.Types.ORG, true, true, true)));
        }
        ...
        for (String s : new String[] {"СООБЩЕСТВО", "ФОНД", "АССОЦИАЦИЯ", "АЛЬЯНС", "ГИЛЬДИЯ", "ОБЩИНА", "ОБЩЕСТВЕННОЕ ОБЪЕДИНЕНИЕ", "ОБЩЕСТВЕННАЯ ОРГАНИЗАЦИЯ", "ОБЩЕСТВЕННОЕ ФОРМИРОВАНИЕ", "СОЮЗ", "КЛУБ", "ГРУППИРОВКА", "ЛИГА", "COMMUNITY", "FOUNDATION", "ASSOCIATION", "ALLIANCE", "GUILD", "UNION", "CLUB", "GROUP", "LEAGUE"}) {
            m_Global.add((t = OrgItemTermin._new2195(s, 3.0F, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.UNION)));
        }
        for (String s : new String[] {"ПАРТИЯ", "ДВИЖЕНИЕ", "PARTY", "MOVEMENT"}) {
            m_Global.add((t = OrgItemTermin._new2196(s, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.UNION)));
        }
        for (String s : new String[] {"НОЧНОЙ КЛУБ", "NIGHTCLUB"}) {
            m_Global.add((t = OrgItemTermin._new2197(s, OrgItemTermin.Types.ORG, true, true, com.pullenti.ner._org.OrgProfile.MUSIC)));
        }
        for (String s : new String[] {"ОРГАНІЗАЦІЯ", "ПІДПРИЄМСТВО", "КОМІТЕТ", "КОМІСІЯ", "ВИРОБНИК", "ГІГАНТ", "СУСПІЛЬСТВО", "СПІЛЬНОТА", "ФОНД", "СЛУЖБА", "АСОЦІАЦІЯ", "АЛЬЯНС", "АСАМБЛЕЯ", "ГІЛЬДІЯ", "ОБЄДНАННЯ", "СОЮЗ", "ПАРТІЯ", "РУХ", "ФЕДЕРАЦІЯ", "КЛУБ", "ГРУПУВАННЯ"}) {
            m_Global.add((t = OrgItemTermin._new2198(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, true, true, true)));
        }
        t = OrgItemTermin._new2199("ДЕПУТАТСКАЯ ГРУППА", OrgItemTermin.Types.ORG, 3.0F, true);
        t.addVariant("ГРУППА ДЕПУТАТОВ", false);
        m_Global.add(t);
        t = OrgItemTermin._new2200("ДЕПУТАТСЬКА ГРУПА", com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, 3.0F, true);
        ...
        for (String s : new String[] {"ФОНД", "СОЮЗ", "ОБЪЕДИНЕНИЕ", "ОРГАНИЗАЦИЯ", "ФЕДЕРАЦИЯ", "ДВИЖЕНИЕ"}) {
            for (String ss : new String[] {"ВСЕМИРНЫЙ", "МЕЖДУНАРОДНЫЙ", "ВСЕРОССИЙСКИЙ", "ОБЩЕСТВЕННЫЙ", "НЕКОММЕРЧЕСКИЙ", "ЕВРОПЕЙСКИЙ", "ВСЕУКРАИНСКИЙ"}) {
                t = OrgItemTermin._new2185((ss + " " + s), (float)3.5, OrgItemTermin.Types.ORG, true, true);
        ...
        for (String s : new String[] {"ФОНД", "СОЮЗ", "ОБЄДНАННЯ", "ОРГАНІЗАЦІЯ", "ФЕДЕРАЦІЯ", "РУХ"}) {
            for (String ss : new String[] {"СВІТОВИЙ", "МІЖНАРОДНИЙ", "ВСЕРОСІЙСЬКИЙ", "ГРОМАДСЬКИЙ", "НЕКОМЕРЦІЙНИЙ", "ЄВРОПЕЙСЬКИЙ", "ВСЕУКРАЇНСЬКИЙ"}) {
                t = OrgItemTermin._new2186((ss + " " + s), com.pullenti.morph.MorphLang.UA, (float)3.5, OrgItemTermin.Types.ORG, true, true);
                ...
                if (bi != null && bi.getGender() != com.pullenti.morph.MorphGender.MASCULINE) {
                    String adj = com.pullenti.morph.Morphology.getWordform(ss, com.pullenti.morph.MorphBaseInfo._new560(com.pullenti.morph.MorphClass.ADJECTIVE, bi.getGender(), com.pullenti.morph.MorphNumber.SINGULAR, com.pullenti.morph.MorphLang.UA));
                    if (adj != null) 
        ...
        t = OrgItemTermin._new2185("ИНВЕСТИЦИОННЫЙ ФОНД", 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ИНВЕСТФОНД", false);
        m_Global.add(t);
        t = OrgItemTermin._new2186("ІНВЕСТИЦІЙНИЙ ФОНД", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ІНВЕСТФОНД", false);
        m_Global.add(t);
        t = OrgItemTermin._new2185("СОЦИАЛЬНАЯ СЕТЬ", 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("СОЦСЕТЬ", false);
        m_Global.add(t);
        t = OrgItemTermin._new2186("СОЦІАЛЬНА МЕРЕЖА", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("СОЦМЕРЕЖА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2185("ОФФШОРНАЯ КОМПАНИЯ", 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ОФФШОР", false);
        t.addVariant("ОФШОР", false);
        m_Global.add(t);
        t = OrgItemTermin._new2186("ОФШОРНА КОМПАНІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ОФШОР", false);
        m_Global.add(t);
        m_Global.add(OrgItemTermin._new2210("ТЕРРОРИСТИЧЕСКАЯ ОРГАНИЗАЦИЯ", 3.0F, OrgItemTermin.Types.ORG, true, true));
        m_Global.add(OrgItemTermin._new2211("ТЕРОРИСТИЧНА ОРГАНІЗАЦІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true));
        m_Global.add(OrgItemTermin._new2212("АТОМНАЯ ЭЛЕКТРОСТАНЦИЯ", 3.0F, OrgItemTermin.Types.ORG, "АЭС", true, true, true));
        m_Global.add(OrgItemTermin._new2213("АТОМНА ЕЛЕКТРОСТАНЦІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, "АЕС", true, true, true));
        m_Global.add(OrgItemTermin._new2212("ГИДРОЭЛЕКТРОСТАНЦИЯ", 3.0F, OrgItemTermin.Types.ORG, "ГЭС", true, true, true));
        m_Global.add(OrgItemTermin._new2213("ГІДРОЕЛЕКТРОСТАНЦІЯ", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, "ГЕС", true, true, true));
        m_Global.add(OrgItemTermin._new2212("ГИДРОРЕЦИРКУЛЯЦИОННАЯ ЭЛЕКТРОСТАНЦИЯ", 3.0F, OrgItemTermin.Types.ORG, "ГРЭС", true, true, true));
        m_Global.add(OrgItemTermin._new2212("ТЕПЛОВАЯ ЭЛЕКТРОСТАНЦИЯ", 3.0F, OrgItemTermin.Types.ORG, "ТЭС", true, true, true));
        m_Global.add(OrgItemTermin._new2212("НЕФТЕПЕРЕРАБАТЫВАЮЩИЙ ЗАВОД", 3.0F, OrgItemTermin.Types.ORG, "НПЗ", true, true, true));
        m_Global.add(OrgItemTermin._new2213("НАФТОПЕРЕРОБНИЙ ЗАВОД", com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, "НПЗ", true, true, true));
        for (String s : new String[] {"ФИРМА", "КОМПАНИЯ", "КОРПОРАЦИЯ", "ГОСКОРПОРАЦИЯ", "КОНЦЕРН", "КОНСОРЦИУМ", "ХОЛДИНГ", "МЕДИАХОЛДИНГ", "ТОРГОВЫЙ ДОМ", "ТОРГОВЫЙ ЦЕНТР", "УЧЕБНЫЙ ЦЕНТР", "ИССЛЕДОВАТЕЛЬСКИЙ ЦЕНТР", "КОСМИЧЕСКИЙ ЦЕНТР", "АУКЦИОННЫЙ ДОМ", "ИЗДАТЕЛЬСТВО", "ИЗДАТЕЛЬСКИЙ ДОМ", "ТОРГОВЫЙ КОМПЛЕКС", "ТОРГОВО РАЗВЛЕКАТЕЛЬНЫЙ КОМПЛЕКС", "АГЕНТСТВО НЕДВИЖИМОСТИ", "ГРУППА КОМПАНИЙ", "МЕДИАГРУППА", "МАГАЗИН", "ТОРГОВЫЙ КОМПЛЕКС", "ГИПЕРМАРКЕТ", "СУПЕРМАРКЕТ", "КАФЕ", "РЕСТОРАН", "БАР", "АУКЦИОН", "АНАЛИТИЧЕСКИЙ ЦЕНТР", "COMPANY", "CORPORATION"}) {
            t = OrgItemTermin._new2220(s, 3.0F, OrgItemTermin.Types.ORG, true, true, true);
        ...
        for (String s : new String[] {"ФІРМА", "КОМПАНІЯ", "КОРПОРАЦІЯ", "ДЕРЖКОРПОРАЦІЯ", "КОНЦЕРН", "КОНСОРЦІУМ", "ХОЛДИНГ", "МЕДІАХОЛДИНГ", "ТОРГОВИЙ ДІМ", "ТОРГОВИЙ ЦЕНТР", "НАВЧАЛЬНИЙ ЦЕНТР", "ВИДАВНИЦТВО", "ВИДАВНИЧИЙ ДІМ", "ТОРГОВИЙ КОМПЛЕКС", "ТОРГОВО-РОЗВАЖАЛЬНИЙ КОМПЛЕКС", "АГЕНТСТВО НЕРУХОМОСТІ", "ГРУПА КОМПАНІЙ", "МЕДІАГРУПА", "МАГАЗИН", "ТОРГОВИЙ КОМПЛЕКС", "ГІПЕРМАРКЕТ", "СУПЕРМАРКЕТ", "КАФЕ", "БАР", "АУКЦІОН", "АНАЛІТИЧНИЙ ЦЕНТР"}) {
            t = OrgItemTermin._new2221(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, true, true, true);
        ...
        t = OrgItemTermin._new2222("ЭКОЛОГИЧЕСКАЯ ГРУППА", com.pullenti.morph.MorphLang.RU, OrgItemTermin.Types.ORG, 3.0F, true);
        t.addVariant("ЭКОГРУППА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2223("РОК ГРУППА", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true);
        t.addVariant("РОКГРУППА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2223("ПАНК ГРУППА", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true);
        t.addVariant("ПАНКГРУППА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2223("ОРКЕСТР", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true);
        m_Global.add(t);
        t = OrgItemTermin._new2223("ХОР", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true);
        m_Global.add(t);
        t = OrgItemTermin._new2223("МУЗЫКАЛЬНЫЙ КОЛЛЕКТИВ", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true);
        t.addVariant("РОКГРУППА", false);
        m_Global.add(t);
        t = OrgItemTermin._new2228("ВОКАЛЬНО ИНСТРУМЕНТАЛЬНЫЙ АНСАМБЛЬ", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MUSIC, OrgItemTermin.Types.ORG, 3.0F, true, "ВИА");
        ...
        for (String s : new String[] {"НОТАРИАЛЬНАЯ КОНТОРА", "АДВОКАТСКОЕ БЮРО", "СТРАХОВОЕ ОБЩЕСТВО", "ЮРИДИЧЕСКИЙ ДОМ"}) {
            t = OrgItemTermin._new2229(s, OrgItemTermin.Types.ORG, true, true, true, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"НОТАРІАЛЬНА КОНТОРА", "АДВОКАТСЬКЕ БЮРО", "СТРАХОВЕ ТОВАРИСТВО"}) {
            t = OrgItemTermin._new2230(s, com.pullenti.morph.MorphLang.UA, OrgItemTermin.Types.ORG, true, true, true, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"ГАЗЕТА", "ЕЖЕНЕДЕЛЬНИК", "ТАБЛОИД", "ЕЖЕНЕДЕЛЬНЫЙ ЖУРНАЛ", "NEWSPAPER", "WEEKLY", "TABLOID", "MAGAZINE"}) {
            t = OrgItemTermin._new2231(s, 3.0F, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.MEDIA);
            t.profiles.add(com.pullenti.ner._org.OrgProfile.PRESS);
            m_Global.add(t);
        }
        for (String s : new String[] {"ГАЗЕТА", "ТИЖНЕВИК", "ТАБЛОЇД"}) {
            t = OrgItemTermin._new2232(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, true, com.pullenti.ner._org.OrgProfile.MEDIA);
            t.profiles.add(com.pullenti.ner._org.OrgProfile.PRESS);
            m_Global.add(t);
        }
        ...
        for (String s : new String[] {"ПАНСІОНАТ", "САНАТОРІЙ", "БУДИНОК ВІДПОЧИНКУ", "ГОТЕЛЬ", "SPA-ГОТЕЛЬ", "ОЗДОРОВЧИЙ ТАБІР", "БАЗА ВІДПОЧИНКУ", "СПОРТ-КЛУБ"}) {
            t = OrgItemTermin._new2236(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, true);
            if (com.pullenti.unisharp.Utils.stringsEq(s, "САНАТОРІЙ")) 
                t.addAbridge("САН.");
            m_Global.add(t);
        }
        m_Global.add(OrgItemTermin._new2237("ДЕТСКИЙ ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", 3.0F, OrgItemTermin.Types.ORG, "ДОЛ", true, true, true));
        m_Global.add(OrgItemTermin._new2237("ДЕТСКИЙ СПОРТИВНЫЙ ОЗДОРОВИТЕЛЬНЫЙ ЛАГЕРЬ", 3.0F, OrgItemTermin.Types.ORG, "ДСОЛ", true, true, true));
        for (String s : new String[] {"КОЛХОЗ", "САДОВО ОГОРОДНОЕ ТОВАРИЩЕСТВО", "КООПЕРАТИВ", "ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "КРЕСТЬЯНСКО ФЕРМЕРСКОЕ ХОЗЯЙСТВО", "АГРОФИРМА", "КОНЕЗАВОД", "ПТИЦЕФЕРМА", "СВИНОФЕРМА", "ФЕРМА", "ЛЕСПРОМХОЗ"}) {
            t = OrgItemTermin._new2239(s, 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"КОЛГОСП", "САДОВО ГОРОДНЄ ТОВАРИСТВО", "КООПЕРАТИВ", "ФЕРМЕРСЬКЕ ГОСПОДАРСТВО", "СЕЛЯНСЬКО ФЕРМЕРСЬКЕ ГОСПОДАРСТВО", "АГРОФІРМА", "КОНЕЗАВОД", "ПТАХОФЕРМА", "СВИНОФЕРМА", "ФЕРМА"}) {
            t = OrgItemTermin._new2240(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
            m_Global.add(t);
        }
        t = OrgItemTermin._new2239("АВТОМОБИЛЬНЫЙ ЗАВОД", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addVariant("АВТОЗАВОД", false);
        m_Global.add(t);
        t = OrgItemTermin._new2239("АВТОМОБИЛЬНЫЙ ЦЕНТР", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addVariant("АВТОЦЕНТР", false);
        m_Global.add(t);
        t = OrgItemTermin._new2239("СОВХОЗ", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addAbridge("С/Х");
        t.addAbridge("С-З");
        m_Global.add(t);
        t = OrgItemTermin._new2239("ПЛЕМЕННОЕ ХОЗЯЙСТВО", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addVariant("ПЛЕМХОЗ", false);
        m_Global.add(t);
        t = OrgItemTermin._new2239("ЛЕСНОЕ ХОЗЯЙСТВО", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        ...
        for (int i = 0; i < sads.length; i += 2) {
            t = OrgItemTermin._new2246(sads[i].toUpperCase(), 3.0F, sads[i + 1], OrgItemTermin.Types.ORG, true, true, true);
            t.addAbridge(sads[i + 1]);
            if (com.pullenti.unisharp.Utils.stringsEq(t.acronym, "СНТ")) 
                t.addAbridge("САДОВ.НЕКОМ.ТОВ.");
            m_Global.add(t);
        }
        t = OrgItemTermin._new2239("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        ...
        m_Global.add(t);
        t = OrgItemTermin._new2239("САДОВОДЧЕСКИЙ КООПЕРАТИВ", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addAbridge("САДОВОДЧ.КООП.");
        t.addAbridge("САДОВ.КООП.");
        t.addVariant("САДОВЫЙ КООПЕРАТИВ", false);
        m_Global.add(t);
        t = OrgItemTermin._new2239("ДАЧНОЕ ТОВАРИЩЕСТВО", 3.0F, OrgItemTermin.Types.ORG, true, true, true, true);
        t.addAbridge("ДАЧН.ТОВ.");
        t.addAbridge("ДАЧ.ТОВ.");
        m_Global.add(t);
        for (String s : new String[] {"ФЕСТИВАЛЬ", "ЧЕМПИОНАТ", "ОЛИМПИАДА", "КОНКУРС"}) {
            t = OrgItemTermin._new1813(s, 3.0F, OrgItemTermin.Types.ORG, true);
            m_Global.add(t);
        }
        for (String s : new String[] {"ФЕСТИВАЛЬ", "ЧЕМПІОНАТ", "ОЛІМПІАДА"}) {
            t = OrgItemTermin._new2251(s, com.pullenti.morph.MorphLang.UA, 3.0F, OrgItemTermin.Types.ORG, true);
            m_Global.add(t);
        }
        t = OrgItemTermin._new1915("ПОГРАНИЧНЫЙ ПОСТ", 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ПОГП", false);
        m_Global.add(t);
        t = OrgItemTermin._new1915("ПОГРАНИЧНАЯ ЗАСТАВА", 3.0F, OrgItemTermin.Types.ORG, true, true);
        t.addVariant("ПОГЗ", false);
        t.addVariant("ПОГРАНЗАСТАВА", false);
        m_Global.add(t);
        t = OrgItemTermin._new1897("ТЕРРИТОРИАЛЬНЫЙ ПУНКТ", 3.0F, OrgItemTermin.Types.DEP, true);
        m_Global.add(t);
        t = OrgItemTermin._new1897("МИГРАЦИОННЫЙ ПУНКТ", 3.0F, OrgItemTermin.Types.DEP, true);
        m_Global.add(t);
        ...
        for (String s : new String[] {"КАПІТАЛ", "КЕРІВНИЦТВО", "ЗЇЗД", "ЗБОРИ", "РАДА", "УПРАВЛІННЯ"}) {
            m_PrefWords.add(com.pullenti.ner.core.Termin._new891(s, com.pullenti.morph.MorphLang.UA));
        }
        for (String s : new String[] {"АКЦИЯ", "ВЛАДЕЛЕЦ", "ВЛАДЕЛИЦА", "СОВЛАДЕЛЕЦ", "СОВЛАДЕЛИЦА", "КОНКУРЕНТ"}) {
            m_PrefWords.add(com.pullenti.ner.core.Termin._new119(s, s));
        }
        for (String s : new String[] {"АКЦІЯ", "ВЛАСНИК", "ВЛАСНИЦЯ", "СПІВВЛАСНИК", "СПІВВЛАСНИЦЯ", "КОНКУРЕНТ"}) {
            m_PrefWords.add(com.pullenti.ner.core.Termin._new120(s, s, com.pullenti.morph.MorphLang.UA));
        }
        for (int k = 0; k < 3; k++) {
            ...
            try (com.pullenti.unisharp.MemoryStream tmp = new com.pullenti.unisharp.MemoryStream(deflate(dat))) {
                ...
                for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.doc.getDocumentElement().getChildNodes())).arr) {
                    if (k == 0) 
                        m_PrefWords.add(com.pullenti.ner.core.Termin._new119(x.getTextContent(), 1));
                    else if (k == 1) 
                        m_PrefWords.add(com.pullenti.ner.core.Termin._new120(x.getTextContent(), 1, com.pullenti.morph.MorphLang.UA));
                    else if (k == 2) 
                        m_PrefWords.add(com.pullenti.ner.core.Termin._new120(x.getTextContent(), 1, com.pullenti.morph.MorphLang.EN));
                }
            }
        }
        ...
        for (String s : new String[] {"ЧАСТЬ", "БАНК", "ЗАВОД", "ФАБРИКА", "АЭРОПОРТ", "БИРЖА", "СЛУЖБА", "МИНИСТЕРСТВО", "КОМИССИЯ", "КОМИТЕТ", "ГРУППА", "ЧАСТИНА", "БАНК", "ЗАВОД", "ФАБРИКА", "АЕРОПОРТ", "БІРЖА", "СЛУЖБА", "МІНІСТЕРСТВО", "КОМІСІЯ", "КОМІТЕТ", "ГРУПА"}) {
            m_KeyWordsForRefs.add(com.pullenti.ner.core.Termin._new119(s, s));
        }
    ...
    public static OrgItemTypeToken tryAttach(com.pullenti.ner.Token t, boolean canBeFirstLetterLower, com.pullenti.ner.core.AnalyzerDataWithOntology ad) {
            ...
            if (num != null && num.getEndToken().getNext() != null) {
                ...
                if (oo != null) {
                    if ((oo.toString().toUpperCase().indexOf("МИГРАЦ") >= 0)) {
                        res = _new2264(t, t, (com.pullenti.unisharp.Utils.stringsEq(term, "ТП") ? "территориальный пункт" : "миграционный пункт"), 4.0F, true);
                        return res;
                    }
                }
            }
        ...
        if (tt.chars.isAllUpper() && com.pullenti.unisharp.Utils.stringsEq(term, "МГТУ")) {
            if (tt.getNext().isValue("БАНК", null) || (((tt.getNext().getReferent() instanceof com.pullenti.ner._org.OrganizationReferent) && (((com.pullenti.ner._org.OrganizationReferent)com.pullenti.unisharp.Utils.cast(tt.getNext().getReferent(), com.pullenti.ner._org.OrganizationReferent.class))).getKind() == com.pullenti.ner._org.OrganizationKind.BANK)) || ((tt.getPrevious() != null && tt.getPrevious().isValue("ОПЕРУ", null)))) {
                res = _new2265(tt, tt, "главное территориальное управление");
                res.altTyp = "ГТУ";
                res.name = "МОСКОВСКОЕ";
                res.nameIsName = true;
                res.altName = "МГТУ";
        ...
        if (((say || tt.isValue("ОБЛОЖКА", "ОБКЛАДИНКА") || tt.isValue("РЕДАКТОР", null)) || tt.isValue("КОРРЕСПОНДЕНТ", "КОРЕСПОНДЕНТ") || tt.isValue("ЖУРНАЛИСТ", "ЖУРНАЛІСТ")) || com.pullenti.unisharp.Utils.stringsEq(term, "ИНТЕРВЬЮ") || com.pullenti.unisharp.Utils.stringsEq(term, "ІНТЕРВЮ")) {
            if (m_PressRU == null) 
                m_PressRU = OrgItemTermin._new2266("ИЗДАНИЕ", com.pullenti.morph.MorphLang.RU, com.pullenti.ner._org.OrgProfile.MEDIA, true, 4.0F);
            if (m_PressUA == null) 
                m_PressUA = OrgItemTermin._new2266("ВИДАННЯ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner._org.OrgProfile.MEDIA, true, 4.0F);
            ...
            if (t1.chars.isLatinLetter() && !t1.chars.isAllLower()) {
                if (tt.isValue("РЕДАКТОР", null)) 
                    return null;
                return _new2268(t, t, pres.getCanonicText().toLowerCase(), pres, true);
            }
            if (!say) {
            ...
            if (npt != null && npt.getEndToken().getNext() != null) {
                ...
                if (ok) {
                    if ((com.pullenti.unisharp.Utils.stringsEq(_root, "ИЗДАНИЕ") || com.pullenti.unisharp.Utils.stringsEq(_root, "ИЗДАТЕЛЬСТВО") || com.pullenti.unisharp.Utils.stringsEq(_root, "ЖУРНАЛ")) || com.pullenti.unisharp.Utils.stringsEq(_root, "ВИДАННЯ") || com.pullenti.unisharp.Utils.stringsEq(_root, "ВИДАВНИЦТВО")) {
                        res = _new2265(npt.getBeginToken(), npt.getEndToken(), _root.toLowerCase());
                        ...
                        res.root = OrgItemTermin._new2271(_root, true, 4.0F);
                        return res;
                    }
                }
            }
            ...
            if (rt != null && rt.getMorph()._getClass().isAdjective()) {
                if (rt.getEndToken().getNext() != null && rt.getEndToken().getNext().chars.isLatinLetter()) {
                    res = _new2272(t1, rt.getEndToken(), pres.getCanonicText().toLowerCase(), pres);
                    res.geo = rt;
                    return res;
                }
            }
            ...
            if ((((tt1.chars.isLatinLetter() && tt1.getNext() != null && tt1.getNext().isChar('.')) && tt1.getNext().getNext() != null && tt1.getNext().getNext().chars.isLatinLetter()) && (tt1.getNext().getNext().getLengthChar() < 4) && tt1.getNext().getNext().getLengthChar() > 1) && !tt1.getNext().isWhitespaceAfter()) {
                if (tt1 != t1 && !com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(tt1.getNext().getNext().getNext(), true, t1, false)) {
                    ...
                    res = _new2272(t1, tt1.getNext().getNext(), pres.getCanonicText().toLowerCase(), pres);
            ...
            if (t.getNext() != null && t.getNext().chars.isLatinLetter() && !t.getNext().chars.isAllLower()) 
                ok = true;
            if (ok) {
                res = _new2265(t, t, t.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false).toLowerCase());
                res.getProfiles().add(com.pullenti.ner._org.OrgProfile.MEDIA);
                res.getProfiles().add(com.pullenti.ner._org.OrgProfile.PRESS);
                res.root = OrgItemTermin._new2275(t.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), OrgItemTermin.Types.ORG, 3.0F, true);
            ...
            if (_geo != null && _geo.isState()) {
                res = _new2276(t, t, "министерство", "МИНИСТЕРСТВО ОБОРОНЫ", 4.0F, m_MO);
                res.getProfiles().add(com.pullenti.ner._org.OrgProfile.STATE);
                res.canBeOrganization = true;
                return res;
            }
            ...
            if (OrgItemNumberToken.tryAttach(t.getNext(), false, null) != null) 
                ...
                et = t.getNext();
            if (et != null) 
                return _new2277(t, et, "исправительная колония", "колония", m_IsprKolon, true);
        }
        else if (t.isValue("ПАКЕТ", null) && t.getNext() != null && t.getNext().isValue("АКЦИЯ", "АКЦІЯ")) 
            return _new2278(t, t.getNext(), 4.0F, true, "");
        else {
            ...
            if (tok != null && tok.tag != null) {
                if ((tok.getWhitespacesAfterCount() < 2) && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tok.getEndToken().getNext(), true, false)) 
                    return _new2278(t, tok.getEndToken(), 4.0F, true, "");
            }
        }
        if (res == null && com.pullenti.unisharp.Utils.stringsEq(term, "АК") && t.chars.isAllUpper()) {
            if (tryAttach(t.getNext(), canBeFirstLetterLower, ad) != null) 
                return _new2280(t, t, m_AkcionComp, m_AkcionComp.getCanonicText().toLowerCase());
        }
        if (com.pullenti.unisharp.Utils.stringsEq(term, "В")) {
            if ((t.getNext() != null && t.getNext().isCharOf("\\/") && t.getNext().getNext() != null) && t.getNext().getNext().isValue("Ч", null)) {
                if (OrgItemNumberToken.tryAttach(t.getNext().getNext().getNext(), true, null) != null) 
                    return _new2280(t, t.getNext().getNext(), m_MilitaryUnit, m_MilitaryUnit.getCanonicText().toLowerCase());
            }
        }
    ...
    private static OrgItemTypeToken _TryAttach(com.pullenti.ner.Token t, boolean canBeFirstLetterLower) {
        ...
        if (t.isValue("СБ", null)) {
            if (t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) 
                return _new2282(t, t, "банк", m_SberBank, m_SberBank.getCanonicText());
        }
        ...
        if (npt == null || npt.internalNoun != null) {
            if (((!t.chars.isAllLower() && t.getNext() != null && t.getNext().isHiphen()) && !t.isWhitespaceAfter() && !t.getNext().isWhitespaceAfter()) && t.getNext().getNext() != null && t.getNext().getNext().isValue("БАНК", null)) {
                ...
                res = _new2283(t, t.getNext().getNext(), s, t.getNext().getNext().getMorph(), t.chars, t.getNext().getNext().chars);
                res.root = m_Bank;
                res.typ = "банк";
                return res;
            }
        ...
        if (npt.getBeginToken() == npt.getEndToken()) {
            ...
            if (com.pullenti.morph.LanguageHelper.endsWithEx(s, "БАНК", "БАНКА", "БАНОК", null)) {
                ...
                res = _new2283(npt.getBeginToken(), npt.getEndToken(), s, npt.getMorph(), npt.chars, npt.chars);
                res.root = m_Bank;
                res.typ = "банк";
                return res;
            }
    ...
    public static OrgItemTypeToken _new2263(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, float _arg3) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.m_Coef = _arg3;
        return res;
    }

    public static OrgItemTypeToken _new2264(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, float _arg4, boolean _arg5) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setCoef(_arg4);
        res.setDep(_arg5);
    ...
    public static OrgItemTypeToken _new2265(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static OrgItemTypeToken _new2268(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, OrgItemTermin _arg4, boolean _arg5) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.root = _arg4;
        res.isNotTyp = _arg5;
    ...
    public static OrgItemTypeToken _new2272(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, OrgItemTermin _arg4) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.root = _arg4;
        return res;
    ...
    public static OrgItemTypeToken _new2276(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, String _arg4, float _arg5, OrgItemTermin _arg6) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.name = _arg4;
        res.setCoef(_arg5);
    ...
    public static OrgItemTypeToken _new2277(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, String _arg4, OrgItemTermin _arg5, boolean _arg6) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.altTyp = _arg4;
        res.root = _arg5;
    ...
    public static OrgItemTypeToken _new2278(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, float _arg3, boolean _arg4, String _arg5) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.setCoef(_arg3);
        res.isNotTyp = _arg4;
        res.typ = _arg5;
    ...
    public static OrgItemTypeToken _new2280(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, OrgItemTermin _arg3, String _arg4) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.root = _arg3;
        res.typ = _arg4;
        return res;
    ...
    public static OrgItemTypeToken _new2282(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, OrgItemTermin _arg4, String _arg5) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.root = _arg4;
        res.name = _arg5;
    ...
    public static OrgItemTypeToken _new2283(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.MorphCollection _arg4, com.pullenti.morph.CharsInfo _arg5, com.pullenti.morph.CharsInfo _arg6) {
        OrgItemTypeToken res = new OrgItemTypeToken(_arg1, _arg2);
        res.name = _arg3;
        res.setMorph(_arg4);
        res.chars = _arg5;

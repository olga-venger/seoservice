...
public class InstrToken1 extends com.pullenti.ner.MetaToken {
    ...
    public static InstrToken1 parse(com.pullenti.ner.Token t, boolean ignoreDirectives, FragToken cur, int lev, InstrToken1 prev, boolean isCitat, int maxChar, boolean canBeTableCell) {
        ...
        if (t.isChar('(')) {
            ...
            if (fr != null) 
                edt = _new1514(fr.getBeginToken(), fr.getEndToken(), Types.EDITIONS);
            else {
                com.pullenti.ner.Token t2 = _createEdition(t);
                if (t2 != null) 
                    edt = _new1514(t, t2, Types.EDITIONS);
            }
            if (edt != null) {
        ...
        InstrToken1 res = _new1516(t0, t, true);
        ...
        if (dt == null && (((t.getReferent() instanceof com.pullenti.ner.person.PersonReferent) || (t.getReferent() instanceof com.pullenti.ner.instrument.InstrumentParticipant)))) {
            dt = com.pullenti.ner.decree.internal.DecreeToken._new834(t, t, com.pullenti.ner.decree.internal.DecreeToken.ItemType.OWNER);
        ...
        if (t.isValue("КОНСУЛЬТАНТПЛЮС", null) || t.isValue("ГАРАНТ", null)) {
            ...
            if (t1 != null && ((t1.isValue("ПРИМЕЧАНИЕ", null) || ok))) {
                if (t1.getNext() != null && t1.getNext().isChar('.')) 
                    t1 = t1.getNext();
                InstrToken1 re = _new1514(t, t1, Types.COMMENT);
        ...
        if (checkComment > 0 || t.isValue("О", "ПРО")) {
            ...
            if (ok) {
                InstrToken1 cmt = _new1514(t, t1, Types.COMMENT);
        ...
        String val = null;
        com.pullenti.unisharp.Outargwrapper<String> wrapval1525 = new com.pullenti.unisharp.Outargwrapper<String>();
        com.pullenti.ner.Token tt2 = _checkDirective(t, wrapval1525);
        ...
        if (tt2 != null) {
            if (tt2.isNewlineAfter() || ((tt2.getNext() != null && ((tt2.getNext().isCharOf(":") || ((tt2.getNext().isChar('.') && tt2 != t)))) && ((tt2.getNext().isNewlineAfter() || t.chars.isAllUpper()))))) 
                return _new1520(t, (tt2.isNewlineAfter() ? tt2 : tt2.getNext()), Types.DIRECTIVE, val);
        }
        if ((lev < 3) && t != null) {
                    ...
                    if (first != null) {
                        ...
                        for (tt = first.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                            ...
                            if ((ok && first.typ != Types.APPENDIX && itprev != null) && itprev.typ == Types.APPENDIX) {
                                InstrToken1 it2 = parse(it.getEndToken().getNext(), ignoreDirectives, null, lev + 1, null, false, 0, false);
            ...
            if (tt != null && tt.isCharOf(".)]")) {
                ...
                for (; tt != null; tt = tt.getNext()) {
                    ...
                    if (tt.isNewlineAfter()) {
                        if (ok) 
                            return _new1514(t, tt, Types.COMMENT);
                        break;
                    }
                }
        }
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (t != res.getBeginToken() && _isFirstLine(t)) 
                break;
            String tmp;
            com.pullenti.unisharp.Outargwrapper<String> wraptmp1522 = new com.pullenti.unisharp.Outargwrapper<String>();
            tt2 = _checkDirective(t, wraptmp1522);
        ...
        if (res.typ == Types.LINE) {
            if (res.numTyp != NumberTypes.UNDEFINED) {
                ...
                for (String nn : res.numbers) {
                    int vv;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapvv1523 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    boolean inoutres1524 = com.pullenti.unisharp.Utils.parseInteger(nn, 0, null, wrapvv1523);
                    vv = (wrapvv1523.value != null ? wrapvv1523.value : 0);
                    if (inoutres1524) {
    ...
    public static InstrToken1 _new1514(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static InstrToken1 _new1516(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.allUpper = _arg3;
        return res;
    }

    public static InstrToken1 _new1520(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Types _arg3, String _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static InstrToken1 _new1533(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3, Types _arg4) {
        InstrToken1 res = new InstrToken1(_arg1, _arg2);

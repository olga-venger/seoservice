...
public class GoodAttrToken extends com.pullenti.ner.MetaToken {
    ...
    private static java.util.ArrayList<GoodAttrToken> _tryParseList(com.pullenti.ner.Token t) {
        ...
        for (com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
            ...
            if (tt instanceof com.pullenti.ner.NumberToken) 
                res.add(_new1262(tt, tt, tt.getSourceText()));
        }
    ...
    private static GoodAttrToken _tryParse_(com.pullenti.ner.Token t, GoodAttrToken key, boolean canBeMeasure, boolean isChars) {
        ...
        if (r != null) {
            if (com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "ORGANIZATION") || com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "GEO")) 
                return _new1263(t, t, com.pullenti.ner.goods.GoodAttrType.REFERENT, r);
        }
        if (canBeMeasure) {
        ...
        if ((((tok = m_StdAbbrs.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO)))) != null) {
            ...
            if (ty == com.pullenti.ner.goods.GoodAttrType.UNDEFINED && tok.termin.tag2 != null) {
                ...
                if (tok2 != null && com.pullenti.unisharp.Utils.stringsEq(((String)com.pullenti.unisharp.Utils.cast(tok2.termin.tag2, String.class)), "NO")) {
                    res = _new1264(t, tok2.getEndToken(), com.pullenti.ner.goods.GoodAttrType.UNDEFINED);
                    return res;
                }
            ...
            if (ty != com.pullenti.ner.goods.GoodAttrType.REFERENT) {
                res = _new1265(t, tok.getEndToken(), ty, tok.termin.getCanonicText(), tok.getMorph());
            ...
            if (ty == com.pullenti.ner.goods.GoodAttrType.REFERENT) {
                ...
                if (tt.getReferent() != null) 
                    return _new1266(t, tt, tt.getReferent(), com.pullenti.ner.goods.GoodAttrType.REFERENT);
                if ((tt instanceof com.pullenti.ner.TextToken) && !tt.chars.isAllLower() && tt.chars.isLetter()) {
                    ...
                    if (rt != null) 
                        return _new1267(t, rt.getEndToken(), rt, com.pullenti.ner.goods.GoodAttrType.REFERENT);
                }
                if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(tt, false, false)) {
                    ...
                    if (rt != null) {
                        ...
                        if (com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(t1.getNext(), false, null, false)) 
                            t1 = t1.getNext();
                        return _new1267(t, t1, rt, com.pullenti.ner.goods.GoodAttrType.REFERENT);
                    }
                }
            }
        }
        ...
        if (t.isValue("ФАСОВКА", null) || t.isValue("УПАКОВКА", null)) {
            if (!((t.getPrevious() instanceof com.pullenti.ner.NumberToken))) {
                ...
                if (tt == null) 
                    return null;
                res = _new1269(t, tt, com.pullenti.ner.goods.GoodAttrType.NUMERIC, "ФАСОВКА");
        ...
        if ((t instanceof com.pullenti.ner.ReferentToken) && (((t.getReferent() instanceof com.pullenti.ner.uri.UriReferent) || com.pullenti.unisharp.Utils.stringsEq(t.getReferent().getTypeName(), "DECREE")))) {
            res = _new1269(t, t, com.pullenti.ner.goods.GoodAttrType.MODEL, "СПЕЦИФИКАЦИЯ");
        ...
        if (key == null && !isChars) {
            ...
            if ((((!t.chars.isAllUpper() || isAllUpper)) && ((t.getMorph()._getClass().isNoun() || t.getMorph()._getClass().isUndefined())) && t.chars.isCyrillicLetter()) && (t instanceof com.pullenti.ner.TextToken)) {
                ...
                res = _new1271(t, t, com.pullenti.ner.goods.GoodAttrType.KEYWORD, t.getMorph());
        ...
        if ((t.isWhitespaceBefore() && (t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter()) && (t.getLengthChar() < 5) && !isChars) {
            ...
            if (rt != null) {
                res = _new1264(t, rt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.MODEL);
        ...
        if (t.chars.isLatinLetter() && t.isWhitespaceBefore()) {
            res = _new1264(t, t, com.pullenti.ner.goods.GoodAttrType.PROPER);
        ...
        if (pref != null) {
            ...
            if (npt != null && ((npt.chars.isAllLower() || npt.chars.isAllUpper())) && npt.chars.isCyrillicLetter()) {
                GoodAttrToken re = _new1264(t0, npt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.CHARACTER);
                ...
                for (com.pullenti.ner.Token tt = npt.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                    if (tt.isNewlineBefore()) 
                        break;
                    if (((tt.getMorph()._getClass().isPreposition() || tt.isCommaAnd())) && tt.getNext() != null) 
                        tt = tt.getNext();
        ...
        if (t.chars.isCyrillicLetter() || (t instanceof com.pullenti.ner.NumberToken)) {
            ...
            if (npt1 != null) {
                if (((npt1.noun.getBeginToken().isValue("СОРТ", null) || npt1.noun.getBeginToken().isValue("КЛАСС", null) || npt1.noun.getBeginToken().isValue("ГРУППА", null)) || npt1.noun.getBeginToken().isValue("КАТЕГОРИЯ", null) || npt1.noun.getBeginToken().isValue("ТИП", null)) || npt1.noun.getBeginToken().isValue("ПОДТИП", null)) {
                    res = _new1264(t, npt1.getEndToken(), com.pullenti.ner.goods.GoodAttrType.CHARACTER);
            ...
            if (((t instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getIntValue() != null && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT) && (t.getNext() instanceof com.pullenti.ner.TextToken) && (t.getWhitespacesAfterCount() < 2)) {
                if (((t.getNext().isValue("СОРТ", null) || t.getNext().isValue("КЛАСС", null) || t.getNext().isValue("ГРУППА", null)) || t.getNext().isValue("КАТЕГОРИЯ", null) || t.getNext().isValue("ТИП", null)) || t.getNext().isValue("ПОДТИП", null)) {
                    res = _new1264(t, t.getNext(), com.pullenti.ner.goods.GoodAttrType.CHARACTER);
            ...
            if (npt1 != null && npt1.noun.getBeginToken().isValue("ХАРАКТЕРИСТИКА", null)) {
                ...
                if (t11 != null && ((t11.isValue("УКАЗАТЬ", null) || t11.isValue("УКАЗЫВАТЬ", null)))) {
                    res = _new1264(t, t11, com.pullenti.ner.goods.GoodAttrType.UNDEFINED);
        ...
        if ((t.chars.isCyrillicLetter() && pref == null && (t instanceof com.pullenti.ner.TextToken)) && t.getMorph()._getClass().isAdjective()) {
            ...
            if (_isChar) {
                res = _new1264(t, t, com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        ...
        if (t.chars.isCyrillicLetter()) {
            ...
            if (npt != null) {
                ...
                if (npt.adjectives.size() > 0 && pref == null) {
                    if (key == null) 
                        return _new1279(t0, npt.adjectives.get(0).getEndToken(), com.pullenti.ner.goods.GoodAttrType.CHARACTER, npt.adjectives.get(0).getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, true, com.pullenti.morph.MorphGender.MASCULINE, false));
                }
                if (pref == null && key != null && npt.noun.isValue(key.value, null)) {
                    if (npt.adjectives.size() == 0) 
                        return _new1265(t0, npt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.KEYWORD, npt.noun.getNormalCaseText(com.pullenti.morph.MorphClass.NOUN, true, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
                    return _new1279(t0, npt.adjectives.get(0).getEndToken(), com.pullenti.ner.goods.GoodAttrType.CHARACTER, npt.adjectives.get(0).getNormalCaseText(com.pullenti.morph.MorphClass.ADJECTIVE, true, com.pullenti.morph.MorphGender.MASCULINE, false));
                }
                if (isProp) {
                    res = _new1264(t0, npt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.CHARACTER);
                    res.value = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
                    return res;
                }
                if (!npt.chars.isAllLower()) 
                    return _new1265(t0, npt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.PROPER, npt.getSourceText(), npt.getMorph());
            }
            if (t instanceof com.pullenti.ner.TextToken) {
                if (((t.getMorphClassInDictionary().isAdjective() || com.pullenti.morph.MorphClass.ooEq(t.getMorph()._getClass(), com.pullenti.morph.MorphClass.ADJECTIVE))) && pref == null) 
                    return _new1265(t0, t, com.pullenti.ner.goods.GoodAttrType.CHARACTER, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).getLemma(), t.getMorph());
            }
            ...
            if (pref != null && t.getMorph()._getClass().isAdjective() && (t instanceof com.pullenti.ner.TextToken)) {
                res = _new1264(t0, t, com.pullenti.ner.goods.GoodAttrType.CHARACTER);
            ...
            if (pref != null && t.getNext() != null && t.getNext().isValue("WC", null)) 
                return _new1279(t, t.getNext(), com.pullenti.ner.goods.GoodAttrType.CHARACTER, "туалет");
            if (pref != null) 
                return null;
        }
        if (t != null && t.isValue("№", null) && (t.getNext() instanceof com.pullenti.ner.NumberToken)) 
            return _new1279(t, t.getNext(), com.pullenti.ner.goods.GoodAttrType.MODEL, ("№" + (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getValue()));
        if ((t instanceof com.pullenti.ner.TextToken) && t.chars.isLetter()) {
            if (t.getLengthChar() > 2 && ((!t.chars.isAllLower() || t.chars.isLatinLetter()))) 
                return _new1279(t, t, com.pullenti.ner.goods.GoodAttrType.PROPER, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term);
            return null;
        }
        if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
            ...
            if (br != null) {
                ...
                if (res1 != null && res1.getEndToken().getNext() == br.getEndToken()) {
                    ...
                    res1 = _new1264(br.getBeginToken(), br.getEndToken(), com.pullenti.ner.goods.GoodAttrType.PROPER);
        ...
        if (t.isChar('(')) {
            ...
            if (br != null) {
                if (t.getNext().isValue("ПРИЛОЖЕНИЕ", null)) 
                    return _new1264(t, br.getEndToken(), com.pullenti.ner.goods.GoodAttrType.UNDEFINED);
            }
        }
    ...
    private static GoodAttrToken _tryParseModel(com.pullenti.ner.Token t) {
        if (t == null) 
            return null;
        GoodAttrToken res = _new1264(t, t, com.pullenti.ner.goods.GoodAttrType.MODEL);
    ...
    private static GoodAttrToken _tryParseNum(com.pullenti.ner.Token t) {
        if (t == null) 
            return null;
        com.pullenti.ner.measure.internal.MeasureToken mt = com.pullenti.ner.measure.internal.MeasureToken.tryParse(t, null, true, false);
        if (mt == null) 
        ...
        if (mt != null) {
            ...
            if (mrs != null && mrs.size() > 0 && (mrs.get(mrs.size() - 1).referent instanceof com.pullenti.ner.measure.MeasureReferent)) {
                ...
                GoodAttrToken res = _new1269(t, mt.getEndToken(), com.pullenti.ner.goods.GoodAttrType.NUMERIC, mr.getStringValue(com.pullenti.ner.measure.MeasureReferent.ATTR_NAME));
                res.value = mr.toString(true, null, 0);
                return res;
            }
        }
        java.util.ArrayList<com.pullenti.ner.measure.internal.NumbersWithUnitToken> mts = com.pullenti.ner.measure.internal.NumbersWithUnitToken.tryParseMulti(t, null, false, false, false);
        if ((mts != null && mts.size() == 1 && mts.get(0).units != null) && mts.get(0).units.size() > 0) {
            ...
            GoodAttrToken res = _new1264(t, mr.getEndToken(), com.pullenti.ner.goods.GoodAttrType.NUMERIC);
    ...
    private static GoodAttrToken _tryParseNum2(com.pullenti.ner.Token t) {
        ...
        if (tok != null && (t.getWhitespacesAfterCount() < 3)) {
            GoodAttrToken res = _new1264(t, tok.getEndToken(), com.pullenti.ner.goods.GoodAttrType.NUMERIC);
        ...
        if (num != null) {
            ...
            if (tt instanceof com.pullenti.ner.MetaToken) {
                if ((((com.pullenti.ner.MetaToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.MetaToken.class))).getEndToken().isValue("СП", null)) {
                    if (com.pullenti.unisharp.Utils.stringsEq(num.getValue(), "1")) 
                        return _new1279(t, tt, com.pullenti.ner.goods.GoodAttrType.CHARACTER, "односпальный");
                    if (com.pullenti.unisharp.Utils.stringsEq(num.getValue(), "1.5")) 
                        return _new1279(t, tt, com.pullenti.ner.goods.GoodAttrType.CHARACTER, "полутораспальный");
                    if (com.pullenti.unisharp.Utils.stringsEq(num.getValue(), "2")) 
                        return _new1279(t, tt, com.pullenti.ner.goods.GoodAttrType.CHARACTER, "вдухспальный");
                }
            }
            tt = tt.getNext();
            ...
            return _new1279(t, num.getEndToken(), com.pullenti.ner.goods.GoodAttrType.NUMERIC, num.getValue());
        }
        return null;
    }
    ...
    private static GoodAttrToken _tryParseChars(com.pullenti.ner.Token t) {
        ...
        if (com.pullenti.unisharp.Utils.isNullOrEmpty(val)) 
            return null;
        return _new1302(t, t3, com.pullenti.ner.goods.GoodAttrType.CHARACTER, _name, val);
    }
    ...
    public static void initialize() {
        ...
        m_NumSuff.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЕРШ", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addVariant("ЕРШИК", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("КОНДИЦИОНЕР", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addVariant("КОНДИЦ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("УДЛИНИТЕЛЬ", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addAbridge("УДЛ-ЛЬ");
        t.addAbridge("УДЛИН-ЛЬ");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("УСТРОЙСТВО", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addAbridge("УСТР-ВО");
        t.addAbridge("УСТР.");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПРОКЛАДКИ", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addVariant("ПРОКЛ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ДЕЗОДОРАНТ", com.pullenti.ner.goods.GoodAttrType.KEYWORD);
        t.addVariant("ДЕЗ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ОХЛАЖДЕННЫЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("ОХЛ", false);
        t.addVariant("ОХЛАЖД", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("МЕДИЦИНСКИЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("МЕД", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("СТЕРИЛЬНЫЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("СТЕР", false);
        t.addVariant("СТ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ХЛОПЧАТОБУМАЖНЫЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addAbridge("Х/Б");
        t.addAbridge("ХБ");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ДЕТСКИЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("ДЕТ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("МУЖСКОЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("МУЖ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЖЕНСКИЙ", com.pullenti.ner.goods.GoodAttrType.CHARACTER);
        t.addVariant("ЖЕН", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("СТРАНА", com.pullenti.ner.goods.GoodAttrType.REFERENT);
        t.addVariant("СТРАНА ПРОИСХОЖДЕНИЯ", false);
        t.addVariant("ПРОИСХОЖДЕНИЕ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПРОИЗВОДИТЕЛЬ", com.pullenti.ner.goods.GoodAttrType.REFERENT);
        t.addAbridge("ПР-ЛЬ");
        ...
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("ТОВАРНЫЙ ЗНАК", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("КАТАЛОЖНЫЙ НОМЕР", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "");
        t.addVariant("НОМЕР В КАТАЛОГЕ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("МАРКА", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("ФИРМА", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("МОДЕЛЬ", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "");
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new121("НЕТ", com.pullenti.ner.goods.GoodAttrType.UNDEFINED, "NO");
        t.addVariant("ОТСУТСТВОВАТЬ", false);
        t.addVariant("НЕ ИМЕТЬ", false);
        m_StdAbbrs.add(t);
        t = com.pullenti.ner.core.Termin._new119("БОЛЕЕ", com.pullenti.ner.goods.GoodAttrType.UNDEFINED);
    ...
    public static GoodAttrToken _new1262(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.value = _arg3;
        return res;
    }

    public static GoodAttrToken _new1263(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, com.pullenti.ner.Referent _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        return res;
    ...
    public static GoodAttrToken _new1264(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static GoodAttrToken _new1265(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static GoodAttrToken _new1266(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Referent _arg3, com.pullenti.ner.goods.GoodAttrType _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.ref = _arg3;
        res.typ = _arg4;
        return res;
    ...
    public static GoodAttrToken _new1267(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.ReferentToken _arg3, com.pullenti.ner.goods.GoodAttrType _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.refTok = _arg3;
        res.typ = _arg4;
        return res;
    ...
    public static GoodAttrToken _new1269(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, String _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.name = _arg4;
        return res;
    ...
    public static GoodAttrToken _new1271(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static GoodAttrToken _new1279(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, String _arg4) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static GoodAttrToken _new1302(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.goods.GoodAttrType _arg3, String _arg4, String _arg5) {
        GoodAttrToken res = new GoodAttrToken(_arg1, _arg2);
        res.typ = _arg3;
        res.name = _arg4;
        res.value = _arg5;

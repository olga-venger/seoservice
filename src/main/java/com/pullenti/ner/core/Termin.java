...
public class Termin {
    ...
    public static class Term {
        ...
        public static Term _new1921(com.pullenti.ner.TextToken _arg1, boolean _arg2) {
    ...
    public static class Abridge {
        ...
        public void addPart(String val, boolean hasDelim) {
            parts.add(com.pullenti.ner.core.Termin.AbridgePart._new620(val, hasDelim));
        }
        ...
        public com.pullenti.ner.core.TerminToken tryAttach(com.pullenti.ner.Token t0) {
            ...
            if (tail == null) {
                ...
                com.pullenti.ner.core.TerminToken res = com.pullenti.ner.core.TerminToken._new621(t0, te, t0 == te);
                if (point) 
    ...
    public static class AbridgePart {
        ...
        public static AbridgePart _new620(String _arg1, boolean _arg2) {
        ...
        public static AbridgePart _new622(String _arg1) {
            AbridgePart res = new AbridgePart();
            res.value = _arg1;
            return res;
        }
    ...
    public Abridge addAbridge(String abr) {
        ...
        if (i == 0) 
            return null;
        a.parts.add(AbridgePart._new622(abr.substring(0, 0 + i).toUpperCase()));
        abridges.add(a);
        if (((i + 1) < abr.length()) && abr.charAt(i) == '-') 
            ...
            for (; i < abr.length(); i++) {
                if (Character.isLetter(abr.charAt(i))) {
                    ...
                    AbridgePart p = AbridgePart._new622(abr.substring(i, i + j - i).toUpperCase());
                    if (j < abr.length()) {
        ...
        if (acronymSmart != null && (((pars.value()) & (TerminParseAttr.FULLWORDSONLY.value()))) == (TerminParseAttr.NO.value()) && term != null) {
            if (com.pullenti.unisharp.Utils.stringsEq(acronymSmart, term)) {
                if (t0.getNext() != null && t0.getNext().isChar('.') && !t0.isWhitespaceAfter()) 
                    return TerminToken._new624(t0, t0.getNext(), this);
                else 
                    return TerminToken._new624(t0, t0, this);
            }
            int i;
            com.pullenti.ner.TextToken t1 = (com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t0, com.pullenti.ner.TextToken.class);
            ...
            if (i >= acronym.length()) 
                return TerminToken._new624(t0, t1, this);
        }
    ...
    public static Termin _new114(String _arg1, String _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        return res;
    }

    public static Termin _new119(String _arg1, Object _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        return res;
    }

    public static Termin _new120(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        return res;
    ...
    public static Termin _new121(String _arg1, Object _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        return res;
    ...
    public static Termin _new143(String _arg1, String _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
    ...
    public static Termin _new145(String _arg1, Object _arg2, String _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        return res;
    ...
    public static Termin _new182(String _arg1, String _arg2, boolean _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
    ...
    public static Termin _new260(String _arg1, Object _arg2, com.pullenti.morph.MorphGender _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.setGender(_arg3);
        return res;
    ...
    public static Termin _new261(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new263(String _arg1, Object _arg2, Object _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new264(String _arg1, Object _arg2, com.pullenti.morph.MorphLang _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.lang = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new291(String _arg1, Object _arg2, String _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new304(String _arg1, String _arg2, Object _arg3, Object _arg4, com.pullenti.morph.MorphGender _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new308(String _arg1, String _arg2, Object _arg3, com.pullenti.morph.MorphLang _arg4, Object _arg5, com.pullenti.morph.MorphGender _arg6) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.lang = _arg4;
    ...
    public static Termin _new309(String _arg1, String _arg2, Object _arg3, com.pullenti.morph.MorphGender _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        res.setGender(_arg4);
    ...
    public static Termin _new332(Object _arg1, boolean _arg2) {
    ...
    public static Termin _new417(String _arg1, Object _arg2, Object _arg3, com.pullenti.morph.MorphLang _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.tag2 = _arg3;
        res.lang = _arg4;
    ...
    public static Termin _new457(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        return res;
    }

    public static Termin _new483(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4, Object _arg5) {
    ...
    public static Termin _new593(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.tag = _arg4;
        return res;
    }

    public static Termin _new695(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.setCanonicText(_arg4);
        return res;
    }

    public static Termin _new891(String _arg1, com.pullenti.morph.MorphLang _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.lang = _arg2;
        return res;
    }

    public static Termin _new903(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.tag2 = _arg4;
        return res;
    ...
    public static Termin _new907(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, String _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.acronym = _arg4;
        return res;
    ...
    public static Termin _new913(String _arg1, String _arg2, com.pullenti.morph.MorphLang _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.lang = _arg3;
        res.tag = _arg4;
    ...
    public static Termin _new916(String _arg1, Object _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.tag = _arg2;
        res.acronym = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new918(String _arg1, com.pullenti.morph.MorphLang _arg2, Object _arg3, String _arg4, Object _arg5) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.tag = _arg3;
        res.acronym = _arg4;
        res.tag2 = _arg5;
    ...
    public static Termin _new938(String _arg1, String _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new987(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, false);
    ...
    public static Termin _new1106(String _arg1, String _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        return res;
    }

    public static Termin _new1141(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.setCanonicText(_arg3);
        return res;
    }

    public static Termin _new1241(String _arg1, com.pullenti.morph.MorphLang _arg2) {
        Termin res = new Termin(null, null, false);
        res.acronym = _arg1;
        res.lang = _arg2;
        return res;
    ...
    public static Termin _new1488(String _arg1, com.pullenti.morph.MorphLang _arg2, String _arg3) {
        Termin res = new Termin(_arg1, _arg2, false);
        res.acronym = _arg3;
        return res;
    }

    public static Termin _new2297(String _arg1, Object _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.tag2 = _arg2;
        return res;
    }

    public static Termin _new2556(String _arg1, boolean _arg2) {
        Termin res = new Termin(_arg1, null, false);
        res.ignoreTermsOrder = _arg2;
        return res;
    }

    public static Termin _new2578(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.tag2 = _arg4;
        return res;
    }

    public static Termin _new2703(String _arg1, String _arg2, Object _arg3, String _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.acronym = _arg4;
    ...
    public static Termin _new2713(String _arg1, String _arg2, Object _arg3, String _arg4, boolean _arg5) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.acronym = _arg4;
    ...
    public static Termin _new2726(String _arg1, com.pullenti.morph.MorphLang _arg2, boolean _arg3, String _arg4, Object _arg5, Object _arg6) {
        Termin res = new Termin(_arg1, _arg2, _arg3);
        res.setCanonicText(_arg4);
        res.tag = _arg5;
        res.tag2 = _arg6;
    ...
    public static Termin _new2727(String _arg1, String _arg2, Object _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.tag = _arg3;
        res.tag2 = _arg4;
    ...
    public static Termin _new2730(String _arg1, String _arg2, String _arg3, Object _arg4, Object _arg5, boolean _arg6) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.acronym = _arg3;
        res.tag = _arg4;
    ...
    public static Termin _new2754(String _arg1, String _arg2, Object _arg3) {
        Termin res = new Termin(_arg1, null, false);
        res.acronym = _arg2;
        res.tag = _arg3;
        return res;
    ...
    public static Termin _new2763(String _arg1, String _arg2, String _arg3, Object _arg4) {
        Termin res = new Termin(_arg1, null, false);
        res.setCanonicText(_arg2);
        res.acronym = _arg3;
        res.tag = _arg4;

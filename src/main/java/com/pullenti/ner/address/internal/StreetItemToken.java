...
public class StreetItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static StreetItemToken _tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locStreets, boolean recurse, StreetItemToken prev, boolean ignoreOnto) {
        ...
        if (nt != null && nt.getIntValue() != null) 
            return _new219(nt.getBeginToken(), nt.getEndToken(), StreetItemType.AGE, nt);
        if ((((nt = (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class)))) != null) {
            if ((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(nt, com.pullenti.ner.NumberToken.class))).getIntValue() == null || (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(nt, com.pullenti.ner.NumberToken.class))).getIntValue() == 0) 
                return null;
            StreetItemToken res = _new220(nt, nt, StreetItemType.NUMBER, nt, nt.getMorph());
        ...
        if ((ntt != null && (ntt instanceof com.pullenti.ner.NumberToken) && prev != null) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(ntt, com.pullenti.ner.NumberToken.class))).getIntValue() != null) 
            return _new221(t, ntt, StreetItemType.NUMBER, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(ntt, com.pullenti.ner.NumberToken.class), true);
            ...
            if (tt.chars.isCapitalUpper() || ((prev != null && prev.typ == StreetItemType.NUMBER && tt.isValue("ТРАНСПОРТНЫЙ", null)))) {
                ...
                if (tte != null) {
                    if ((((((((((tte.isValue("ВАЛ", null) || tte.isValue("ТРАКТ", null) || tte.isValue("ПОЛЕ", null)) || tte.isValue("МАГИСТРАЛЬ", null) || tte.isValue("СПУСК", null)) || tte.isValue("ВЗВОЗ", null) || tte.isValue("РЯД", null)) || tte.isValue("СЛОБОДА", null) || tte.isValue("РОЩА", null)) || tte.isValue("ПРУД", null) || tte.isValue("СЪЕЗД", null)) || tte.isValue("КОЛЬЦО", null) || tte.isValue("МАГІСТРАЛЬ", null)) || tte.isValue("УЗВІЗ", null) || tte.isValue("ЛІНІЯ", null)) || tte.isValue("УЗВІЗ", null) || tte.isValue("ГАЙ", null)) || tte.isValue("СТАВОК", null) || tte.isValue("ЗЇЗД", null)) || tte.isValue("КІЛЬЦЕ", null)) {
                        StreetItemToken sit = _new222(tt, tte, true);
        ...
        if (((tt != null && tt.getLengthChar() == 1 && tt.chars.isAllLower()) && tt.getNext() != null && tt.getNext().isChar('.')) && tt.kit.baseLanguage.isRu()) {
            if (tt.isValue("М", null) || tt.isValue("M", null)) {
                if (prev != null && prev.typ == StreetItemType.NOUN) {
                    ...
                    return _new223(tt, tt.getNext(), m_Metro, StreetItemType.NOUN, true);
            }
        }
        ...
        if (ot != null) {
            StreetItemToken res0 = _new224(ot.getBeginToken(), ot.getEndToken(), StreetItemType.NAME, (com.pullenti.ner.address.StreetReferent)com.pullenti.unisharp.Utils.cast(ot.item.referent, com.pullenti.ner.address.StreetReferent.class), ot.getMorph(), true);
            return res0;
        }
        ...
        if (tok != null && !ignoreOnto) {
            if (((StreetItemType)tok.termin.tag) == StreetItemType.NUMBER) {
                if ((tok.getEndToken().getNext() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tok.getEndToken().getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) 
                    return _new225(t, tok.getEndToken().getNext(), StreetItemType.NUMBER, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tok.getEndToken().getNext(), com.pullenti.ner.NumberToken.class), true, tok.getMorph());
                return null;
            }
            if (tt == null) 
                return null;
            ...
            case 3: // StreetItemType.STDADJECTIVE 
                if (tt.chars.isAllLower() && prev == null) 
                    ...
                    if (!tok.getEndToken().isChar('.')) {
                        ...
                        if (oo2) 
                            return _new226(tok.getBeginToken(), tok.getEndToken(), StreetItemType.STDADJECTIVE, tok.termin, abr, tok.getMorph());
                        break;
                    }
            ...
            case 0: // StreetItemType.NOUN 
                ...
                if (tok.getBeginToken().isValue("ПР", null) && ((tok.getBeginToken() == tok.getEndToken() || tok.getBeginToken().getNext().isChar('.')))) 
                    alt = m_Prospect;
                return _new228(tok.getBeginToken(), tok.getEndToken(), StreetItemType.NOUN, tok.termin, alt, abr, tok.getMorph(), (tok.termin.tag2 instanceof Integer ? (int)tok.termin.tag2 : 0));
            case 4: // StreetItemType.STDNAME 
                ...
                if (tok.getBeginToken().chars.isAllLower() && !isPostOff && tok.getEndToken().chars.isAllLower()) 
                    return null;
                StreetItemToken sits = _new229(tok.getBeginToken(), tok.getEndToken(), StreetItemType.STDNAME, tok.getMorph(), tok.termin.getCanonicText());
            ...
            case 5: // StreetItemType.STDPARTOFNAME 
                ...
                if (sit == null) {
                    if (tok.getMorph().getNumber() == com.pullenti.morph.MorphNumber.PLURAL) 
                        return _new229(tok.getBeginToken(), tok.getEndToken(), StreetItemType.NAME, tok.getMorph(), com.pullenti.ner.core.MiscHelper.getTextValueOfMetaToken(tok, com.pullenti.ner.core.GetTextAttr.NO));
                    return null;
                }
                ...
                if (sit.typ == StreetItemType.NOUN) {
                    if (tok.getMorph().getNumber() == com.pullenti.morph.MorphNumber.PLURAL) 
                        ...
                        return _new232(tok.getBeginToken(), tok.getEndToken(), StreetItemType.NAME, tok.getMorph(), tok.termin);
                }
                if (sit.value != null) {
                    if (sit.altValue == null) 
            ...
            case 1: // StreetItemType.NAME 
                ...
                StreetItemToken sit1 = _new233(tok.getBeginToken(), tok.getEndToken(), StreetItemType.NAME, tok.getMorph(), true);
            ...
            case 7: // StreetItemType.FIX 
                return _new234(tok.getBeginToken(), tok.getEndToken(), StreetItemType.FIX, tok.getMorph(), true, tok.termin);
            }
        }
        if (tt != null) {
                ...
                if (tt.isValue("БАКИНСКИЙ", null) || "БАКИНСК".startsWith((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term)) {
                    ...
                    if (tt2.getNext() instanceof com.pullenti.ner.TextToken) {
                        ...
                        if (tt2.isValue("КОМИССАР", null) || tt2.isValue("КОММИССАР", null) || "КОМИС".startsWith((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt2, com.pullenti.ner.TextToken.class))).term)) {
                            if (tt2.getNext() != null && tt2.getNext().isChar('.')) 
                                tt2 = tt2.getNext();
                            StreetItemToken sit = _new235(tt, tt2, StreetItemType.STDNAME, true, "БАКИНСКИХ КОМИССАРОВ", tt2.getMorph());
                            return sit;
                        }
                    }
                }
            ...
            if (tt.chars.isCyrillicLetter() && tt.getLengthChar() > 1 && !tt.getMorph()._getClass().isPreposition()) {
                if (tt.isValue("ГЕРОЙ", null) || tt.isValue("ЗАЩИТНИК", "ЗАХИСНИК")) {
                    if ((tt.getNext() instanceof com.pullenti.ner.ReferentToken) && (tt.getNext().getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                        StreetItemToken re = _new236(tt, tt.getNext(), StreetItemType.STDPARTOFNAME, com.pullenti.ner.core.MiscHelper.getTextValue(tt, tt.getNext(), com.pullenti.ner.core.GetTextAttr.NO));
                        ...
                        if (sit == null || sit.typ != StreetItemType.NAME) {
                            ...
                            if (sit != null && ((sit.typ == StreetItemType.STDADJECTIVE || sit.typ == StreetItemType.NOUN))) 
                                ...
                                ok2 = true;
                            if (ok2) {
                                sit = _new237(tt, tt.getNext(), StreetItemType.NAME);
                ...
                if (ani != null) 
                    return _new238(t, ani.getEndToken(), StreetItemType.AGE, ani, ani.getValue().toString());
                boolean ok1 = false;
                ...
                if (ok1) {
                    ...
                    StreetItemToken res = _new239(tt, tt, StreetItemType.NAME, tt.getMorph());
                        ...
                        if (!AddressItemToken.checkHouseAfter(tt.getNext(), false, false) || tt.getNext().isNewlineAfter()) {
                            ...
                            if (nn == null || nn.typ == StreetItemType.NAME) {
                                ...
                                if (npt != null && npt.getEndToken() == nn.getEndToken()) {
                                    ...
                                    String var = com.pullenti.morph.Morphology.getWordform(res.value, com.pullenti.morph.MorphBaseInfo._new240(com.pullenti.morph.MorphCase.NOMINATIVE, com.pullenti.morph.MorphClass.ADJECTIVE, com.pullenti.morph.MorphNumber.SINGULAR, npt.getMorph().getGender()));
            ...
            if (((tt.isValue("РЕКА", null) || tt.isValue("РІЧКА", null))) && tt.getNext() != null && tt.getNext().chars.isCapitalUpper()) 
                return _new241(tt, tt.getNext(), StreetItemType.NAME, tt.getMorph(), tt.getNext().getSourceText().toUpperCase());
            if (tt.isValue("№", null) || tt.isValue("НОМЕР", null) || tt.isValue("НОМ", null)) {
                ...
                if ((tt1 instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.NumberToken.class))).getIntValue() != null) 
                    return _new221(tt, tt1, StreetItemType.NUMBER, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.NumberToken.class), true);
            }
            if (tt.isHiphen() && (tt.getNext() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt.getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                if (prev != null && prev.typ == StreetItemType.NOUN) {
                    if (com.pullenti.unisharp.Utils.stringsEq(prev.termin.getCanonicText(), "МИКРОРАЙОН") || com.pullenti.morph.LanguageHelper.endsWith(prev.termin.getCanonicText(), "ГОРОДОК")) 
                        return _new221(tt, tt.getNext(), StreetItemType.NUMBER, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt.getNext(), com.pullenti.ner.NumberToken.class), true);
                }
            }
        }
        ...
        if (r instanceof com.pullenti.ner.geo.GeoReferent) {
            ...
            if (prev != null && prev.typ == StreetItemType.NOUN) {
                if (AddressItemToken.checkHouseAfter(t.getNext(), false, false)) 
                    return _new236(t, t, StreetItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, t, com.pullenti.ner.core.GetTextAttr.NO));
            }
        }
        if (((tt instanceof com.pullenti.ner.TextToken) && tt.chars.isCapitalUpper() && tt.chars.isLatinLetter()) && (tt.getWhitespacesAfterCount() < 2)) {
            ...
            if (tok1 != null) 
                return _new229(tt, tt2.getPrevious(), StreetItemType.NAME, tt.getMorph(), (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term);
        }
        return null;
    }
    ...
    public static java.util.ArrayList<StreetItemToken> tryParseSpec(com.pullenti.ner.Token t, StreetItemToken prev) {
        ...
        if (t.getReferent() instanceof com.pullenti.ner.date.DateReferent) {
            ...
            if (dr.getYear() == 0 && dr.getDay() > 0 && dr.getMonth() > 0) {
                ...
                res.add(_new219(t, t, StreetItemType.NUMBER, new com.pullenti.ner.NumberToken(t, t, ((Integer)dr.getDay()).toString(), com.pullenti.ner.NumberSpellingType.DIGIT, null)));
                String tmp = dr.toString(false, t.getMorph().getLanguage(), 0);
                int i = tmp.indexOf(' ');
                res.add((sit = _new236(t, t, StreetItemType.STDNAME, tmp.substring(i + 1).toUpperCase())));
                sit.chars.setCapitalUpper(true);
                return res;
            }
            if (dr.getYear() > 0 && dr.getMonth() == 0) {
                res = new java.util.ArrayList<StreetItemToken>();
                res.add(_new219(t, t, StreetItemType.NUMBER, new com.pullenti.ner.NumberToken(t, t, ((Integer)dr.getYear()).toString(), com.pullenti.ner.NumberSpellingType.DIGIT, null)));
                res.add((sit = _new236(t, t, StreetItemType.STDNAME, (t.getMorph().getLanguage().isUa() ? "РОКУ" : "ГОДА"))));
                sit.chars.setCapitalUpper(true);
                return res;
            }
            return null;
        ...
        if (prev != null && prev.typ == StreetItemType.AGE) {
            ...
            if (t.getReferent() instanceof com.pullenti.ner.geo.GeoReferent) 
                res.add((sit = _new250(t, t, StreetItemType.NAME, t.getSourceText().toUpperCase(), t.getReferent().toString(true, t.kit.baseLanguage, 0).toUpperCase())));
            else if (t.isValue("ГОРОД", null) || t.isValue("МІСТО", null)) 
                res.add((sit = _new236(t, t, StreetItemType.NAME, "ГОРОДА")));
            else 
                return null;
            return res;
        }
        if (prev != null && prev.typ == StreetItemType.NOUN) {
            ...
            if (num != null && num.getIntValue() != null) {
                res = new java.util.ArrayList<StreetItemToken>();
                res.add((sit = _new219(num.getBeginToken(), num.getEndToken(), StreetItemType.NUMBER, num)));
            ...
            if (t.isChar('.') && sit != null && sit.typ == StreetItemType.NOUN) {
                ...
                if (sit == null) {
                    ...
                    if (((t instanceof com.pullenti.ner.TextToken) && ((res.size() == 2 || res.size() == 3)) && res.get(0).typ == StreetItemType.NOUN) && res.get(1).typ == StreetItemType.NUMBER && (((com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "ГОДА") || com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "МАЯ") || com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "МАРТА")) || com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "СЪЕЗДА")))) {
                        res.add((sit = _new236(t, t, StreetItemType.STDNAME, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term)));
                        continue;
                    }
                    sit = res.get(res.size() - 1);
                    if (t == null) 
                    ...
                    if (sit.typ == StreetItemType.NOUN && ((com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "МИКРОРАЙОН") || com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "МІКРОРАЙОН"))) && (t.getWhitespacesBeforeCount() < 2)) {
                        ...
                        if (((tt1 instanceof com.pullenti.ner.TextToken) && tt1.getLengthChar() == 1 && tt1.chars.isLetter()) && ((AddressItemToken.checkHouseAfter(tt2, false, true) || tt2 == null))) {
                            sit = _new236(t, (br ? tt1.getNext() : tt1), StreetItemType.NAME, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term);
                    ...
                    if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
                        ...
                        if (sit1.typ == StreetItemType.NOUN && ((sit1.nounIsDoubtCoef == 0 || (((t.getNext() instanceof com.pullenti.ner.TextToken) && !t.getNext().chars.isAllLower()))))) {
                            ...
                            if (br != null && (br.getLengthChar() < 50)) {
                                ...
                                res.add(_new255(t, br.getEndToken(), StreetItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, br.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO), true));
                                t = br.getEndToken();
                                continue;
                            }
                        }
                    ...
                    if (t.isHiphen() && (t.getNext() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                        ...
                        if (sit.typ == StreetItemType.NOUN && (((com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "КВАРТАЛ") || com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "МИКРОРАЙОН") || com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "ГОРОДОК")) || com.pullenti.unisharp.Utils.stringsEq(sit.termin.getCanonicText(), "МІКРОРАЙОН")))) {
                            sit = _new221(t, t.getNext(), StreetItemType.NUMBER, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class), true);
                            res.add(sit);
                            t = t.getNext();
                            continue;
                        }
                ...
                if (tt != null && (tt.getReferent() instanceof com.pullenti.ner.geo.GeoReferent)) {
                    ...
                    if (g2 != null) {
                        if (g1.isCity() && g2.isCity()) {
                            StreetItemToken nam = _new237(res.get(0).getEndToken().getNext(), tt, StreetItemType.NAME);
                    ...
                    if (br != null) {
                        StreetItemToken nam = _new258(tt, br.getEndToken(), StreetItemType.NAME, true);
    ...
    private static StreetItemToken _tryAttachRoadNum(com.pullenti.ner.Token t) {
        ...
        if (!((tt instanceof com.pullenti.ner.NumberToken))) 
            return null;
        StreetItemToken res = _new237(t, tt, StreetItemType.NAME);
    ...
    public static void initialize() throws Exception, java.io.IOException {
        ...
        t = com.pullenti.ner.core.Termin._new260("УЛИЦА", StreetItemType.NOUN, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("УЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new261("ВУЛИЦЯ", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("ВУЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("STREET", StreetItemType.NOUN);
        t.addAbridge("ST.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПЛОЩАДЬ", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("ПЛ.");
        t.addAbridge("ПЛОЩ.");
        t.addAbridge("ПЛ-ДЬ");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("ПЛОЩА", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("ПЛ.");
        t.addAbridge("ПЛОЩ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("МАЙДАН", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("SQUARE", StreetItemType.NOUN);
        t.addAbridge("SQ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПРОЕЗД", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("ПР.");
        t.addAbridge("П-Д");
        t.addAbridge("ПР-Д");
        t.addAbridge("ПР-ЗД");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ЛИНИЯ", StreetItemType.NOUN, 2, com.pullenti.morph.MorphGender.FEMINIE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("ЛІНІЯ", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 2, com.pullenti.morph.MorphGender.FEMINIE);
        m_Ontology.add(t);
        m_Prospect = (t = com.pullenti.ner.core.Termin._new263("ПРОСПЕКТ", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE));
        t.addAbridge("ПРОС.");
        t.addAbridge("ПРКТ");
        t.addAbridge("ПРОСП.");
        t.addAbridge("ПР-Т");
        ...
        t.addAbridge("П-КТЕ");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПЕРЕУЛОК", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("ПЕР.");
        t.addAbridge("ПЕР-К");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПРОУЛОК", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("ПРОУЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("ПРОВУЛОК", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("ПРОВ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("LANE", StreetItemType.NOUN, 0);
        t.addAbridge("LN.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ТУПИК", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("ТУП.");
        t.addAbridge("Т.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("БУЛЬВАР", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("БУЛЬВ.");
        t.addAbridge("БУЛ.");
        t.addAbridge("Б-Р");
        t.addAbridge("Б-РЕ");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("BOULEVARD", StreetItemType.NOUN, 0);
        t.addAbridge("BLVD");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("СКВЕР", StreetItemType.NOUN, 1);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("НАБЕРЕЖНАЯ", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("НАБ.");
        t.addAbridge("НАБЕР.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("НАБЕРЕЖНА", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 0, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("НАБ.");
        t.addAbridge("НАБЕР.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("АЛЛЕЯ", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("АЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("АЛЕЯ", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 0, com.pullenti.morph.MorphGender.FEMINIE);
        t.addAbridge("АЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("ALLEY", StreetItemType.NOUN, 0);
        t.addAbridge("ALY.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПРОСЕКА", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("ПРОСЕК", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("ПРОСІКА", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 1, com.pullenti.morph.MorphGender.FEMINIE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ШОССЕ", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.NEUTER);
        t.addAbridge("Ш.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("ШОСЕ", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 1, com.pullenti.morph.MorphGender.NEUTER);
        t.addAbridge("Ш.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("ROAD", StreetItemType.NOUN, 1);
        t.addAbridge("RD.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("МИКРОРАЙОН", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("МКР.");
        t.addAbridge("МИКР-Н");
        t.addAbridge("МКР-Н");
        t.addAbridge("МКРН.");
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("КВАРТАЛ", StreetItemType.NOUN, 2, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("КВАРТ.");
        t.addAbridge("КВ-Л");
        t.addAbridge("КВ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new291("ЖИЛОЙ КОМПЛЕКС", StreetItemType.NOUN, "ЖК", 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addVariant("ЖИЛКОМПЛЕКС", false);
        t.addAbridge("ЖИЛ.К.");
        t.addAbridge("Ж/К");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ГОРОДОК", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("МІСТЕЧКО", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 0, com.pullenti.morph.MorphGender.NEUTER);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("HILL", StreetItemType.NOUN, 0);
        t.addAbridge("HL.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ВОЕННЫЙ ГОРОДОК", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.MASCULINE);
        t.addAbridge("В.ГОРОДОК");
        t.addAbridge("В/Г");
        t.addAbridge("В/ГОРОДОК");
        t.addAbridge("В/ГОР");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПРОМЗОНА", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("ПРОМЫШЛЕННАЯ ЗОНА", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ЖИЛАЯ ЗОНА", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("ЖИЛЗОНА", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("КОММУНАЛЬНАЯ ЗОНА", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("КОМЗОНА", false);
        t.addAbridge("КОММУН. ЗОНА");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("МАССИВ", StreetItemType.NOUN, 2, com.pullenti.morph.MorphGender.MASCULINE);
        t.addVariant("ЖИЛОЙ МАССИВ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("МОСТ", StreetItemType.NOUN, 2, com.pullenti.morph.MorphGender.MASCULINE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("МІСТ", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 2, com.pullenti.morph.MorphGender.MASCULINE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new263("ПАРК", StreetItemType.NOUN, 2, com.pullenti.morph.MorphGender.MASCULINE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("PLAZA", StreetItemType.NOUN, 1);
        t.addAbridge("PLZ");
        m_Ontology.add(t);
        m_Metro = (t = com.pullenti.ner.core.Termin._new304("СТАНЦИЯ МЕТРО", "МЕТРО", StreetItemType.NOUN, 0, com.pullenti.morph.MorphGender.FEMINIE));
        t.addVariant("СТАНЦІЯ МЕТРО", false);
        t.addAbridge("СТ.МЕТРО");
        t.addAbridge("СТ.М.");
        t.addAbridge("МЕТРО");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new291("АВТОДОРОГА", StreetItemType.NOUN, "ФАД", 0, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new304("ДОРОГА", "АВТОДОРОГА", StreetItemType.NOUN, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("ТРАССА", false);
        t.addVariant("МАГИСТРАЛЬ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new264("АВТОДОРОГА", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 0, com.pullenti.morph.MorphGender.FEMINIE);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new308("ДОРОГА", "АВТОДОРОГА", StreetItemType.NOUN, com.pullenti.morph.MorphLang.UA, 1, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("ТРАСА", false);
        t.addVariant("МАГІСТРАЛЬ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new309("МОСКОВСКАЯ КОЛЬЦЕВАЯ АВТОМОБИЛЬНАЯ ДОРОГА", "МКАД", StreetItemType.FIX, com.pullenti.morph.MorphGender.FEMINIE);
        t.addVariant("МОСКОВСКАЯ КОЛЬЦЕВАЯ АВТОДОРОГА", false);
        m_Ontology.add(t);
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("САДОВОЕ КОЛЬЦО", StreetItemType.FIX));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("БУЛЬВАРНОЕ КОЛЬЦО", StreetItemType.FIX));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ТРАНСПОРТНОЕ КОЛЬЦО", StreetItemType.FIX));
        t = com.pullenti.ner.core.Termin._new260("ПОЧТОВОЕ ОТДЕЛЕНИЕ", StreetItemType.STDNAME, com.pullenti.morph.MorphGender.NEUTER);
        t.addAbridge("П.О.");
        t.addAbridge("ПОЧТ.ОТД.");
        t.addAbridge("ПОЧТОВ.ОТД.");
        t.addAbridge("ПОЧТОВОЕ ОТД.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("БОЛЬШОЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("БОЛ.");
        t.addAbridge("Б.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new120("ВЕЛИКИЙ", StreetItemType.STDADJECTIVE, com.pullenti.morph.MorphLang.UA);
        t.addAbridge("ВЕЛ.");
        t.addAbridge("В.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("МАЛЫЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("МАЛ.");
        t.addAbridge("М.");
        t.addVariant("МАЛИЙ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("СРЕДНИЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("СРЕД.");
        t.addAbridge("СР.");
        t.addAbridge("С.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new120("СЕРЕДНІЙ", StreetItemType.STDADJECTIVE, com.pullenti.morph.MorphLang.UA);
        t.addAbridge("СЕРЕД.");
        t.addAbridge("СЕР.");
        t.addAbridge("С.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ВЕРХНИЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("ВЕРХН.");
        t.addAbridge("ВЕРХ.");
        t.addAbridge("ВЕР.");
        t.addAbridge("В.");
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("НИЖНИЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("НИЖН.");
        t.addAbridge("НИЖ.");
        t.addAbridge("Н.");
        t.addVariant("НИЖНІЙ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("СТАРЫЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("СТАР.");
        t.addAbridge("СТ.");
        t.addVariant("СТАРИЙ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("НОВЫЙ", StreetItemType.STDADJECTIVE);
        t.addAbridge("НОВ.");
        t.addVariant("НОВИЙ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("НОМЕР", StreetItemType.STDADJECTIVE);
        t.addAbridge("N");
        t.addAbridge("№");
        t.addAbridge("НОМ.");
        m_Ontology.add(t);
        for (String s : new String[] {"ФРИДРИХА ЭНГЕЛЬСА", "КАРЛА МАРКСА", "РОЗЫ ЛЮКСЕМБУРГ"}) {
            t = com.pullenti.ner.core.Termin._new119(s, StreetItemType.STDNAME);
            t.addAllAbridges(0, 0, 0);
            m_Ontology.add(t);
        }
        for (String s : new String[] {"МАРТА", "МАЯ", "ОКТЯБРЯ", "НОЯБРЯ", "БЕРЕЗНЯ", "ТРАВНЯ", "ЖОВТНЯ", "ЛИСТОПАДА"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new119(s, StreetItemType.STDNAME));
        }
        for (String s : new String[] {"МАРШАЛА", "ГЕНЕРАЛА", "АДМИРАЛА", "КОСМОНАВТА", "ЛЕТЧИКА", "АВИАКОНСТРУКТОРА", "АРХИТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "АКАДЕМИКА", "ПРОФЕССОРА", "ЛЕЙТЕНАНТА", "КАПИТАНА", "МАЙОРА", "ПОДПОЛКОВНИКА", "ПОЛКОВНИКА", "ПОЛИЦИИ", "МИЛИЦИИ"}) {
            ...
            t = com.pullenti.ner.core.Termin._new119(s, StreetItemType.STDPARTOFNAME);
        ...
        for (String s : new String[] {"МАРШАЛА", "ГЕНЕРАЛА", "АДМІРАЛА", "КОСМОНАВТА", "ЛЬОТЧИКА", "АВІАКОНСТРУКТОРА", "АРХІТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "АКАДЕМІКА", "ПРОФЕСОРА", "ЛЕЙТЕНАНТА", "КАПІТАН", "МАЙОР", "ПІДПОЛКОВНИК", "ПОЛКОВНИК", "ПОЛІЦІЇ", "МІЛІЦІЇ"}) {
            m_StdOntMisc.add(new com.pullenti.ner.core.Termin(s, null, false));
            t = com.pullenti.ner.core.Termin._new120(s, StreetItemType.STDPARTOFNAME, com.pullenti.morph.MorphLang.UA);
            t.addAllAbridges(0, 0, 2);
            t.addAllAbridges(2, 5, 0);
            t.addAbridge("ГЛ." + s);
            t.addAbridge("ГЛАВ." + s);
        ...
        t = com.pullenti.ner.core.Termin._new119("ВАСИЛЬЕВСКОГО ОСТРОВА", StreetItemType.STDNAME);
        t.addAbridge("В.О.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПЕТРОГРАДСКОЙ СТОРОНЫ", StreetItemType.STDNAME);
        t.addAbridge("П.С.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ОЛИМПИЙСКАЯ ДЕРЕВНЯ", StreetItemType.FIX);
        t.addAbridge("ОЛИМП. ДЕРЕВНЯ");
        t.addAbridge("ОЛИМП. ДЕР.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЛЕНИНСКИЕ ГОРЫ", StreetItemType.FIX);
        m_Ontology.add(t);
        ...
        for (String line0 : com.pullenti.unisharp.Utils.split(streets, String.valueOf('\n'), false)) {
            ...
            if (line.indexOf(';') >= 0) {
                ...
                t = com.pullenti.ner.core.Termin._new332(StreetItemType.NAME, true);
    ...
    public static StreetItemToken _new219(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.NumberToken _arg4) {
    ...
    public static StreetItemToken _new220(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.NumberToken _arg4, com.pullenti.ner.MorphCollection _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.number = _arg4;
        res.setMorph(_arg5);
    ...
    public static StreetItemToken _new221(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.NumberToken _arg4, boolean _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.number = _arg4;
    ...
    public static StreetItemToken _new222(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.hasStdSuffix = _arg3;
        return res;
    }

    public static StreetItemToken _new223(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.core.Termin _arg3, StreetItemType _arg4, boolean _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.termin = _arg3;
        res.typ = _arg4;
        res.isAbridge = _arg5;
    ...
    public static StreetItemToken _new224(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.address.StreetReferent _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static StreetItemToken _new225(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.NumberToken _arg4, boolean _arg5, com.pullenti.ner.MorphCollection _arg6) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.number = _arg4;
        res.numberHasPrefix = _arg5;
    ...
    public static StreetItemToken _new226(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.core.Termin _arg4, boolean _arg5, com.pullenti.ner.MorphCollection _arg6) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.termin = _arg4;
        res.isAbridge = _arg5;
    ...
    public static StreetItemToken _new228(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.core.Termin _arg4, com.pullenti.ner.core.Termin _arg5, boolean _arg6, com.pullenti.ner.MorphCollection _arg7, int _arg8) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.termin = _arg4;
        res.altTermin = _arg5;
    ...
    public static StreetItemToken _new229(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4, String _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.value = _arg5;
    ...
    public static StreetItemToken _new232(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4, com.pullenti.ner.core.Termin _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.termin = _arg5;
    ...
    public static StreetItemToken _new233(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4, boolean _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
    ...
    public static StreetItemToken _new234(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4, boolean _arg5, com.pullenti.ner.core.Termin _arg6) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.isInDictionary = _arg5;
    ...
    public static StreetItemToken _new235(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, boolean _arg4, String _arg5, com.pullenti.ner.MorphCollection _arg6) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static StreetItemToken _new236(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, String _arg4) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static StreetItemToken _new237(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static StreetItemToken _new238(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.NumberToken _arg4, String _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.number = _arg4;
        res.value = _arg5;
    ...
    public static StreetItemToken _new239(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static StreetItemToken _new241(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, com.pullenti.ner.MorphCollection _arg4, String _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.altValue = _arg5;
    ...
    public static StreetItemToken _new250(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, String _arg4, String _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.altValue = _arg5;
    ...
    public static StreetItemToken _new255(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, String _arg4, boolean _arg5) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
    ...
    public static StreetItemToken _new258(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, StreetItemType _arg3, boolean _arg4) {
        StreetItemToken res = new StreetItemToken(_arg1, _arg2);
        res.typ = _arg3;

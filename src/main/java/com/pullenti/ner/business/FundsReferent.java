...
public class FundsReferent extends com.pullenti.ner.Referent {
    ...
    public int getCount() {
        ...
        if (val == null) 
            return 0;
        int v;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapv452 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres453 = com.pullenti.unisharp.Utils.parseInteger(val, 0, null, wrapv452);
        v = (wrapv452.value != null ? wrapv452.value : 0);
        if (!inoutres453) 
            return 0;
        return v;
    }

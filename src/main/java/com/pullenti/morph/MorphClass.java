...
public class MorphClass {
    ...
    public static MorphClass _new64(short _arg1) {
    ...
    public static MorphClass _new75(boolean _arg1) {
        MorphClass res = new MorphClass(null);
        res.setConjunction(_arg1);
        return res;
    }

    public static MorphClass _new2510(boolean _arg1) {
        MorphClass res = new MorphClass(null);
    ...
    static {
        ...
        UNDEFINED = _new67(true);
        NOUN = _new68(true);
        PRONOUN = _new69(true);
        PERSONALPRONOUN = _new70(true);
        VERB = _new71(true);
        ADJECTIVE = _new72(true);
        ADVERB = _new73(true);
        PREPOSITION = _new74(true);
        CONJUNCTION = _new75(true);
    }
}

...
public class MoneyReferent extends com.pullenti.ner.Referent {
    ...
    public double getValue() {
        ...
        if (val == null) 
            return 0.0;
        double v;
        com.pullenti.unisharp.Outargwrapper<Double> wrapv1713 = new com.pullenti.unisharp.Outargwrapper<Double>();
        boolean inoutres1714 = com.pullenti.unisharp.Utils.parseDouble(val, null, wrapv1713);
        v = (wrapv1713.value != null ? wrapv1713.value : 0);
        if (!inoutres1714) 
            return 0.0;
        return v;
    }
    ...
    public Double getAltValue() {
        ...
        if (val == null) 
            return null;
        double v;
        com.pullenti.unisharp.Outargwrapper<Double> wrapv1715 = new com.pullenti.unisharp.Outargwrapper<Double>();
        boolean inoutres1716 = com.pullenti.unisharp.Utils.parseDouble(val, null, wrapv1715);
        v = (wrapv1715.value != null ? wrapv1715.value : 0);
        if (!inoutres1716) 
            return null;
        return v;
    }
    ...
    public int getRest() {
        ...
        if (val == null) 
            return 0;
        int v;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapv1717 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres1718 = com.pullenti.unisharp.Utils.parseInteger(val, 0, null, wrapv1717);
        v = (wrapv1717.value != null ? wrapv1717.value : 0);
        if (!inoutres1718) 
            return 0;
        return v;
    }
    ...
    public Integer getAltRest() {
        ...
        if (val == null) 
            return null;
        int v;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapv1719 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres1720 = com.pullenti.unisharp.Utils.parseInteger(val, 0, null, wrapv1719);
        v = (wrapv1719.value != null ? wrapv1719.value : 0);
        if (!inoutres1720) 
            return null;
        return v;
    }
    ...
    public static MoneyReferent _new830(String _arg1, double _arg2) {

...
public class CanonicDecreeRefUri {
    ...
    public static CanonicDecreeRefUri _new825(String _arg1, com.pullenti.ner.Referent _arg2, int _arg3, int _arg4) {
    ...
    public static CanonicDecreeRefUri _new827(String _arg1, com.pullenti.ner.Referent _arg2, int _arg3, int _arg4, boolean _arg5) {
        CanonicDecreeRefUri res = new CanonicDecreeRefUri(_arg1);
        res.ref = _arg2;
        res.beginChar = _arg3;
        res.endChar = _arg4;

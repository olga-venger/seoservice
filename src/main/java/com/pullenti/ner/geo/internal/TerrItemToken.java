...
public class TerrItemToken extends com.pullenti.ner.MetaToken {
    ...
    private static TerrItemToken _tryParseRzdDir(com.pullenti.ner.Token t) {
        ...
        if (tt0 != null) {
            TerrItemToken ci = _new1163(tt0, tt1, true);
            if (val != null) 
                ci.rzdDir = val;
            else {
    ...
    public static TerrItemToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection intOnt, boolean canBeLowCapital, boolean nounCanBeAdjective) {
        ...
        if (res == null) {
            if (nounCanBeAdjective && t.getMorph()._getClass().isAdjective()) {
                ...
                if (tok != null) 
                    return _new1164(tok.getBeginToken(), tok.getEndToken(), (TerrTermin)com.pullenti.unisharp.Utils.cast(tok.termin.tag, TerrTermin.class), false);
            }
                ...
                if (((t.getMorph()._getClass().isAdjective() || t.chars.isAllUpper() || (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term.endsWith("ЖД"))) || ((t.getNext() != null && t.getNext().isHiphen()))) {
                    ...
                    if (rt0 != null) {
                        if ((((String)com.pullenti.unisharp.Utils.notnull(rt0.referent.getStringValue("TYPE"), ""))).endsWith("дорога")) 
                            return _new1174(t, rt0.getEndToken(), rt0, rt0.getMorph());
                    }
                }
    ...
    private static TerrItemToken _TryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection intOnt, boolean canBeLowCapital) {
            ...
            for (com.pullenti.ner.core.IntOntologyToken nt : li) {
                if (nt.item != null && !((nt.termin.tag instanceof com.pullenti.ner.core.IntOntologyItem))) {
                    if (canBeLowCapital || !com.pullenti.ner.core.MiscHelper.isAllCharactersLower(nt.getBeginToken(), nt.getEndToken(), false) || nt.getBeginToken() != nt.getEndToken()) {
                        TerrItemToken res0 = _new1176(nt.getBeginToken(), nt.getEndToken(), nt.item, nt.getMorph());
            ...
            for (com.pullenti.ner.core.IntOntologyToken nt : li) {
                if (nt.item != null && (nt.termin.tag instanceof com.pullenti.ner.core.IntOntologyItem)) {
                    if (nt.getEndToken().getNext() == null || !nt.getEndToken().getNext().isHiphen()) {
                        TerrItemToken res1 = _new1177(nt.getBeginToken(), nt.getEndToken(), nt.item, true, nt.getMorph());
                        if ((li.size() == 2 && nt == li.get(0) && li.get(1).item != null) && (li.get(1).termin.tag instanceof com.pullenti.ner.core.IntOntologyItem)) 
            ...
            for (com.pullenti.ner.core.IntOntologyToken nt : li) {
                if (nt.termin != null && nt.item == null) {
                    if (nt.getEndToken().getNext() == null || !nt.getEndToken().getNext().isHiphen() || !(((TerrTermin)com.pullenti.unisharp.Utils.cast(nt.termin, TerrTermin.class))).isAdjective) {
                        TerrItemToken res1 = _new1178(nt.getBeginToken(), nt.getEndToken(), (TerrTermin)com.pullenti.unisharp.Utils.cast(nt.termin, TerrTermin.class), (((TerrTermin)com.pullenti.unisharp.Utils.cast(nt.termin, TerrTermin.class))).isAdjective, nt.getMorph());
                        if (!res1.isAdjective) {
        ...
        if (((tt.getLengthChar() == 2 || tt.getLengthChar() == 3)) && tt.chars.isAllUpper()) {
            if (m_Alpha2State.containsKey(tt.term)) {
                ...
                if (ok) 
                    return _new1165(tt, tt, m_Alpha2State.get(tt.term));
            }
        }
        ...
        if (npt != null) {
            if (((npt.noun.isValue("ФЕДЕРАЦИЯ", null) || npt.noun.isValue("ФЕДЕРАЦІЯ", null))) && npt.adjectives.size() == 1) {
                if (com.pullenti.ner.core.MiscHelper.isNotMoreThanOneError("РОССИЙСКАЯ", npt.adjectives.get(0)) || com.pullenti.ner.core.MiscHelper.isNotMoreThanOneError("РОСІЙСЬКА", npt.adjectives.get(0))) 
                    return _new1176(npt.getBeginToken(), npt.getEndToken(), (t0.kit.baseLanguage.isUa() ? m_RussiaUA : m_RussiaRU), npt.getMorph());
            }
        }
    ...
    public static TerrItemToken tryParseDistrictName(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection intOnt) {
        ...
        String str = (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term;
        TerrItemToken res = _new1181(t, t, true);
    ...
    public static void initialize() throws Exception, java.io.IOException, javax.xml.stream.XMLStreamException, org.xml.sax.SAXException {
        ...
        t = TerrTermin._new1182("ГОСУДАРСТВО", true);
        t.addAbridge("ГОС-ВО");
        m_TerrOntology.add(t);
        t = TerrTermin._new1183("ДЕРЖАВА", com.pullenti.morph.MorphLang.UA, true);
        m_TerrOntology.add(t);
        ...
        for (String s : new String[] {"СОЮЗ", "СОДРУЖЕСТВО", "ФЕДЕРАЦИЯ", "КОНФЕДЕРАЦИЯ"}) {
            m_TerrOntology.add(TerrTermin._new1184(s, true, true));
        }
        for (String s : new String[] {"СОЮЗ", "СПІВДРУЖНІСТЬ", "ФЕДЕРАЦІЯ", "КОНФЕДЕРАЦІЯ"}) {
            m_TerrOntology.add(TerrTermin._new1185(s, com.pullenti.morph.MorphLang.UA, true, true));
        }
        for (String s : new String[] {"КОРОЛЕВСТВО", "КНЯЖЕСТВО", "ГЕРЦОГСТВО", "ИМПЕРИЯ", "ЦАРСТВО", "KINGDOM", "DUCHY", "EMPIRE"}) {
            m_TerrOntology.add(TerrTermin._new1182(s, true));
        }
        for (String s : new String[] {"КОРОЛІВСТВО", "КНЯЗІВСТВО", "ГЕРЦОГСТВО", "ІМПЕРІЯ"}) {
            m_TerrOntology.add(TerrTermin._new1183(s, com.pullenti.morph.MorphLang.UA, true));
        }
        for (String s : new String[] {"НЕЗАВИСИМЫЙ", "ОБЪЕДИНЕННЫЙ", "СОЕДИНЕННЫЙ", "НАРОДНЫЙ", "НАРОДНО", "ФЕДЕРАТИВНЫЙ", "ДЕМОКРАТИЧЕСКИЙ", "СОВЕТСКИЙ", "СОЦИАЛИСТИЧЕСКИЙ", "КООПЕРАТИВНЫЙ", "ИСЛАМСКИЙ", "АРАБСКИЙ", "МНОГОНАЦИОНАЛЬНЫЙ", "СУВЕРЕННЫЙ", "САМОПРОВОЗГЛАШЕННЫЙ", "НЕПРИЗНАННЫЙ"}) {
            m_TerrOntology.add(TerrTermin._new1188(s, true, true));
        }
        for (String s : new String[] {"НЕЗАЛЕЖНИЙ", "ОБЄДНАНИЙ", "СПОЛУЧЕНИЙ", "НАРОДНИЙ", "ФЕДЕРАЛЬНИЙ", "ДЕМОКРАТИЧНИЙ", "РАДЯНСЬКИЙ", "СОЦІАЛІСТИЧНИЙ", "КООПЕРАТИВНИЙ", "ІСЛАМСЬКИЙ", "АРАБСЬКИЙ", "БАГАТОНАЦІОНАЛЬНИЙ", "СУВЕРЕННИЙ"}) {
            m_TerrOntology.add(TerrTermin._new1189(s, com.pullenti.morph.MorphLang.UA, true, true));
        }
        t = TerrTermin._new1190("ОБЛАСТЬ", true);
        t.addAbridge("ОБЛ.");
        m_TerrNounAdjectives.add(com.pullenti.ner.core.Termin._new119("ОБЛАСТНОЙ", t));
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("REGION", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1193("ОБЛАСТЬ", com.pullenti.morph.MorphLang.UA, true);
        t.addAbridge("ОБЛ.");
        m_TerrOntology.add(t);
        t = TerrTermin._new1194(null, true, "АО");
        m_TerrOntology.add(t);
        t = TerrTermin._new1195(null, com.pullenti.morph.MorphLang.UA, true, "АО");
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("РАЙОН", true);
        t.addAbridge("Р-Н");
        t.addAbridge("Р-ОН");
        t.addAbridge("РН.");
        m_TerrNounAdjectives.add(com.pullenti.ner.core.Termin._new119("РАЙОННЫЙ", t));
        m_TerrOntology.add(t);
        t = TerrTermin._new1193("РАЙОН", com.pullenti.morph.MorphLang.UA, true);
        t.addAbridge("Р-Н");
        t.addAbridge("Р-ОН");
        t.addAbridge("РН.");
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("УЛУС", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("УЕЗД", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1201("ШТАТ", true, true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("STATE", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1203("ШТАТ", com.pullenti.morph.MorphLang.UA, true, true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1201("ПРОВИНЦИЯ", true, true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1203("ПРОВІНЦІЯ", com.pullenti.morph.MorphLang.UA, true, true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("PROVINCE", true);
        t.addVariant("PROVINCIAL", false);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("ПРЕФЕКТУРА", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("PREFECTURE", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("АВТОНОМИЯ", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("AUTONOMY", true);
        m_TerrOntology.add(t);
        t = TerrTermin._new1193("АВТОНОМІЯ", com.pullenti.morph.MorphLang.UA, true);
        m_TerrOntology.add(t);
        for (String s : new String[] {"РЕСПУБЛИКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНЫЙ ОКРУГ", "АВТОНОМНЫЙ ОКРУГ", "НАЦИОНАЛЬНЫЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНАЯ ЗЕМЛЯ", "ВОЕВОДСТВО", "МУНИЦИПАЛЬНЫЙ РАЙОН", "МУНИЦИПАЛЬНЫЙ ОКРУГ", "АДМИНИСТРАТИВНЫЙ ОКРУГ", "ГОРОДСКОЙ РАЙОН", "ВНУТРИГОРОДСКОЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "REPUBLIC", "COUNTY", "BOROUGH", "PARISH", "MUNICIPALITY", "CENSUS AREA", "AUTONOMOUS REGION", "ADMINISTRATIVE REGION", "SPECIAL ADMINISTRATIVE REGION"}) {
            t = TerrTermin._new1212(s, true, (s.indexOf(" ") >= 0));
            if (com.pullenti.unisharp.Utils.stringsEq(s, "КРАЙ")) 
                m_TerrNounAdjectives.add(com.pullenti.ner.core.Termin._new119("КРАЕВОЙ", t));
            else if (com.pullenti.unisharp.Utils.stringsEq(s, "ОКРУГ")) 
                m_TerrNounAdjectives.add(com.pullenti.ner.core.Termin._new119("ОКРУЖНОЙ", t));
        ...
        for (String s : new String[] {"РЕСПУБЛІКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНИЙ ОКРУГ", "АВТОНОМНЫЙ ОКРУГ", "НАЦІОНАЛЬНИЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНА ЗЕМЛЯ", "МУНІЦИПАЛЬНИЙ РАЙОН", "МУНІЦИПАЛЬНИЙ ОКРУГ", "АДМІНІСТРАТИВНИЙ ОКРУГ", "МІСЬКИЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНІЦИПАЛЬНЕ УТВОРЕННЯ"}) {
            t = TerrTermin._new1215(s, com.pullenti.morph.MorphLang.UA, true, (s.indexOf(" ") >= 0));
            if (com.pullenti.morph.LanguageHelper.endsWith(s, "РАЙОН")) 
                t.addAbridge(s.replace("РАЙОН", "Р-Н"));
            m_TerrOntology.add(t);
        }
        t = TerrTermin._new1190("СЕЛЬСКИЙ ОКРУГ", true);
        t.addAbridge("С.О.");
        t.addAbridge("C.O.");
        t.addAbridge("ПС С.О.");
        ...
        t.addAbridge("С/О");
        m_TerrOntology.add(t);
        t = TerrTermin._new1193("СІЛЬСЬКИЙ ОКРУГ", com.pullenti.morph.MorphLang.UA, true);
        t.addAbridge("С.О.");
        t.addAbridge("C.O.");
        t.addAbridge("С/ОКРУГ");
        m_TerrOntology.add(t);
        t = TerrTermin._new1218("СЕЛЬСКИЙ СОВЕТ", "СЕЛЬСКИЙ ОКРУГ", true);
        ...
        t.addAbridge("С.АДМ.");
        m_TerrOntology.add(t);
        t = TerrTermin._new1190("ПОСЕЛКОВЫЙ ОКРУГ", true);
        t.addAbridge("П.О.");
        t.addAbridge("П/О");
        ...
        t.addAbridge("П/А");
        m_TerrOntology.add(t);
        t = TerrTermin._new1218("ПОСЕЛКОВЫЙ СОВЕТ", "ПОСЕЛКОВЫЙ ОКРУГ", true);
        t.addAbridge("П.С.");
        m_TerrOntology.add(t);
        m_TerrOntology.add(TerrTermin._new1221("АВТОНОМНЫЙ", true, true));
        m_TerrOntology.add(TerrTermin._new1222("АВТОНОМНИЙ", com.pullenti.morph.MorphLang.UA, true, true));
        m_TerrOntology.add(TerrTermin._new1223("МУНИЦИПАЛЬНОЕ СОБРАНИЕ", true, true, true));
        m_TerrOntology.add(TerrTermin._new1224("МУНІЦИПАЛЬНЕ ЗБОРИ", com.pullenti.morph.MorphLang.UA, true, true, true));
        t = TerrTermin._new1225("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "МО");
        m_TerrOntology.add(t);
        t = TerrTermin._new1226("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ МУНИЦИПАЛЬНЫЙ РАЙОН", "МОМР", true);
        t.addVariant("МО МР", false);
        m_TerrOntology.add(t);
        t = TerrTermin._new1226("МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ ГОРОДСКОЙ ОКРУГ", "МОГО", true);
            ...
            for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.doc.getDocumentElement().getChildNodes())).arr) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(x.getNodeName(), "state")) 
                    ...
                    if (a != null && a.getNodeValue() != null) 
                        m_UnknownRegions.add(com.pullenti.ner.core.Termin._new891(a.getNodeValue(), lang));
                }
            }
        }
    }
    ...
    private static void loadState(org.w3c.dom.Node xml, com.pullenti.morph.MorphLang lang) {
        ...
        for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.getChildNodes())).arr) {
            if (com.pullenti.unisharp.Utils.stringsEq(x.getNodeName(), "n")) {
                ...
                c.termins.add(com.pullenti.ner.core.Termin._new1241(x.getTextContent(), lang));
                state.addName(x.getTextContent());
                if (acrs == null) 
        ...
        if (a2 != null) {
            ...
            String a3;
            com.pullenti.unisharp.Outargwrapper<String> wrapa31242 = new com.pullenti.unisharp.Outargwrapper<String>();
            boolean inoutres1243 = com.pullenti.unisharp.Utils.tryGetValue(MiscLocationHelper.m_Alpha2_3, a2, wrapa31242);
            a3 = wrapa31242.value;
            if (inoutres1243) {
    ...
    private static void loadRegion(org.w3c.dom.Node xml, com.pullenti.morph.MorphLang lang) {
        ...
        for (org.w3c.dom.Node x : (new com.pullenti.unisharp.XmlNodeListWrapper(xml.getChildNodes())).arr) {
            if (com.pullenti.unisharp.Utils.stringsEq(x.getNodeName(), "n")) {
                ...
                if (aTerm == null) 
                    aTerm = com.pullenti.ner.core.Termin._new457(reg.getStringValue(com.pullenti.ner.geo.GeoReferent.ATTR_NAME), lang, reg);
    ...
    public static TerrItemToken _new1163(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.isAdjective = _arg3;
        return res;
    }

    public static TerrItemToken _new1164(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, TerrTermin _arg3, boolean _arg4) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
    ...
    public static TerrItemToken _new1165(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.core.IntOntologyItem _arg3) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.ontoItem = _arg3;
        return res;
    }

    public static TerrItemToken _new1174(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.ReferentToken _arg3, com.pullenti.ner.MorphCollection _arg4) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.rzd = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static TerrItemToken _new1176(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.core.IntOntologyItem _arg3, com.pullenti.ner.MorphCollection _arg4) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.ontoItem = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static TerrItemToken _new1177(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.core.IntOntologyItem _arg3, boolean _arg4, com.pullenti.ner.MorphCollection _arg5) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.ontoItem = _arg3;
    ...
    public static TerrItemToken _new1178(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, TerrTermin _arg3, boolean _arg4, com.pullenti.ner.MorphCollection _arg5) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.terminItem = _arg3;
        res.isAdjective = _arg4;
        res.setMorph(_arg5);
    ...
    public static TerrItemToken _new1181(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, boolean _arg3) {
        TerrItemToken res = new TerrItemToken(_arg1, _arg2);
        res.isDoubt = _arg3;
        return res;
    }

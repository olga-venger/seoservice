...
public class NumberHelper {
    ...
    private static com.pullenti.ner.NumberToken _TryParse(com.pullenti.ner.Token token, com.pullenti.ner.NumberToken prevVal) {
        ...
        if (val != null) {
                ...
                if (Character.isDigit(sss.charAt(0)) && sss.length() == 3) {
                    ...
                    for (com.pullenti.ner.Token ttt = et.getNext(); ttt != null; ttt = ttt.getNext()) {
                        ...
                        if (ttt.getWhitespacesBeforeCount() == 1 && ttt.getLengthChar() == 3 && Character.isDigit(ss.charAt(0))) {
                            int ii;
                            com.pullenti.unisharp.Outargwrapper<Integer> wrapii565 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                            boolean inoutres566 = com.pullenti.unisharp.Utils.parseInteger(ss, 0, null, wrapii565);
                            ii = (wrapii565.value != null ? wrapii565.value : 0);
                            if (!inoutres566) 
                                break;
                            val2 += ss;
                            continue;
            ...
            com.pullenti.ner.NumberToken res = com.pullenti.ner.NumberToken._new567(token, et, val, typ, mc);
    ...
    public static com.pullenti.ner.NumberToken tryParseAge(com.pullenti.ner.Token t) {
            ...
            if (ntNext != null) {
                ...
                if (t1 instanceof com.pullenti.ner.TextToken) {
                    ...
                    if ((com.pullenti.unisharp.Utils.stringsEq(v, "ЛЕТ") || com.pullenti.unisharp.Utils.stringsEq(v, "ЛЕТИЯ") || com.pullenti.unisharp.Utils.stringsEq(v, "ЛЕТИЕ")) || com.pullenti.unisharp.Utils.stringsEq(v, "РІЧЧЯ")) 
                        return com.pullenti.ner.NumberToken._new567(t, t1, nt.getValue(), com.pullenti.ner.NumberSpellingType.AGE, t1.getMorph());
        ...
        if (com.pullenti.morph.LanguageHelper.endsWithEx(s, "ЛЕТИЕ", "ЛЕТИЯ", "РІЧЧЯ", null)) {
            ...
            if (term != null) 
                return com.pullenti.ner.NumberToken._new567(tt, tt, term.tag.toString(), com.pullenti.ner.NumberSpellingType.AGE, tt.getMorph());
        }
        s = tt.lemma;
    ...
    private static com.pullenti.ner.MetaToken analizeNumberTail(com.pullenti.ner.TextToken tt, String val) {
            ...
            if (((com.pullenti.unisharp.Utils.stringsEq(s, "<") || com.pullenti.unisharp.Utils.stringsEq(s, "("))) && (tt.getNext() instanceof com.pullenti.ner.TextToken)) {
                ...
                if ((com.pullenti.unisharp.Utils.stringsEq(s, "TH") || com.pullenti.unisharp.Utils.stringsEq(s, "ST") || com.pullenti.unisharp.Utils.stringsEq(s, "RD")) || com.pullenti.unisharp.Utils.stringsEq(s, "ND")) {
                    if (tt.getNext().getNext() != null && tt.getNext().getNext().isCharOf(">)")) {
                        ...
                        return com.pullenti.ner.MetaToken._new572(tt, tt.getNext().getNext(), mc);
                    }
                }
            }
            return null;
        ...
        if ((com.pullenti.unisharp.Utils.stringsEq(s, "TH") || com.pullenti.unisharp.Utils.stringsEq(s, "ST") || com.pullenti.unisharp.Utils.stringsEq(s, "RD")) || com.pullenti.unisharp.Utils.stringsEq(s, "ND")) {
            ...
            mc._setClass(com.pullenti.morph.MorphClass.ADJECTIVE);
            mc.setLanguage(com.pullenti.morph.MorphLang.EN);
            return com.pullenti.ner.MetaToken._new572(tt, tt, mc);
        }
        ...
        if (tt.getMorph().getLanguage().isUa() && mc == null && com.pullenti.unisharp.Utils.stringsEq(s, "Ї")) {
            mc = new com.pullenti.ner.MorphCollection(null);
            mc.addItem(com.pullenti.morph.MorphBaseInfo._new574(com.pullenti.morph.MorphClass.ADJECTIVE));
        }
        if (mc != null) 
            return com.pullenti.ner.MetaToken._new572(tt, tt, mc);
        if ((((s.length() < 3) && !tt.isWhitespaceBefore() && tt.getPrevious() != null) && tt.getPrevious().isHiphen() && !tt.getPrevious().isWhitespaceBefore()) && tt.getWhitespacesAfterCount() == 1 && com.pullenti.unisharp.Utils.stringsNe(s, "А")) 
            return com.pullenti.ner.MetaToken._new572(tt, tt, com.pullenti.ner.MorphCollection._new576(com.pullenti.morph.MorphClass.ADJECTIVE));
        return null;
    }
    ...
    public static com.pullenti.ner.NumberToken tryParseRealNumber(com.pullenti.ner.Token t, boolean canBeInteger) {
        ...
        if (t.getNext() != null && t.getNext().isValue("ЦЕЛЫЙ", null) && (((t.getNext().getNext() instanceof com.pullenti.ner.NumberToken) || (((t.getNext().getNext() instanceof com.pullenti.ner.TextToken) && t.getNext().getNext().isValue("НОЛЬ", null)))))) {
            ...
            if (res0.getRealValue() == 0) {
                String str = ("0." + val);
                double dd = 0.0;
                com.pullenti.unisharp.Outargwrapper<Double> wrapdd580 = new com.pullenti.unisharp.Outargwrapper<Double>();
                boolean inoutres581 = com.pullenti.unisharp.Utils.parseDouble(str, null, wrapdd580);
                dd = (wrapdd580.value != null ? wrapdd580.value : 0);
                if (inoutres581) {
                }
                else {
                    com.pullenti.unisharp.Outargwrapper<Double> wrapdd578 = new com.pullenti.unisharp.Outargwrapper<Double>();
                    boolean inoutres579 = com.pullenti.unisharp.Utils.parseDouble(str.replace('.', ','), null, wrapdd578);
                    dd = (wrapdd578.value != null ? wrapdd578.value : 0);
                    if (inoutres579) {
                    }
                    else 
                        return null;
        ...
        double d;
        com.pullenti.unisharp.Outargwrapper<Double> wrapd583 = new com.pullenti.unisharp.Outargwrapper<Double>();
        com.pullenti.ner.Token tt = _tryParseFloat((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class), wrapd583);
        d = (wrapd583.value != null ? wrapd583.value : 0);
        if (tt == null) {
        ...
        if (isNot) 
            d = -d;
        return NumberExToken._new582(t0, tt, "", com.pullenti.ner.NumberSpellingType.DIGIT, NumberExType.UNDEFINED, d);
    }
    ...
    public static Double stringToDouble(String str) {
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(str, "NaN")) 
            return Double.NaN;
        com.pullenti.unisharp.Outargwrapper<Double> wrapres586 = new com.pullenti.unisharp.Outargwrapper<Double>();
        boolean inoutres587 = com.pullenti.unisharp.Utils.parseDouble(str, null, wrapres586);
        res = (wrapres586.value != null ? wrapres586.value : 0);
        if (inoutres587) 
            return res;
        com.pullenti.unisharp.Outargwrapper<Double> wrapres584 = new com.pullenti.unisharp.Outargwrapper<Double>();
        boolean inoutres585 = com.pullenti.unisharp.Utils.parseDouble(str.replace('.', ','), null, wrapres584);
        res = (wrapres584.value != null ? wrapres584.value : 0);
        if (inoutres585) 
            return res;
        return null;
    }
    ...
    public static void initialize() {
        ...
        Termin t = Termin._new119("ПОЛОВИНА", 0.5);

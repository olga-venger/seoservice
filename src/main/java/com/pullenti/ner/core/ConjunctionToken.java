...
public class ConjunctionToken extends com.pullenti.ner.MetaToken {
    ...
    public static ConjunctionToken _new548(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ConjunctionType _arg3, String _arg4) {
    ...
    public static ConjunctionToken _new549(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, ConjunctionType _arg4) {
        ConjunctionToken res = new ConjunctionToken(_arg1, _arg2);
        res.normal = _arg3;
        res.typ = _arg4;
        return res;

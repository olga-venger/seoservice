...
public class NumberExToken extends com.pullenti.ner.NumberToken {
    ...
    public static String exTypToString(NumberExType ty, NumberExType ty2) {
        ...
        String res;
        com.pullenti.unisharp.Outargwrapper<String> wrapres563 = new com.pullenti.unisharp.Outargwrapper<String>();
        boolean inoutres564 = com.pullenti.unisharp.Utils.tryGetValue(com.pullenti.ner.core.internal.NumberExHelper.m_NormalsTyps, ty, wrapres563);
    ...
    public static NumberExToken _new473(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6, com.pullenti.ner.MorphCollection _arg7) {
    ...
    public static NumberExToken _new474(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, com.pullenti.ner.MorphCollection _arg6) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.setMorph(_arg6);
        return res;
    }

    public static NumberExToken _new475(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6, double _arg7, com.pullenti.ner.MorphCollection _arg8) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
    ...
    public static NumberExToken _new476(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6, double _arg7, String _arg8) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.setRealValue(_arg6);
        res.altRealValue = _arg7;
    ...
    public static NumberExToken _new478(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6, double _arg7, NumberExType _arg8, String _arg9) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.setRealValue(_arg6);
        res.altRealValue = _arg7;
        res.exTyp2 = _arg8;
    ...
    public static NumberExToken _new479(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6, double _arg7, boolean _arg8) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.setRealValue(_arg6);
        res.altRealValue = _arg7;
        res.multAfter = _arg8;
    ...
    public static NumberExToken _new480(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, String _arg6) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.exTypParam = _arg6;
        return res;
    }

    public static NumberExToken _new582(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.NumberSpellingType _arg4, NumberExType _arg5, double _arg6) {
        NumberExToken res = new NumberExToken(_arg1, _arg2, _arg3, _arg4, _arg5);
        res.setRealValue(_arg6);
        return res;
    }

...
public class MorphCase {
    ...
    public static MorphCase ooBitand(MorphCase arg1, MorphCase arg2) {
        ...
        if (arg2 != null) 
            val2 = arg2.value;
        return _new49((short)((((int)val1) & ((int)val2))));
    }
    ...
    public static MorphCase _new49(short _arg1) {
        MorphCase res = new MorphCase(null);
        res.value = _arg1;
        return res;
    }
    ...
    static {
        UNDEFINED = _new49((short)0);
        NOMINATIVE = _new49((short)1);
        GENITIVE = _new49((short)2);
        DATIVE = _new49((short)4);
        ACCUSATIVE = _new49((short)8);
        INSTRUMENTAL = _new49((short)0x10);
        PREPOSITIONAL = _new49((short)0x20);
        VOCATIVE = _new49((short)0x40);
        PARTIAL = _new49((short)0x80);
        COMMON = _new49((short)0x100);
        POSSESSIVE = _new49((short)0x200);
        ALLCASES = _new49((short)0x3FF);

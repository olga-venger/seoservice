...
public class DateAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public static class DateAnalizerData extends com.pullenti.ner.core.AnalyzerData {
        ...
        public com.pullenti.ner.Referent registerReferent(com.pullenti.ner.Referent referent) {
            ...
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent> wrapdr717 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Referent>();
            boolean inoutres718 = com.pullenti.unisharp.Utils.tryGetValue(m_Hash, key, wrapdr717);
            dr = wrapdr717.value;
            if (inoutres718) 
                return dr;
            ...
            if (rts != null) {
                ...
                for (int i = 0; i < rts.size(); i++) {
                    ...
                    if ((i < (rts.size() - 1)) && rt.tag == null) 
                        rt.referent.addOccurence(com.pullenti.ner.TextAnnotation._new719(kit.getSofa(), rt.beginChar, rt.endChar, rt.referent));
                    else {
                ...
                if ((dat != null && t.getPrevious() != null && t.getPrevious().isHiphen()) && t.getPrevious().getPrevious() != null && (t.getPrevious().getPrevious().getReferent() instanceof DateReferent)) {
                    ...
                    DateRangeReferent dr = (DateRangeReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateRangeReferent._new720(dat0, dat)), DateRangeReferent.class);
                ...
                if ((dat != null && t.getPrevious() != null && ((t.getPrevious().isHiphen() || t.getPrevious().isValue("ПО", null) || t.getPrevious().isValue("И", null)))) && (t.getPrevious().getPrevious() instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getPrevious().getPrevious(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                    ...
                    if (dat.getDay() > 0 && (num < dat.getDay()) && num > 0) {
                        if (dat.getHigher() != null) 
                            dat0 = DateReferent._new721(dat.getHigher(), num);
                        else if (dat.getMonth() > 0) 
                            dat0 = DateReferent._new722(dat.getMonth(), num);
                    }
                    else if (dat.getYear() > 0 && (num < dat.getYear()) && num > 1000) 
                        dat0 = DateReferent._new723(num);
                    if (dat0 != null) {
    ...
    public com.pullenti.ner.ReferentToken processReferent(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        if (begin.isValue("ДО", null) && (begin.getNext() instanceof com.pullenti.ner.ReferentToken) && (begin.getNext().getReferent() instanceof DateReferent)) {
            DateRangeReferent drr = DateRangeReferent._new725((DateReferent)com.pullenti.unisharp.Utils.cast(begin.getNext().getReferent(), DateReferent.class));
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttach(java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> dts, boolean high) {
            ...
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR || ((dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER && ((dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR || dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER))))) {
                if (dts.size() > 3 && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && com.pullenti.unisharp.Utils.stringsEq(dts.get(3).stringValue, dts.get(1).stringValue)) {
                    ...
                    if (res1 != null && (res1.get(res1.size() - 1).referent instanceof DateReferent) && (((DateReferent)com.pullenti.unisharp.Utils.cast(res1.get(res1.size() - 1).referent, DateReferent.class))).getDay() > 0) {
                        DateReferent time = DateReferent._new726(dts.get(0).intValue, dts.get(2).intValue);
        ...
        boolean b = false;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear771 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon772 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday773 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
        b = this.applyRuleFormal(dts, high, wrapyear771, wrapmon772, wrapday773);
        year = wrapyear771.value;
        mon = wrapmon772.value;
        day = wrapday773.value;
        if (b) {
        ...
        if (dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.POINTER && com.pullenti.unisharp.Utils.stringsEq(dts.get(0).stringValue, "сегодня")) {
            ...
            res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new727(DatePointerType.TODAY), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
            return res0;
        }
        if (dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR && dts.get(0).getYear() <= 0) {
            java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
            res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new727(DatePointerType.UNDEFINED), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
            return res0;
        }
        ...
        if (!b) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear729 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon730 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday731 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<Boolean> wrapyearIsDif732 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
            b = this.applyRuleWithMonth(dts, high, wrapyear729, wrapmon730, wrapday731, wrapyearIsDif732);
            year = wrapyear729.value;
            mon = wrapmon730.value;
            day = wrapday731.value;
            yearIsDif = (wrapyearIsDif732.value != null ? wrapyearIsDif732.value : false);
        }
        if (!b) {
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapyear733 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapmon734 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken> wrapday735 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.date.internal.DateItemToken>();
            b = this.applyRuleYearOnly(dts, wrapyear733, wrapmon734, wrapday735);
            year = wrapyear733.value;
            mon = wrapmon734.value;
            day = wrapday735.value;
        }
        if (!b) {
            if (dts.size() == 2 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MINUTE) {
                ...
                if (t00 != null && (((t00.isValue("ТЕЧЕНИЕ", null) || t00.isValue("ПРОТЯГОМ", null) || t00.isValue("ЧЕРЕЗ", null)) || t00.isValue("ТЕЧІЮ", null)))) {
                    ...
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    DateReferent time = DateReferent._new726(dts.get(0).intValue, dts.get(1).intValue);
            ...
            if ((dts.size() == 4 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM) && dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) {
                java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                DateReferent yea = DateReferent._new723(dts.get(3).intValue);
                res0.add(com.pullenti.ner.ReferentToken._new738(yea, dts.get(3).getBeginToken(), dts.get(3).getEndToken(), dts.get(3).getMorph()));
                DateReferent mon1 = DateReferent._new739(dts.get(0).intValue, yea);
                res0.add(com.pullenti.ner.ReferentToken._new740(mon1, dts.get(0).getBeginToken(), dts.get(0).getEndToken(), mon1));
                DateReferent mon2 = DateReferent._new739(dts.get(2).intValue, yea);
            ...
            if (((dts.size() >= 4 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER && dts.get(0).canBeDay()) && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && dts.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.NUMBER) && dts.get(2).canBeDay() && dts.get(3).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH) {
                if (dts.size() == 4 || ((dts.size() == 5 && dts.get(4).canBeYear()))) {
                    ...
                    if (dts.size() == 5) 
                        res0.add(new com.pullenti.ner.ReferentToken((yea = DateReferent._new723(dts.get(4).getYear())), dts.get(4).getBeginToken(), dts.get(4).getEndToken(), null));
                    DateReferent mo = DateReferent._new739(dts.get(3).intValue, yea);
                    res0.add(new com.pullenti.ner.ReferentToken(mo, dts.get(3).getBeginToken(), dts.get(dts.size() - 1).getEndToken(), null));
                    DateReferent da1 = DateReferent._new744(dts.get(0).intValue, mo);
                    res0.add(new com.pullenti.ner.ReferentToken(da1, dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    DateReferent da2 = DateReferent._new744(dts.get(2).intValue, mo);
            ...
            if ((dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.size() == 1 && dts.get(0).getEndToken().getNext() != null) && ((dts.get(0).getEndToken().getNext().isHiphen() || dts.get(0).getEndToken().getNext().isValue("ПО", null) || dts.get(0).getEndToken().getNext().isValue("НА", null)))) {
                ...
                if (rt != null) {
                    ...
                    if ((dr0 != null && dr0.getYear() > 0 && dr0.getMonth() > 0) && dr0.getDay() == 0 && dr0.getMonth() > dts.get(0).intValue) {
                        DateReferent drYear0 = DateReferent._new723(dr0.getYear());
                        java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                        res0.add(new com.pullenti.ner.ReferentToken(drYear0, dts.get(0).getEndToken(), dts.get(0).getEndToken(), null));
                        DateReferent drMon0 = DateReferent._new739(dts.get(0).intValue, drYear0);
            ...
            if (((dts.size() == 3 && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.DELIM && dts.get(1).getBeginToken().isHiphen()) && dts.get(0).canBeYear() && dts.get(2).canBeYear()) && (dts.get(0).intValue < dts.get(2).intValue)) {
                ...
                if (ok) {
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new723(dts.get(0).getYear()), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new723(dts.get(2).getYear()), dts.get(2).getBeginToken(), dts.get(2).getEndToken(), null));
                    return res0;
                }
            }
            ...
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.QUARTAL || dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HALFYEAR) {
                if (dts.size() == 1 || dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) {
                    ...
                    if (dts.size() > 1) {
                        ii = 1;
                        yea = DateReferent._new723(dts.get(1).intValue);
                        res0.add(com.pullenti.ner.ReferentToken._new738(yea, dts.get(1).getBeginToken(), dts.get(1).getEndToken(), dts.get(1).getMorph()));
                    }
                    else {
                        int cou = 0;
            ...
            if ((dts.size() == 1 && dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH && dts.get(0).getBeginToken().getPrevious() != null) && dts.get(0).getBeginToken().getPrevious().getMorph()._getClass().isPreposition()) {
                if (dts.get(0).chars.isLatinLetter() && dts.get(0).chars.isAllLower()) {
                    ...
                    java.util.ArrayList<com.pullenti.ner.ReferentToken> res0 = new java.util.ArrayList<com.pullenti.ner.ReferentToken>();
                    res0.add(new com.pullenti.ner.ReferentToken(DateReferent._new760(dts.get(0).intValue), dts.get(0).getBeginToken(), dts.get(0).getEndToken(), null));
                    return res0;
                }
            }
            return null;
        ...
        if (cent != null) {
            DateReferent ce = DateReferent._new761((cent.newAge < 0 ? -cent.intValue : cent.intValue));
        ...
        if (year != null && year.getYear() > 0) {
            drYear = DateReferent._new723((year.newAge < 0 ? -year.getYear() : year.getYear()));
            if (!yearIsDif) {
                t1 = year.getEndToken();
            ...
            res.add(com.pullenti.ner.ReferentToken._new738(drYear, (t0 = year.getBeginToken()), year.getEndToken(), year.getMorph()));
        }
        if (mon != null) {
            drMon = DateReferent._new760(mon.intValue);
            if (drYear != null) 
            ...
            if (drYear == null && t1.getNext() != null && ((t1.getNext().isValue("ПО", null) || t1.getNext().isValue("НА", null)))) {
                ...
                if (rt != null) {
                    ...
                    if (dr0 != null && dr0.getYear() > 0 && dr0.getMonth() > 0) {
                        drYear = DateReferent._new723(dr0.getYear());
                        res.add(new com.pullenti.ner.ReferentToken(drYear, (t0 = t1), t1, null));
                        drMon.setHigher(drYear);
                    }
                }
            }
            res.add(com.pullenti.ner.ReferentToken._new738(drMon, t0, t1, mon.getMorph()));
            if (day != null) {
                drDay = DateReferent._new767(day.intValue);
                ...
                res.add(com.pullenti.ner.ReferentToken._new738(drDay, t0, t1, day.getMorph()));
                if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && dts.get(1).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MINUTE) {
                    DateReferent hou = DateReferent._new769(drDay);
            ...
            if (dt0.getMonth() == 0) {
                ...
                if (tt != null && tt.isCharOf("(,")) {
                    ...
                    if (dit != null && dit.typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.MONTH) {
                        drMon = DateReferent._new770(dt0, dit.intValue);
    ...
    private com.pullenti.ner.ReferentToken tryAttachTimeLi(java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> dts, boolean afterDate) {
        ...
        if (dts.size() == 1) {
            if (dts.get(0).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.HOUR && afterDate) {
                time = DateReferent._new726(dts.get(0).intValue, 0);
            ...
            time = DateReferent._new726(dts.get(0).intValue, dts.get(1).intValue);
            ...
            time = DateReferent._new726(dts.get(0).intValue, dts.get(2).intValue);
            t1 = dts.get(2).getEndToken();
    ...
    private DateRangeReferent applyDateRange(com.pullenti.ner.core.AnalyzerData ad, java.util.ArrayList<com.pullenti.ner.date.internal.DateItemToken> its, com.pullenti.unisharp.Outargwrapper<com.pullenti.morph.MorphLang> lang) {
        ...
        if ((its.get(0).canBeYear() && com.pullenti.unisharp.Utils.stringsEq(its.get(1).stringValue, "-") && its.get(2).typ == com.pullenti.ner.date.internal.DateItemToken.DateItemType.YEAR) && (its.get(0).getYear() < its.get(2).getYear())) {
            ...
            res.setDateFrom((DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new723(its.get(0).getYear())), DateReferent.class));
            ...
            res.setDateTo((DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new723(its.get(2).getYear())), DateReferent.class));
    ...
    private void applyDateRange0(com.pullenti.ner.core.AnalysisKit kit, com.pullenti.ner.core.AnalyzerData ad) {
        for (com.pullenti.ner.Token t = kit.firstToken; t != null; t = t.getNext()) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(str, "ON") && (t0 instanceof com.pullenti.ner.TextToken)) {
                ...
                if (tok != null) {
                    DateReferent dow = DateReferent._new779((int)tok.termin.tag);
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(str, "С") || com.pullenti.unisharp.Utils.stringsEq(str, "C")) 
                ...
                if ((t.getNext() instanceof com.pullenti.ner.ReferentToken) && (t.getNext().getReferent() instanceof DateReferent)) {
                    DateRangeReferent dr = DateRangeReferent._new725((DateReferent)com.pullenti.unisharp.Utils.cast(t.getNext().getReferent(), DateReferent.class));
            ...
            if (date1 == null) {
                date1 = (DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new723(yearVal1)), DateReferent.class);
            ...
            if (date2 == null) {
                date2 = (DateReferent)com.pullenti.unisharp.Utils.cast(ad.registerReferent(DateReferent._new723(yearVal2)), DateReferent.class);
                com.pullenti.ner.ReferentToken rt1 = new com.pullenti.ner.ReferentToken(date2, t1, t1, null);
                kit.embedToken(rt1);
                t1 = rt1;
            }
            t = new com.pullenti.ner.ReferentToken(ad.registerReferent(DateRangeReferent._new720(date1, date2)), t, t1, null);

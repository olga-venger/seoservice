    ...
    private static void addVars(String str, java.util.ArrayList<String> vars) {
        ...
        for (int k = 0; k < 2; k++) {
            ...
            for (i = 0; i < str.length(); i++) {
                String v;
                com.pullenti.unisharp.Outargwrapper<String> wrapv1112 = new com.pullenti.unisharp.Outargwrapper<String>();
                boolean inoutres1113 = com.pullenti.unisharp.Utils.tryGetValue(m_VarChars, str.charAt(i), wrapv1112);
                v = wrapv1112.value;
                if (!inoutres1113) 
                    break;

...
public class _NounPraseHelperInt {
        ...
        if (stat != null) {
            for (com.pullenti.ner.core.internal.NounPhraseItem adj : items) {
                if (adj.getMorph().getItemsCount() > 1) {
                    ...
                    int i1 = 0;
                    int i2 = 0;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapi1536 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    com.pullenti.unisharp.Utils.tryGetValue(stat, l1, wrapi1536);
                    i1 = (wrapi1536.value != null ? wrapi1536.value : 0);
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapi2535 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    com.pullenti.unisharp.Utils.tryGetValue(stat, l2, wrapi2535);
                    i2 = (wrapi2535.value != null ? wrapi2535.value : 0);
                    if (i1 < i2) {
                                    ...
                                    if (ews != null) {
                                        for (com.pullenti.morph.DerivateGroup ew : ews) {
                                            ...
                                            if (ew.nexts != null) {
                                                ...
                                                com.pullenti.unisharp.Outargwrapper<com.pullenti.morph.MorphCase> wrapcm537 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.morph.MorphCase>();
                                                boolean inoutres538 = com.pullenti.unisharp.Utils.tryGetValue(ew.nexts, "", wrapcm537);
                                                cm = wrapcm537.value;
                                                if (inoutres538) {
    ...
    private static NounPhraseToken tryParseEn(com.pullenti.ner.Token first, NounPhraseParseAttr typ, int maxCharPos) {
        ...
        if (res.getMorph().getItemsCount() == 0 && hasArticle) 
            res.getMorph().addItem(com.pullenti.morph.MorphBaseInfo._new211(com.pullenti.morph.MorphClass.NOUN, com.pullenti.morph.MorphNumber.SINGULAR));

...
public class TitlePageAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public com.pullenti.ner.ReferentToken processReferent1(com.pullenti.ner.Token begin, com.pullenti.ner.Token end) {
        ...
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token> wrapet2644 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token>();
        TitlePageReferent tpr = _process(begin, (end == null ? 0 : end.endChar), begin.kit, wrapet2644);
        et = wrapet2644.value;
        if (tpr == null) 
            return null;
    ...
    public void process(com.pullenti.ner.core.AnalysisKit kit) {
        ...
        com.pullenti.ner.Token et;
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token> wrapet2645 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.Token>();
        TitlePageReferent tpr = _process(kit.firstToken, 0, kit, wrapet2645);
        et = wrapet2645.value;
        if (tpr != null) 
            ...
            for (com.pullenti.ner.Referent r : rli) {
                ...
                if (r instanceof com.pullenti.ner._org.OrganizationReferent) {
                    ...
                    if (__org.getTypes().contains("курс") && __org.getNumber() != null) {
                        int i;
                        com.pullenti.unisharp.Outargwrapper<Integer> wrapi2646 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                        boolean inoutres2647 = com.pullenti.unisharp.Utils.parseInteger(__org.getNumber(), 0, null, wrapi2646);
                        i = (wrapi2646.value != null ? wrapi2646.value : 0);
                        if (inoutres2647) {
                            if (i > 0 && (i < 8)) 

...
public class MorphBaseInfo {
    ...
    public static MorphBaseInfo _new211(MorphClass _arg1, MorphNumber _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        res.setNumber(_arg2);
        return res;
    ...
    public static MorphBaseInfo _new212(MorphClass _arg1, MorphGender _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        res.setGender(_arg2);
        return res;
    ...
    public static MorphBaseInfo _new240(MorphCase _arg1, MorphClass _arg2, MorphNumber _arg3, MorphGender _arg4) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
        res._setClass(_arg2);
        res.setNumber(_arg3);
    ...
    public static MorphBaseInfo _new469(MorphClass _arg1, MorphGender _arg2, MorphNumber _arg3, MorphCase _arg4, MorphLang _arg5) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        res.setGender(_arg2);
        res.setNumber(_arg3);
    ...
    public static MorphBaseInfo _new560(MorphClass _arg1, MorphGender _arg2, MorphNumber _arg3, MorphLang _arg4) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        res.setGender(_arg2);
        res.setNumber(_arg3);
    ...
    public static MorphBaseInfo _new561(MorphGender _arg1, MorphCase _arg2, MorphNumber _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setGender(_arg1);
        res.setCase(_arg2);
        res.setNumber(_arg3);
    ...
    public static MorphBaseInfo _new562(MorphCase _arg1, MorphLang _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
    ...
    public static MorphBaseInfo _new574(MorphClass _arg1) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        return res;
    }

    public static MorphBaseInfo _new1782(MorphCase _arg1, MorphGender _arg2, MorphNumber _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
        res.setGender(_arg2);
        res.setNumber(_arg3);
    ...
    public static MorphBaseInfo _new2319(MorphClass _arg1, MorphGender _arg2, MorphLang _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res._setClass(_arg1);
        res.setGender(_arg2);
    ...
    public static MorphBaseInfo _new2415(MorphCase _arg1) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
        return res;
    }

    public static MorphBaseInfo _new2428(MorphCase _arg1, MorphGender _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
        res.setGender(_arg2);
        return res;
    ...
    public static MorphBaseInfo _new2442(MorphGender _arg1, MorphCase _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setGender(_arg1);
        res.setCase(_arg2);
        return res;
    ...
    public static MorphBaseInfo _new2464(MorphGender _arg1) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setGender(_arg1);
        return res;
    }

    public static MorphBaseInfo _new2511(MorphCase _arg1, MorphGender _arg2, MorphClass _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setCase(_arg1);
        res.setGender(_arg2);
        res._setClass(_arg3);
    ...
    public static MorphBaseInfo _new2548(MorphNumber _arg1, MorphLang _arg2) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setNumber(_arg1);
        res.setLanguage(_arg2);
        return res;
    ...
    public static MorphBaseInfo _new2551(MorphGender _arg1, MorphNumber _arg2, MorphLang _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setGender(_arg1);
        res.setNumber(_arg2);
        res.setLanguage(_arg3);
    ...
    public static MorphBaseInfo _new2553(MorphNumber _arg1, MorphGender _arg2, MorphLang _arg3) {
        MorphBaseInfo res = new MorphBaseInfo();
        res.setNumber(_arg1);
        res.setGender(_arg2);
        res.setLanguage(_arg3);

...
public class AddressItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static java.util.ArrayList<AddressItemToken> tryParseList(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locStreets, int maxCount) {
                        ...
                        if (tt1.isComma()) {
                            ...
                            if (tt1.isValue("Л", null) && tt1.getNext() != null && tt1.getNext().isChar('.')) {
                                ...
                                if (ait != null && ait.typ == ItemType.NUMBER) {
                                    ...
                                    res.add((it = _new84(ItemType.STREET, tt1, ait.getEndToken(), st2)));
                                    t = it.getEndToken();
                                }
                            }
                            break;
                ...
                if (it.typ == ItemType.HOUSE || it.typ == ItemType.BUILDING || it.typ == ItemType.NUMBER) {
                    if ((!t.isWhitespaceBefore() && t.getLengthChar() == 1 && t.chars.isLetter()) && !t.isWhitespaceAfter() && (t.getNext() instanceof com.pullenti.ner.NumberToken)) {
                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(ch, "К") || com.pullenti.unisharp.Utils.stringsEq(ch, "С")) {
                            it0 = _new85((com.pullenti.unisharp.Utils.stringsEq(ch, "К") ? ItemType.CORPUS : ItemType.BUILDING), t, t.getNext(), (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getValue().toString());
                            it = it0;
                            res.add(it);
                            t = it.getEndToken();
                            ...
                            if (((tt != null && !tt.isWhitespaceBefore() && tt.getLengthChar() == 1) && tt.chars.isLetter() && !tt.isWhitespaceAfter()) && (tt.getNext() instanceof com.pullenti.ner.NumberToken)) {
                                ...
                                if (com.pullenti.unisharp.Utils.stringsEq(ch, "К") || com.pullenti.unisharp.Utils.stringsEq(ch, "С")) {
                                    it = _new85((com.pullenti.unisharp.Utils.stringsEq(ch, "К") ? ItemType.CORPUS : ItemType.BUILDING), tt, tt.getNext(), (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt.getNext(), com.pullenti.ner.NumberToken.class))).getValue().toString());
                                    res.add(it);
                                    t = it.getEndToken();
                                }
                            }
        ...
        for (int i = 0; i < (res.size() - 1); i++) {
            if (res.get(i).isTerrOrRzd() && res.get(i + 1).typ == ItemType.KILOMETER && (((i + 1) >= res.size() || !res.get(i + 1).isTerrOrRzd()))) {
                ...
                AddressItemToken ai = _new87(ItemType.STREET, res.get(i).getBeginToken(), t11, str, false);
    ...
    private static AddressItemToken _TryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.IntOntologyCollection locStreets, boolean prefixBefore, boolean ignoreStreet, AddressItemToken prev) {
        if (t instanceof com.pullenti.ner.ReferentToken) {
            ...
            if (geo != null) {
                if (geo.isCity() || geo.isTerritory()) 
                    ...
                    ty = ItemType.REGION;
                return _new84(ty, t, t, rt.referent);
            }
        }
        ...
        if (t instanceof com.pullenti.ner.NumberToken) {
            ...
            if (((n.getLengthChar() == 6 || n.getLengthChar() == 5)) && n.typ == com.pullenti.ner.NumberSpellingType.DIGIT && !n.getMorph()._getClass().isAdjective()) 
                return _new85(ItemType.ZIP, t, t, n.getValue().toString());
            boolean ok = false;
                ...
                if (typ0 == ItemType.FLAT) {
                    ...
                    if ((tok0.getEndToken().getNext() instanceof com.pullenti.ner.NumberToken) && (tok0.getEndToken().getWhitespacesAfterCount() < 3)) {
                        if (prev != null && ((prev.typ == ItemType.STREET || prev.typ == ItemType.CITY))) 
                            return _new85(ItemType.NUMBER, t, t, n.getValue().toString());
                    }
                }
                if ((typ0 == ItemType.KILOMETER || typ0 == ItemType.FLOOR || typ0 == ItemType.BLOCK) || typ0 == ItemType.POTCH || typ0 == ItemType.FLAT) 
                    return _new85(typ0, t, tok0.getEndToken(), n.getValue().toString());
            }
        }
        ...
        if (tok != null) {
            ...
            if (com.pullenti.unisharp.Utils.stringsEq(tok.termin.getCanonicText(), "ТАМ ЖЕ")) {
                ...
                for (com.pullenti.ner.Token tt = t.getPrevious(); tt != null; tt = tt.getPrevious()) {
                    ...
                    if (r instanceof com.pullenti.ner.address.AddressReferent) {
                        ...
                        if (g != null) 
                            return _new84(ItemType.CITY, t, tok.getEndToken(), g);
                        break;
                    }
            ...
            if (tok.termin.tag instanceof ItemType) {
                ...
                if (_typ == ItemType.PREFIX) {
                    ...
                    if (rt != null) 
                        return _new95(_typ, t, rt.getEndToken(), rt);
                }
                    ...
                    if (t1 != null && ((t1.getMorph()._getClass().isPreposition() || t1.getMorph()._getClass().isConjunction())) && (t1.getWhitespacesAfterCount() < 2)) {
                        ...
                        if (tok2 != null && (tok2.termin.tag instanceof ItemType)) {
                            ...
                            if (typ2 != _typ && ((typ2 == ItemType.PLOT || ((typ2 == ItemType.HOUSE && _typ == ItemType.PLOT))))) {
                                ...
                                if (t1 == null) 
                                    return _new96(_typ, t, tok2.getEndToken(), "0", houseTyp);
                            }
                        }
                    }
                }
                if (_typ != ItemType.NUMBER) {
                    if (t1 == null && t.getLengthChar() > 1) 
                        return _new97(_typ, t, tok.getEndToken(), houseTyp, buildTyp);
                    if ((t1 instanceof com.pullenti.ner.NumberToken) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t1, com.pullenti.ner.NumberToken.class))).getValue(), "0")) 
                        return _new98(_typ, t, t1, "0", houseTyp, buildTyp);
                }
            }
        }
        ...
        if (tok != null && (tok.termin.tag instanceof ItemType) && ((ItemType)tok.termin.tag) == ItemType.NUMBER) 
            ...
            AddressItemToken re0 = _new98(_typ, t, tok.getEndToken(), "0", houseTyp, buildTyp);
        ...
        if (nt != null) {
            ...
            if (_typ == ItemType.BOX && num.length() == 0) {
                ...
                if (rom != null) 
                    return _new85(_typ, t, rom.getEndToken(), rom.getValue().toString());
            }
        }
            ...
            if ((t1 instanceof com.pullenti.ner.TextToken) && ((_typ == ItemType.HOUSE || _typ == ItemType.BUILDING || _typ == ItemType.CORPUS))) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(ter, "АБ") || com.pullenti.unisharp.Utils.stringsEq(ter, "АБВ") || com.pullenti.unisharp.Utils.stringsEq(ter, "МГУ")) 
                    return _new98(_typ, t, t1, ter, houseTyp, buildTyp);
            ...
            if (_typ == ItemType.PLOT && t1 != null) {
                if ((t1.isValue("ОКОЛО", null) || t1.isValue("РЯДОМ", null) || t1.isValue("НАПРОТИВ", null)) || t1.isValue("БЛИЗЬКО", null) || t1.isValue("НАВПАКИ", null)) 
                    return _new85(_typ, t, t1, t1.getSourceText().toLowerCase());
            }
            return null;
        }
        ...
        return _new106(_typ, t, t1, num.toString(), t.getMorph(), houseTyp, buildTyp);
    }
        ...
        for (com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
            if ((((tt.isValue("В", null) || tt.isValue("B", null))) && tt.getNext() != null && tt.getNext().isCharOf("./\\")) && (tt.getNext().getNext() instanceof com.pullenti.ner.TextToken) && tt.getNext().getNext().isValue("Ч", null)) {
                ...
                if ((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term.startsWith("ОБЩ")) {
                    ...
                    if (re != null) 
                        return re;
                    return _new85(ty, t, tt, "ОБЩ");
                }
                if (tt.chars.isAllUpper() && tt.getLengthChar() > 1) {
                    AddressItemToken re = _new85(ty, t, tt, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term);
    ...
    public static AddressItemToken tryAttachDetail(com.pullenti.ner.Token t) {
        ...
        if (tok == null) {
            ...
            res = _new112(ItemType.DETAIL, t, tok.getEndToken(), (com.pullenti.ner.address.AddressDetailType)tok.termin.tag);
        }
        for (tt = res.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
            ...
            if ((tt instanceof com.pullenti.ner.NumberToken) && tt.getNext() != null) {
                ...
                if (nex != null && ((nex.exTyp == com.pullenti.ner.core.NumberExType.METER || nex.exTyp == com.pullenti.ner.core.NumberExType.KILOMETER))) {
                    ...
                    com.pullenti.ner.core.NumberExType tyy = com.pullenti.ner.core.NumberExType.METER;
                    com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType> wraptyy113 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType>(tyy);
                    res.detailMeters = (int)nex.normalizeValue(wraptyy113);
    ...
    public static AddressItemToken tryAttachOrg(com.pullenti.ner.Token t) {
            ...
            if (Character.isUpperCase(namm.charAt(0)) && Character.isUpperCase(namm.charAt(1))) {
                for (int i = 0; i < namm.length(); i++) {
                    if (Character.isLowerCase(namm.charAt(i)) && i > 2) {
                        ...
                        com.pullenti.ner.core.Termin te = com.pullenti.ner.core.Termin._new114(abbr, abbr);
                        ...
                        if (li != null && li.size() > 0) {
                            ...
                            return _new115(ItemType.STREET, t, rt00.getEndToken(), rt00.referent, rt00, true);
                        }
                        break;
                    }
                }
        ...
        if (_typ != null) {
            ...
            rt = com.pullenti.ner.ReferentToken._new116(_org, t, t1, t.kit.getAnalyzerDataByAnalyzerName("ORGANIZATION"));
        ...
        if (rt.referent.findSlot("TYPE", "администрация", true) != null || rt.referent.findSlot("TYPE", "адміністрація", true) != null) {
            ...
            if (ge != null) 
                return _new84((ge.isRegion() ? ItemType.REGION : ItemType.CITY), t, rt.getEndToken(), ge);
        }
        AddressItemToken res = _new115(ItemType.STREET, t, rt.getEndToken(), rt.referent, rt, _typ != null);
        return res;
    }
    ...
    public static void initialize() throws Exception, java.io.IOException {
        ...
        t = com.pullenti.ner.core.Termin._new119("ДОМ", ItemType.HOUSE);
        t.addAbridge("Д.");
        t.addVariant("КОТТЕДЖ", false);
        t.addAbridge("КОТ.");
        t.addVariant("ДАЧА", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new120("БУДИНОК", ItemType.HOUSE, com.pullenti.morph.MorphLang.UA);
        t.addAbridge("Б.");
        t.addVariant("КОТЕДЖ", false);
        t.addAbridge("БУД.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("ВЛАДЕНИЕ", ItemType.HOUSE, com.pullenti.ner.address.AddressHouseType.ESTATE);
        t.addAbridge("ВЛАД.");
        t.addAbridge("ВЛД.");
        t.addAbridge("ВЛ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("ДОМОВЛАДЕНИЕ", ItemType.HOUSE, com.pullenti.ner.address.AddressHouseType.HOUSEESTATE);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОДЪЕЗД ДОМА", ItemType.HOUSE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОДВАЛ ДОМА", ItemType.HOUSE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КРЫША ДОМА", ItemType.HOUSE);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЭТАЖ", ItemType.FLOOR);
        t.addAbridge("ЭТ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПОДЪЕЗД", ItemType.POTCH);
        t.addAbridge("ПОД.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КОРПУС", ItemType.CORPUS);
        t.addAbridge("КОРП.");
        t.addAbridge("КОР.");
        t.addAbridge("Д.КОРП.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("К", ItemType.CORPUSORFLAT);
        t.addAbridge("К.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("СТРОЕНИЕ", ItemType.BUILDING);
        t.addAbridge("СТРОЕН.");
        t.addAbridge("СТР.");
        t.addAbridge("СТ.");
        ...
        t.addAbridge("Д.СТР.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("СООРУЖЕНИЕ", ItemType.BUILDING, com.pullenti.ner.address.AddressBuildingType.CONSTRUCTION);
        t.addAbridge("СООР.");
        t.addAbridge("СООРУЖ.");
        t.addAbridge("СООРУЖЕН.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new121("ЛИТЕРА", ItemType.BUILDING, com.pullenti.ner.address.AddressBuildingType.LITER);
        t.addAbridge("ЛИТ.");
        t.addVariant("ЛИТЕР", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("УЧАСТОК", ItemType.PLOT);
        t.addAbridge("УЧАСТ.");
        t.addAbridge("УЧ.");
        t.addAbridge("УЧ-К");
        ...
        t.addAbridge("ПОЗ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КВАРТИРА", ItemType.FLAT);
        t.addAbridge("КВАРТ.");
        t.addAbridge("КВАР.");
        t.addAbridge("КВ.");
        t.addAbridge("КВ-РА");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ОФИС", ItemType.OFFICE);
        t.addAbridge("ОФ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new120("ОФІС", ItemType.OFFICE, com.pullenti.morph.MorphLang.UA);
        t.addAbridge("ОФ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("БИЗНЕС-ЦЕНТР", ItemType.BUSINESSCENTER);
        t.acronym = "БЦ";
        t.addVariant("БИЗНЕС ЦЕНТР", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЛОК", ItemType.BLOCK);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("БОКС", ItemType.BOX);
        ...
        t.addAbridge("Г.Б.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КОМНАТА", ItemType.OFFICE);
        t.addAbridge("КОМ.");
        t.addAbridge("КОМН.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КАБИНЕТ", ItemType.OFFICE);
        t.addAbridge("КАБ.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("НОМЕР", ItemType.NUMBER);
        t.addAbridge("НОМ.");
        t.addAbridge("№");
        t.addAbridge("N");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new143("БЕЗ НОМЕРА", "Б/Н", ItemType.NONUMBER);
        t.addAbridge("Б.Н.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("АБОНЕНТСКИЙ ЯЩИК", ItemType.POSTOFFICEBOX);
        t.addAbridge("А.Я.");
        t.addVariant("ПОЧТОВЫЙ ЯЩИК", false);
        t.addAbridge("П.Я.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new145("ГОРОДСКАЯ СЛУЖЕБНАЯ ПОЧТА", ItemType.CSP, "ГСП");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("АДРЕС", ItemType.PREFIX);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("АДРЕСА", ItemType.PREFIX);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("КИЛОМЕТР", ItemType.KILOMETER);
        t.addAbridge("КИЛОМ.");
        t.addAbridge("КМ.");
        m_Ontology.add(t);
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПЕРЕСЕЧЕНИЕ", com.pullenti.ner.address.AddressDetailType.CROSS));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("НА ПЕРЕСЕЧЕНИИ", com.pullenti.ner.address.AddressDetailType.CROSS));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПЕРЕКРЕСТОК", com.pullenti.ner.address.AddressDetailType.CROSS));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("НА ПЕРЕКРЕСТКЕ", com.pullenti.ner.address.AddressDetailType.CROSS));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("НА ТЕРРИТОРИИ", com.pullenti.ner.address.AddressDetailType.NEAR));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕРЕДИНА", com.pullenti.ner.address.AddressDetailType.NEAR));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПРИМЫКАТЬ", com.pullenti.ner.address.AddressDetailType.NEAR));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ГРАНИЧИТЬ", com.pullenti.ner.address.AddressDetailType.NEAR));
        t = com.pullenti.ner.core.Termin._new119("ВБЛИЗИ", com.pullenti.ner.address.AddressDetailType.NEAR);
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("РАЙОН", com.pullenti.ner.address.AddressDetailType.NEAR);
        t.addAbridge("Р-Н");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new143("В РАЙОНЕ", "РАЙОН", com.pullenti.ner.address.AddressDetailType.NEAR);
        t.addAbridge("В Р-НЕ");
        m_Ontology.add(t);
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПРИМЕРНО", com.pullenti.ner.address.AddressDetailType.UNDEFINED));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПОРЯДКА", com.pullenti.ner.address.AddressDetailType.UNDEFINED));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ПРИБЛИЗИТЕЛЬНО", com.pullenti.ner.address.AddressDetailType.UNDEFINED));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("НАПРАВЛЕНИЕ", com.pullenti.ner.address.AddressDetailType.UNDEFINED));
        t = com.pullenti.ner.core.Termin._new119("ОБЩЕЖИТИЕ", com.pullenti.ner.address.AddressDetailType.HOSTEL);
        t.addAbridge("ОБЩ.");
        t.addAbridge("ПОМ.ОБЩ.");
        m_Ontology.add(t);
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕРНЕЕ", com.pullenti.ner.address.AddressDetailType.NORTH));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕР", com.pullenti.ner.address.AddressDetailType.NORTH));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮЖНЕЕ", com.pullenti.ner.address.AddressDetailType.SOUTH));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮГ", com.pullenti.ner.address.AddressDetailType.SOUTH));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЗАПАДНЕЕ", com.pullenti.ner.address.AddressDetailType.WEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЗАПАД", com.pullenti.ner.address.AddressDetailType.WEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ВОСТОЧНЕЕ", com.pullenti.ner.address.AddressDetailType.EAST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ВОСТОК", com.pullenti.ner.address.AddressDetailType.EAST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕРО-ЗАПАДНЕЕ", com.pullenti.ner.address.AddressDetailType.NORTHWEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕРО-ЗАПАД", com.pullenti.ner.address.AddressDetailType.NORTHWEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕРО-ВОСТОЧНЕЕ", com.pullenti.ner.address.AddressDetailType.NORTHEAST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("СЕВЕРО-ВОСТОК", com.pullenti.ner.address.AddressDetailType.NORTHEAST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮГО-ЗАПАДНЕЕ", com.pullenti.ner.address.AddressDetailType.SOUTHWEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮГО-ЗАПАД", com.pullenti.ner.address.AddressDetailType.SOUTHWEST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮГО-ВОСТОЧНЕЕ", com.pullenti.ner.address.AddressDetailType.SOUTHEAST));
        m_Ontology.add(com.pullenti.ner.core.Termin._new119("ЮГО-ВОСТОК", com.pullenti.ner.address.AddressDetailType.SOUTHEAST));
        t = new com.pullenti.ner.core.Termin("ТАМ ЖЕ", null, false);
        t.addAbridge("ТАМЖЕ");
        m_Ontology.add(t);
        m_OrgOntology = new com.pullenti.ner.core.TerminCollection();
        t = com.pullenti.ner.core.Termin._new114("САДОВОЕ ТОВАРИЩЕСТВО", "СТ");
        ...
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "СНО", true);
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "СНП", true);
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "СНТ", true);
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "НСТ", true);
        t.addVariant("НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНСТ", true);
        t.addVariant("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("САДОВОДЧЕСКАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", "СПК", true);
        t.addVariant("САДОВАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", false);
        m_OrgOntology.add(t);
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ДАЧНО СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ДСПК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ЖИЛИЩНЫЙ СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ЖСПК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ЖСК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ЖСКИЗ", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "ОНО", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "ОНП", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНТ", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ОГОРОДНИЧЕСКИЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ОПК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СТСН", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "ТСН", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ ЖИЛЬЯ", "ТСЖ", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("САДОВЫЕ ЗЕМЕЛЬНЫЕ УЧАСТКИ", "СЗУ", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ТОВАРИЩЕСТВО ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ТИЗ", true));
        t = com.pullenti.ner.core.Termin._new182("КОЛЛЕКТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "КИЗ", true);
        t.addVariant("КИЗК", false);
        m_OrgOntology.add(t);
        t = com.pullenti.ner.core.Termin._new182("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СНТСН", true);
        ...
        t.acronymCanBeLower = true;
        m_OrgOntology.add(t);
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ГСК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", "ГЭК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ГАРАЖНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГПК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ПГСК", true));
        m_OrgOntology.add(com.pullenti.ner.core.Termin._new182("ГАРАЖНЫЙ СТРОИТЕЛЬНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГСПК", true));
        m_OrgOntology.add(t);
    ...
    public static AddressItemToken _new84(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.Referent _arg4) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.referent = _arg4;
        return res;
    }

    public static AddressItemToken _new85(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, String _arg4) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.value = _arg4;
        return res;
    }

    public static AddressItemToken _new87(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.Referent _arg4, boolean _arg5) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.referent = _arg4;
        res.isDoubt = _arg5;
        return res;
    ...
    public static AddressItemToken _new95(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.ReferentToken _arg4) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.refToken = _arg4;
        return res;
    }

    public static AddressItemToken _new96(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, String _arg4, com.pullenti.ner.address.AddressHouseType _arg5) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.value = _arg4;
        res.houseType = _arg5;
        return res;
    ...
    public static AddressItemToken _new97(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.address.AddressHouseType _arg4, com.pullenti.ner.address.AddressBuildingType _arg5) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.houseType = _arg4;
    ...
    public static AddressItemToken _new98(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, String _arg4, com.pullenti.ner.address.AddressHouseType _arg5, com.pullenti.ner.address.AddressBuildingType _arg6) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.value = _arg4;
        res.houseType = _arg5;
    ...
    public static AddressItemToken _new106(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, com.pullenti.ner.address.AddressHouseType _arg6, com.pullenti.ner.address.AddressBuildingType _arg7) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.value = _arg4;
        res.setMorph(_arg5);
        res.houseType = _arg6;
    ...
    public static AddressItemToken _new112(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.address.AddressDetailType _arg4) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.detailType = _arg4;
        return res;
    }

    public static AddressItemToken _new115(ItemType _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.Token _arg3, com.pullenti.ner.Referent _arg4, com.pullenti.ner.ReferentToken _arg5, boolean _arg6) {
        AddressItemToken res = new AddressItemToken(_arg1, _arg2, _arg3);
        res.referent = _arg4;
        res.refToken = _arg5;

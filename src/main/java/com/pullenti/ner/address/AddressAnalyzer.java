            ...
            if (i > 0 && li.get(i - 1).typ == com.pullenti.ner.address.internal.AddressItemToken.ItemType.HOUSE && li.get(i - 1).isDigit()) {
                ...
                for (i = 0; i < li.size(); i++) {
                    ...
                    if (li.get(i).typ == com.pullenti.ner.address.internal.AddressItemToken.ItemType.HOUSE) {
                        ...
                        int v = 0;
                        com.pullenti.unisharp.Outargwrapper<Integer> wrapv340 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                        boolean inoutres341 = com.pullenti.unisharp.Utils.parseInteger(li.get(i).value, 0, null, wrapv340);
                        v = (wrapv340.value != null ? wrapv340.value : 0);
                        if (!inoutres341) {
                            com.pullenti.unisharp.Outargwrapper<Integer> wrapv334 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                            boolean inoutres335 = com.pullenti.unisharp.Utils.parseInteger(li.get(i).value.substring(0, 0 + li.get(i).value.length() - 1), 0, null, wrapv334);
                        ...
                        if (((i + 1) < li.size()) && ((li.get(i + 1).typ == com.pullenti.ner.address.internal.AddressItemToken.ItemType.NUMBER || li.get(i + 1).typ == com.pullenti.ner.address.internal.AddressItemToken.ItemType.FLAT)) && !li.get(i + 1).isNewlineBefore()) {
                            ...
                            boolean inoutres339 = com.pullenti.unisharp.Utils.parseInteger(li.get(i + 1).value, 0, null, wrapv338);

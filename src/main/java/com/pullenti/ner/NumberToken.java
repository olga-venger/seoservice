...
public class NumberToken extends MetaToken {
    ...
    public String setValue(String _value) {
        ...
        int n;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapn2801 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres2802 = com.pullenti.unisharp.Utils.parseInteger(m_Value, 0, null, wrapn2801);
        n = (wrapn2801.value != null ? wrapn2801.value : 0);
        if (inoutres2802) 
            m_IntVal = n;
        else 
            m_IntVal = null;
    ...
    public static NumberToken _new567(Token _arg1, Token _arg2, String _arg3, NumberSpellingType _arg4, MorphCollection _arg5) {

...
public class TextToken extends Token {
    ...
    public Object checkValue(java.util.HashMap<String, Object> dict) {
        if (dict == null) 
            return null;
        Object res;
        com.pullenti.unisharp.Outargwrapper<Object> wrapres2837 = new com.pullenti.unisharp.Outargwrapper<Object>();
        boolean inoutres2838 = com.pullenti.unisharp.Utils.tryGetValue(dict, term, wrapres2837);
        res = wrapres2837.value;
        if (inoutres2838) 
            return res;
        if (getMorph() != null) {
            for (com.pullenti.morph.MorphBaseInfo it : getMorph().getItems()) {
                ...
                if (mf != null) {
                    if (mf.normalCase != null) {
                        com.pullenti.unisharp.Outargwrapper<Object> wrapres2833 = new com.pullenti.unisharp.Outargwrapper<Object>();
                        boolean inoutres2834 = com.pullenti.unisharp.Utils.tryGetValue(dict, mf.normalCase, wrapres2833);
                        res = wrapres2833.value;
                        if (inoutres2834) 
                            return res;
                    }
                    if (mf.normalFull != null && com.pullenti.unisharp.Utils.stringsNe(mf.normalCase, mf.normalFull)) {
                        com.pullenti.unisharp.Outargwrapper<Object> wrapres2835 = new com.pullenti.unisharp.Outargwrapper<Object>();
                        boolean inoutres2836 = com.pullenti.unisharp.Utils.tryGetValue(dict, mf.normalFull, wrapres2835);
                        res = wrapres2835.value;
                        if (inoutres2836) 
                            return res;
                    }
                }
    ...
    public String getNormalCaseText(com.pullenti.morph.MorphClass mc, boolean singleNumber, com.pullenti.morph.MorphGender gender, boolean keepChars) {
        ...
        if (singleNumber && mc != null) {
            com.pullenti.morph.MorphBaseInfo bi = com.pullenti.morph.MorphBaseInfo._new560(new com.pullenti.morph.MorphClass(mc), gender, com.pullenti.morph.MorphNumber.SINGULAR, this.getMorph().getLanguage());
    ...
    public static TextToken _new540(com.pullenti.morph.MorphToken _arg1, com.pullenti.ner.core.AnalysisKit _arg2, String _arg3) {
        TextToken res = new TextToken(_arg1, _arg2);
        res.term0 = _arg3;
        return res;
    }

    public static TextToken _new543(com.pullenti.morph.MorphToken _arg1, com.pullenti.ner.core.AnalysisKit _arg2, com.pullenti.morph.CharsInfo _arg3, int _arg4, int _arg5, String _arg6) {
        TextToken res = new TextToken(_arg1, _arg2);
        res.chars = _arg3;
        res.beginChar = _arg4;
        res.endChar = _arg5;

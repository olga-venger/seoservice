...
public class NumberExHelper {
    ...
    public static com.pullenti.ner.core.NumberExToken tryParseNumberWithPostfix(com.pullenti.ner.Token t) {
        ...
        if (nt == null) {
            if ((!((t.getPrevious() instanceof com.pullenti.ner.NumberToken)) && t.isChar('(') && (t.getNext() instanceof com.pullenti.ner.NumberToken)) && t.getNext().getNext() != null && t.getNext().getNext().isChar(')')) {
                ...
                if (toks1 != null && ((com.pullenti.ner.core.NumberExType)toks1.termin.tag) == com.pullenti.ner.core.NumberExType.MONEY) {
                    ...
                    com.pullenti.ner.core.NumberExToken res = com.pullenti.ner.core.NumberExToken._new473(t, toks1.getEndToken(), nt0.getValue(), nt0.typ, com.pullenti.ner.core.NumberExType.MONEY, nt0.getRealValue(), toks1.getBeginToken().getMorph());
            ...
            for (int i = 4; i < (val.length() - 5); i++) {
                ...
                if (lii != null && lii.size() > 0) {
                    com.pullenti.ner.core.NumberExToken re = com.pullenti.ner.core.NumberExToken._new474(t, t, ((Integer)((int)li.get(0).tag)).toString(), com.pullenti.ner.NumberSpellingType.WORDS, (com.pullenti.ner.core.NumberExType)lii.get(0).tag, t.getMorph());
                    _correctExtTypes(re);
                    return re;
                }
                break;
                    ...
                    if (toks1 != null) {
                        if (((com.pullenti.ner.core.NumberExType)toks1.termin.tag) == com.pullenti.ner.core.NumberExType.MONEY) {
                            if (toks1.getEndToken().getNext() != null && toks1.getEndToken().getNext().isChar(')')) {
                                com.pullenti.ner.core.NumberExToken res = com.pullenti.ner.core.NumberExToken._new475(t, toks1.getEndToken().getNext(), nt.getValue(), nt.typ, com.pullenti.ner.core.NumberExType.MONEY, f, altf, toks1.getBeginToken().getMorph());
                                return _correctMoney(res, toks1.getBeginToken());
                            }
                        }
                    }
        ...
        if (isDollar != null) {
            ...
            return com.pullenti.ner.core.NumberExToken._new476(t0, te, "", nt.typ, com.pullenti.ner.core.NumberExType.MONEY, f, altf, isDollar);
        }
        ...
        if (toks != null) {
            ...
            com.pullenti.ner.core.NumberExToken res = com.pullenti.ner.core.NumberExToken._new475(t, t1, nt.getValue(), nt.typ, ty, f, altf, toks.getBeginToken().getMorph());
        ...
        if (t1.getNext() != null && ((t1.getMorph()._getClass().isPreposition() || t1.getMorph()._getClass().isConjunction()))) {
            if (t1.isValue("НА", null)) {
                ...
                if (nn != null) 
                    return com.pullenti.ner.core.NumberExToken._new478(t, t, nt.getValue(), nt.typ, nn.exTyp, f, altf, nn.exTyp2, nn.exTypParam);
            }
        }
        if (!t1.isWhitespaceAfter() && (t1.getNext() instanceof com.pullenti.ner.NumberToken) && (t1 instanceof com.pullenti.ner.TextToken)) {
            ...
            if (ty != com.pullenti.ner.core.NumberExType.UNDEFINED) 
                return com.pullenti.ner.core.NumberExToken._new479(t, t1, nt.getValue(), nt.typ, ty, f, altf, true);
        }
        return null;
    }
    ...
    private static com.pullenti.ner.core.NumberExToken _attachSpecPostfix(com.pullenti.ner.Token t) {
        ...
        if (money != null) 
            return com.pullenti.ner.core.NumberExToken._new480(t, t, "", com.pullenti.ner.NumberSpellingType.DIGIT, com.pullenti.ner.core.NumberExType.MONEY, money);
        return null;
    }
    ...
    private static void _correctExtTypes(com.pullenti.ner.core.NumberExToken ex) {
        ...
        com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType> wrapty482 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType>(ty);
        com.pullenti.ner.Token tt = _corrExTyp2(t, wrapty482);
        ty = wrapty482.value;
        if (tt != null) {
            ex.exTyp = ty;
            ex.setEndToken(tt);
        ...
        if (tok != null && ((((com.pullenti.ner.core.NumberExType)tok.termin.tag) != com.pullenti.ner.core.NumberExType.MONEY))) {
            ...
            ty = ex.exTyp2;
            com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType> wrapty481 = new com.pullenti.unisharp.Outargwrapper<com.pullenti.ner.core.NumberExType>(ty);
            tt = _corrExTyp2(ex.getEndToken().getNext(), wrapty481);
            ty = wrapty481.value;
            if (tt != null) {
                ex.exTyp2 = ty;
                ex.setEndToken(tt);
    ...
    public static void initialize() {
        ...
        t = com.pullenti.ner.core.Termin._new483("КВАДРАТНЫЙ МЕТР", com.pullenti.morph.MorphLang.RU, true, "кв.м.", com.pullenti.ner.core.NumberExType.METER2);
        t.addAbridge("КВ.МЕТР");
        t.addAbridge("КВ.МЕТРА");
        t.addAbridge("КВ.М.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КВАДРАТНИЙ МЕТР", com.pullenti.morph.MorphLang.UA, true, "КВ.М.", com.pullenti.ner.core.NumberExType.METER2);
        t.addAbridge("КВ.МЕТР");
        t.addAbridge("КВ.МЕТРА");
        t.addAbridge("КВ.М.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КВАДРАТНЫЙ КИЛОМЕТР", com.pullenti.morph.MorphLang.RU, true, "кв.км.", com.pullenti.ner.core.NumberExType.KILOMETER2);
        t.addVariant("КВАДРАТНИЙ КІЛОМЕТР", true);
        t.addAbridge("КВ.КМ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ГЕКТАР", com.pullenti.morph.MorphLang.RU, true, "га", com.pullenti.ner.core.NumberExType.GEKTAR);
        t.addAbridge("ГА");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("АР", com.pullenti.morph.MorphLang.RU, true, "ар", com.pullenti.ner.core.NumberExType.AR);
        t.addVariant("СОТКА", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КУБИЧЕСКИЙ МЕТР", com.pullenti.morph.MorphLang.RU, true, "куб.м.", com.pullenti.ner.core.NumberExType.METER3);
        t.addVariant("КУБІЧНИЙ МЕТР", true);
        t.addAbridge("КУБ.МЕТР");
        t.addAbridge("КУБ.М.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МЕТР", com.pullenti.morph.MorphLang.RU, true, "м.", com.pullenti.ner.core.NumberExType.METER);
        t.addAbridge("М.");
        t.addAbridge("M.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МЕТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "м.", com.pullenti.ner.core.NumberExType.METER);
        t.addVariant("МЕТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИМЕТР", com.pullenti.morph.MorphLang.RU, true, "мм.", com.pullenti.ner.core.NumberExType.MILLIMETER);
        t.addAbridge("ММ");
        t.addAbridge("MM");
        t.addVariant("МІЛІМЕТР", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИМЕТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "мм.", com.pullenti.ner.core.NumberExType.MILLIMETER);
        t.addVariant("МІЛІМЕТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("САНТИМЕТР", com.pullenti.morph.MorphLang.RU, true, "см.", com.pullenti.ner.core.NumberExType.SANTIMETER);
        t.addAbridge("СМ");
        t.addAbridge("CM");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("САНТИМЕТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "см.", com.pullenti.ner.core.NumberExType.SANTIMETER);
        t.addVariant("САНТИМЕТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КВАДРАТНЫЙ САНТИМЕТР", com.pullenti.morph.MorphLang.RU, true, "кв.см.", com.pullenti.ner.core.NumberExType.SANTIMETER2);
        t.addVariant("КВАДРАТНИЙ САНТИМЕТР", true);
        t.addAbridge("КВ.СМ.");
        t.addAbridge("СМ.КВ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КУБИЧЕСКИЙ САНТИМЕТР", com.pullenti.morph.MorphLang.RU, true, "куб.см.", com.pullenti.ner.core.NumberExType.SANTIMETER3);
        t.addVariant("КУБІЧНИЙ САНТИМЕТР", true);
        t.addAbridge("КУБ.САНТИМЕТР");
        t.addAbridge("КУБ.СМ.");
        t.addAbridge("СМ.КУБ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КИЛОМЕТР", com.pullenti.morph.MorphLang.RU, true, "км.", com.pullenti.ner.core.NumberExType.KILOMETER);
        t.addAbridge("КМ");
        t.addAbridge("KM");
        t.addVariant("КІЛОМЕТР", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КИЛОМЕТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "км.", com.pullenti.ner.core.NumberExType.KILOMETER);
        t.addVariant("КІЛОМЕТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЯ", com.pullenti.morph.MorphLang.RU, true, "миль", com.pullenti.ner.core.NumberExType.KILOMETER);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ГРАММ", com.pullenti.morph.MorphLang.RU, true, "гр.", com.pullenti.ner.core.NumberExType.GRAMM);
        t.addAbridge("ГР");
        t.addAbridge("Г");
        t.addVariant("ГРАМ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ГРАММОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "гр.", com.pullenti.ner.core.NumberExType.GRAMM);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КИЛОГРАММ", com.pullenti.morph.MorphLang.RU, true, "кг.", com.pullenti.ner.core.NumberExType.KILOGRAM);
        t.addAbridge("КГ");
        t.addVariant("КІЛОГРАМ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КИЛОГРАММОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "кг.", com.pullenti.ner.core.NumberExType.KILOGRAM);
        t.addVariant("КІЛОГРАМОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИГРАММ", com.pullenti.morph.MorphLang.RU, true, "мг.", com.pullenti.ner.core.NumberExType.MILLIGRAM);
        t.addAbridge("МГ");
        t.addVariant("МІЛІГРАМ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИГРАММОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "мг.", com.pullenti.ner.core.NumberExType.MILLIGRAM);
        t.addVariant("МИЛЛИГРАМОВЫЙ", true);
        t.addVariant("МІЛІГРАМОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ТОННА", com.pullenti.morph.MorphLang.RU, true, "т.", com.pullenti.ner.core.NumberExType.TONNA);
        t.addAbridge("Т");
        t.addAbridge("T");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ТОННЫЙ", com.pullenti.morph.MorphLang.RU, true, "т.", com.pullenti.ner.core.NumberExType.TONNA);
        t.addVariant("ТОННИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ЛИТР", com.pullenti.morph.MorphLang.RU, true, "л.", com.pullenti.ner.core.NumberExType.LITR);
        t.addAbridge("Л");
        t.addVariant("ЛІТР", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ЛИТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "л.", com.pullenti.ner.core.NumberExType.LITR);
        t.addVariant("ЛІТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИЛИТР", com.pullenti.morph.MorphLang.RU, true, "мл.", com.pullenti.ner.core.NumberExType.MILLILITR);
        t.addAbridge("МЛ");
        t.addVariant("МІЛІЛІТР", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИЛЛИЛИТРОВЫЙ", com.pullenti.morph.MorphLang.RU, true, "мл.", com.pullenti.ner.core.NumberExType.MILLILITR);
        t.addVariant("МІЛІЛІТРОВИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ЧАС", com.pullenti.morph.MorphLang.RU, true, "ч.", com.pullenti.ner.core.NumberExType.HOUR);
        t.addAbridge("Ч.");
        t.addVariant("ГОДИНА", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МИНУТА", com.pullenti.morph.MorphLang.RU, true, "мин.", com.pullenti.ner.core.NumberExType.MINUTE);
        t.addAbridge("МИН.");
        t.addVariant("ХВИЛИНА", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("СЕКУНДА", com.pullenti.morph.MorphLang.RU, true, "сек.", com.pullenti.ner.core.NumberExType.SECOND);
        t.addAbridge("СЕК.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ГОД", com.pullenti.morph.MorphLang.RU, true, "г.", com.pullenti.ner.core.NumberExType.YEAR);
        t.addAbridge("Г.");
        t.addAbridge("ЛЕТ");
        t.addVariant("ЛЕТНИЙ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("МЕСЯЦ", com.pullenti.morph.MorphLang.RU, true, "мес.", com.pullenti.ner.core.NumberExType.MONTH);
        t.addAbridge("МЕС.");
        t.addVariant("МЕСЯЧНЫЙ", true);
        t.addVariant("КАЛЕНДАРНЫЙ МЕСЯЦ", true);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ДЕНЬ", com.pullenti.morph.MorphLang.RU, true, "дн.", com.pullenti.ner.core.NumberExType.DAY);
        t.addAbridge("ДН.");
        ...
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("НЕДЕЛЯ", com.pullenti.morph.MorphLang.RU, true, "нед.", com.pullenti.ner.core.NumberExType.WEEK);
        t.addVariant("НЕДЕЛЬНЫЙ", true);
        t.addVariant("КАЛЕНДАРНАЯ НЕДЕЛЯ", false);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ПРОЦЕНТ", com.pullenti.morph.MorphLang.RU, true, "%", com.pullenti.ner.core.NumberExType.PERCENT);
        t.addVariant("%", false);
        t.addVariant("ПРОЦ", true);
        t.addAbridge("ПРОЦ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ШТУКА", com.pullenti.morph.MorphLang.RU, true, "шт.", com.pullenti.ner.core.NumberExType.SHUK);
        t.addVariant("ШТ", false);
        t.addAbridge("ШТ.");
        t.addAbridge("ШТ-К");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("УПАКОВКА", com.pullenti.morph.MorphLang.RU, true, "уп.", com.pullenti.ner.core.NumberExType.UPAK);
        ...
        t.addAbridge("УП-КА");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("РУЛОН", com.pullenti.morph.MorphLang.RU, true, "рулон", com.pullenti.ner.core.NumberExType.RULON);
        t.addVariant("РУЛ", true);
        t.addAbridge("РУЛ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("НАБОР", com.pullenti.morph.MorphLang.RU, true, "набор", com.pullenti.ner.core.NumberExType.NABOR);
        t.addVariant("НАБ", true);
        t.addAbridge("НАБ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("КОМПЛЕКТ", com.pullenti.morph.MorphLang.RU, true, "компл.", com.pullenti.ner.core.NumberExType.KOMPLEKT);
        t.addVariant("КОМПЛ", true);
        t.addAbridge("КОМПЛ.");
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ПАРА", com.pullenti.morph.MorphLang.RU, true, "пар", com.pullenti.ner.core.NumberExType.PARA);
        m_Postfixes.add(t);
        t = com.pullenti.ner.core.Termin._new483("ФЛАКОН", com.pullenti.morph.MorphLang.RU, true, "флак.", com.pullenti.ner.core.NumberExType.FLAKON);
        ...
        t = com.pullenti.ner.core.Termin._new143("УСЛОВНАЯ ЕДИНИЦА", "УЕ", com.pullenti.ner.core.NumberExType.MONEY);
        t.addAbridge("У.Е.");
        t.addAbridge("У.E.");
        t.addAbridge("Y.Е.");
        t.addAbridge("Y.E.");
        ...
        for (int k = 0; k < 3; k++) {
            ...
            for (String line0 : com.pullenti.unisharp.Utils.split(str, String.valueOf('\n'), false)) {
                ...
                if (i < 2) 
                    continue;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapnum528 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres529 = com.pullenti.unisharp.Utils.parseInteger(parts[3].substring(0, 0 + i), 0, null, wrapnum528);
                num = (wrapnum528.value != null ? wrapnum528.value : 0);
                if (!inoutres529) 
                    continue;

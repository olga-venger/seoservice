...
public class OrgItemEngItem extends com.pullenti.ner.MetaToken {
    ...
    public static void initialize() {
        ...
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Public Limited Company".toUpperCase(), "PLC");
        t.addAbridge("P.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Limited Liability Company".toUpperCase(), "LLC");
        t.addAbridge("L.L.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Limited Liability Partnership".toUpperCase(), "LLP");
        t.addAbridge("L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Limited Liability Limited Partnership".toUpperCase(), "LLLP");
        t.addAbridge("L.L.L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Limited Duration Company".toUpperCase(), "LDC");
        t.addAbridge("L.D.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("International Business Company".toUpperCase(), "IBC");
        t.addAbridge("I.B.S.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Joint stock company".toUpperCase(), "JSC");
        t.addAbridge("J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Open Joint stock company".toUpperCase(), "OJSC");
        t.addAbridge("O.J.S.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Sosiedad Anonima".toUpperCase(), "SA");
        t.addVariant("Sociedad Anonima".toUpperCase(), false);
        t.addAbridge("S.A.");
        t.addVariant("SPA", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Société en commandite".toUpperCase(), "SC");
        t.addAbridge("S.C.");
        t.addVariant("SCS", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Societas Europaea".toUpperCase(), "SE");
        t.addAbridge("S.E.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Società in accomandita".toUpperCase(), "SAS");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Société en commandite par actions".toUpperCase(), "SCA");
        t.addAbridge("S.C.A.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Société en nom collectif".toUpperCase(), "SNC");
        t.addVariant("Società in nome collettivo".toUpperCase(), false);
        t.addAbridge("S.N.C.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("General Partnership".toUpperCase(), "GP");
        t.addVariant("General Partners", false);
        t.addAbridge("G.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Limited Partnership".toUpperCase(), "LP");
        t.addAbridge("L.P.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Kommanditaktiengesellschaft".toUpperCase(), "KGAA");
        t.addVariant("KOMMAG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Societe a Responsidilite Limitee".toUpperCase(), "SRL");
        t.addAbridge("S.A.R.L.");
        t.addAbridge("S.R.L.");
        t.addVariant("SARL", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Società a garanzia limitata".toUpperCase(), "SAGL");
        t.addAbridge("S.A.G.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Società limitata".toUpperCase(), "SL");
        t.addAbridge("S.L.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Vennootschap Met Beperkte Aansparkelij kheid".toUpperCase(), "BV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Vennootschap Met Beperkte Aansparkelij".toUpperCase(), "AVV");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Naamlose Vennootschap".toUpperCase(), "NV");
        t.addAbridge("N.V.");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Gesellschaft mit beschrakter Haftung".toUpperCase(), "GMBH");
        t.addVariant("ГМБХ", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Aktiengesellschaft".toUpperCase(), "AG");
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("International Company".toUpperCase(), "IC");
        t.addAbridge("I.C.");
        m_Ontology.add(t);
        ...
        t.addVariant("& Company", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Kollektivgesellschaft".toUpperCase(), "KG");
        t.addAbridge("K.G.");
        t.addVariant("OHG", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new114("Kommanditgesellschaft".toUpperCase(), "KG");

...
public class FundsItemToken extends com.pullenti.ner.MetaToken {
    ...
    public static FundsItemToken tryParse(com.pullenti.ner.Token t, FundsItemToken prev) {
        ...
        for (com.pullenti.ner.Token tt = t; tt != null; tt = tt.getNext()) {
            ...
            if (re instanceof com.pullenti.ner._org.OrganizationReferent) 
                return _new430(t, tt, FundsItemTyp.ORG, re);
            if (re instanceof com.pullenti.ner.money.MoneyReferent) {
                ...
                if ((tt.getNext() != null && tt.getNext().isValue("ЗА", null) && tt.getNext().getNext() != null) && ((tt.getNext().getNext().isValue("АКЦИЯ", null) || tt.getNext().getNext().isValue("АКЦІЯ", null)))) 
                    typ0 = FundsItemTyp.PRICE;
                FundsItemToken res = _new430(t, tt, typ0, re);
                return res;
            }
            if (re != null) 
                break;
            ...
            if (npt != null) {
                ...
                if (npt.noun.isValue("АКЦІЯ", null) || npt.noun.isValue("АКЦИЯ", null)) {
                    res = _new432(t, npt.getEndToken(), FundsItemTyp.NOUN, com.pullenti.ner.business.FundsKind.STOCK);
                    ...
                    res = _new433(t, npt.getEndToken(), FundsItemTyp.NOUN, com.pullenti.ner.business.FundsKind.STOCK, "ценные бумаги");
                    ...
                    res = _new432(t, npt.getEndToken(), FundsItemTyp.NOUN, com.pullenti.ner.business.FundsKind.CAPITAL);
                if (res != null) {
            ...
            if (prev != null && prev.typ == FundsItemTyp.COUNT) {
                ...
                if (val != null) {
                    ...
                    if (ok) {
                        FundsItemToken res = _new435(t, tt, com.pullenti.ner.business.FundsKind.STOCK, FundsItemTyp.NOUN);
            ...
            if (tt instanceof com.pullenti.ner.NumberToken) {
                ...
                if (num != null) {
                    ...
                    if (num.exTyp == com.pullenti.ner.core.NumberExType.PERCENT) {
                        FundsItemToken res = _new436(t, num.getEndToken(), FundsItemTyp.PERCENT, num);
                ...
                if (t1.getNext() != null && t1.getNext().isValue("ШТУКА", null)) 
                    t1 = t1.getNext();
                return _new436(t, t1, FundsItemTyp.COUNT, (com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.NumberToken.class));
            }
            break;
        }
        return null;
    ...
    public static FundsItemToken _new430(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, FundsItemTyp _arg3, com.pullenti.ner.Referent _arg4) {
    ...
    public static FundsItemToken _new432(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, FundsItemTyp _arg3, com.pullenti.ner.business.FundsKind _arg4) {
        FundsItemToken res = new FundsItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.kind = _arg4;
        return res;
    ...
    public static FundsItemToken _new433(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, FundsItemTyp _arg3, com.pullenti.ner.business.FundsKind _arg4, String _arg5) {
        FundsItemToken res = new FundsItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.kind = _arg4;
        res.stringVal = _arg5;
    ...
    public static FundsItemToken _new435(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.business.FundsKind _arg3, FundsItemTyp _arg4) {
        FundsItemToken res = new FundsItemToken(_arg1, _arg2);
        res.kind = _arg3;
        res.typ = _arg4;
        return res;
    ...
    public static FundsItemToken _new436(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, FundsItemTyp _arg3, com.pullenti.ner.NumberToken _arg4) {
        FundsItemToken res = new FundsItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.numVal = _arg4;
        return res;

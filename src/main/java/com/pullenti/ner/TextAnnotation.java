...
public class TextAnnotation {
    ...
    public static TextAnnotation _new544(SourceOfAnalysis _arg1, int _arg2, int _arg3) {
    ...
    public static TextAnnotation _new719(SourceOfAnalysis _arg1, int _arg2, int _arg3, Referent _arg4) {
        TextAnnotation res = new TextAnnotation(null, null, null);
        res.sofa = _arg1;
        res.beginChar = _arg2;
        res.endChar = _arg3;
    ...
    public static TextAnnotation _new1572(int _arg1, int _arg2, Referent _arg3, SourceOfAnalysis _arg4) {
        TextAnnotation res = new TextAnnotation(null, null, null);
        res.beginChar = _arg1;
        res.endChar = _arg2;
    ...
    public static TextAnnotation _new2826(int _arg1, int _arg2, SourceOfAnalysis _arg3) {
        TextAnnotation res = new TextAnnotation(null, null, null);
        res.beginChar = _arg1;
        res.endChar = _arg2;
        res.sofa = _arg3;
    ...
    public static TextAnnotation _new2829(SourceOfAnalysis _arg1, Referent _arg2) {
        TextAnnotation res = new TextAnnotation(null, null, null);
        res.sofa = _arg1;

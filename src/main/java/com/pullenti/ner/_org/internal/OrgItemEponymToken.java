...
public class OrgItemEponymToken extends com.pullenti.ner.MetaToken {
    ...
    public static OrgItemEponymToken tryAttach(com.pullenti.ner.Token t, boolean mustHasPrefix) {
        ...
        if (tt == null) {
            ...
            if (r1 != null && com.pullenti.unisharp.Utils.stringsEq(r1.getTypeName(), "DATE")) {
                ...
                if ((com.pullenti.unisharp.Utils.stringsEq(str, "1 МАЯ") || com.pullenti.unisharp.Utils.stringsEq(str, "7 ОКТЯБРЯ") || com.pullenti.unisharp.Utils.stringsEq(str, "9 МАЯ")) || com.pullenti.unisharp.Utils.stringsEq(str, "8 МАРТА")) {
                    OrgItemEponymToken dt = _new1760(t, t, new java.util.ArrayList<String>());
                    dt.eponyms.add(str);
                    return dt;
                }
            }
            ...
            if ((age != null && (((age.getEndToken().getNext() instanceof com.pullenti.ner.TextToken) || (age.getEndToken().getNext() instanceof com.pullenti.ner.ReferentToken))) && (age.getWhitespacesAfterCount() < 3)) && !age.getEndToken().getNext().chars.isAllLower() && age.getEndToken().getNext().chars.isCyrillicLetter()) {
                OrgItemEponymToken dt = _new1760(t, age.getEndToken().getNext(), new java.util.ArrayList<String>());
        ...
        if ((r != null && com.pullenti.unisharp.Utils.stringsEq(r.getTypeName(), "DATE") && full) && r.findSlot("DAY", null, true) != null && r.findSlot("YEAR", null, true) == null) {
            OrgItemEponymToken dt = _new1760(t, t1, new java.util.ArrayList<String>());
    ...
    public static class PersonItemToken extends com.pullenti.ner.MetaToken {
            ...
            for (; t != null; t = t.getNext()) {
                ...
                if (((s.length() == 1 || com.pullenti.unisharp.Utils.stringsEq(s, "ДЖ"))) && !tt.chars.isAllLower()) {
                    ...
                    if (t1.getNext() != null && t1.getNext().isChar('.')) 
                        t1 = t1.getNext();
                    res.add(_new1764(t, t1, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.INITIAL, s));
                    t = t1;
                    continue;
                }
                if (tt.isAnd()) {
                    res.add(_new1765(t, t, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.AND));
                    continue;
                }
                ...
                if (tt.chars.isAllLower()) {
                    ...
                    if (t1.getNext() != null && !t1.isWhitespaceAfter() && t1.getNext().isChar('.')) 
                        t1 = t1.getNext();
                    res.add(_new1764(t, t1, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.LOCASEWORD, s));
                    t = t1;
                    continue;
                }
                if (tt.getMorph()._getClass().isProperName()) 
                    res.add(_new1764(t, t, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.NAME, s));
                    ...
                    res.add(_new1764(t, t.getNext().getNext(), com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.SURNAME, (s + "-" + (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext().getNext(), com.pullenti.ner.TextToken.class))).term)));
                    t = t.getNext().getNext();
                }
                else 
                    res.add(_new1764(t, t, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType.SURNAME, s));
            }
            return (res.size() > 0 ? res : null);
        }
    
        public static PersonItemToken _new1764(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType _arg3, String _arg4) {
        ...
        public static PersonItemToken _new1765(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner._org.internal.OrgItemEponymToken.PersonItemType _arg3) {
            PersonItemToken res = new PersonItemToken(_arg1, _arg2);
            res.typ = _arg3;
            return res;
        }
    ...
    public static OrgItemEponymToken _new1760(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, java.util.ArrayList<String> _arg3) {

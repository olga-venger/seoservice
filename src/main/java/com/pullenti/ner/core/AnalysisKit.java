...
public class AnalysisKit {
        ...
        if (tokens != null) {
            for (int ii = 0; ii < tokens.size(); ii++) {
                ...
                if (_sofa.correctionDict != null) {
                    String corw;
                    com.pullenti.unisharp.Outargwrapper<String> wrapcorw541 = new com.pullenti.unisharp.Outargwrapper<String>();
                    boolean inoutres542 = com.pullenti.unisharp.Utils.tryGetValue(_sofa.correctionDict, mt.term, wrapcorw541);
                    corw = wrapcorw541.value;
                    if (inoutres542) {
                        ...
                        if (ccc != null && ccc.size() == 1) {
                            com.pullenti.ner.TextToken tt1 = com.pullenti.ner.TextToken._new540(ccc.get(0), this, tt.term);
    ...
    private void correctWordsByMorph(com.pullenti.morph.MorphLang lang) {
        for (com.pullenti.ner.Token tt = firstToken; tt != null; tt = tt.getNext()) {
            ...
            if (ccc == null || ccc.size() != 1) 
                continue;
            com.pullenti.ner.TextToken tt1 = com.pullenti.ner.TextToken._new543(ccc.get(0), this, tt.chars, tt.beginChar, tt.endChar, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term);
    ...
    public void embedToken(com.pullenti.ner.MetaToken mt) {
        ...
        if (mt instanceof com.pullenti.ner.ReferentToken) {
            if ((((com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(mt, com.pullenti.ner.ReferentToken.class))).referent != null) 
                (((com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(mt, com.pullenti.ner.ReferentToken.class))).referent.addOccurence(com.pullenti.ner.TextAnnotation._new544(this.getSofa(), mt.beginChar, mt.endChar));
        }
    }
    ...
    public AnalyzerData getAnalyzerData(com.pullenti.ner.Analyzer analyzer) {
        if (analyzer == null || analyzer.getName() == null) 
            return null;
        AnalyzerData d;
        com.pullenti.unisharp.Outargwrapper<AnalyzerData> wrapd545 = new com.pullenti.unisharp.Outargwrapper<AnalyzerData>();
        boolean inoutres546 = com.pullenti.unisharp.Utils.tryGetValue(m_Datas, analyzer.getName(), wrapd545);
        d = wrapd545.value;
        if (inoutres546) {
            d.kit = this;
            return d;
    ...
    public static AnalysisKit _new2805(com.pullenti.ner.Processor _arg1, com.pullenti.ner.ExtOntology _arg2) {
    ...
    public static AnalysisKit _new2806(com.pullenti.ner.SourceOfAnalysis _arg1, boolean _arg2, com.pullenti.morph.MorphLang _arg3, com.pullenti.unisharp.ProgressEventHandler _arg4, com.pullenti.ner.ExtOntology _arg5, com.pullenti.ner.Processor _arg6) {

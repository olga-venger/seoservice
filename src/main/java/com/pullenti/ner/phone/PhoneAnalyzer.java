...
public class PhoneAnalyzer extends com.pullenti.ner.Analyzer {
    ...
    public static class PhoneAnalizerData extends com.pullenti.ner.core.AnalyzerData {
        ...
        public com.pullenti.ner.Referent registerReferent(com.pullenti.ner.Referent referent) {
            ...
            com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.phone.PhoneReferent>> wrapphLi2588 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.phone.PhoneReferent>>();
            boolean inoutres2589 = com.pullenti.unisharp.Utils.tryGetValue(m_PhonesHash, key, wrapphLi2588);
            phLi = wrapphLi2588.value;
            if (!inoutres2589) 

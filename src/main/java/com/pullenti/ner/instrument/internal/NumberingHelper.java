...
public class NumberingHelper {
    ...
    public static int calcDelta(InstrToken1 prev, InstrToken1 next, boolean canSubNumbers) {
        ...
        if ((prev.numbers.size() - 1) == next.numbers.size() && prev.numbers.size() > 1) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11534 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1535 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 2), 0, null, wrapn11534);
            n1 = (wrapn11534.value != null ? wrapn11534.value : 0);
            if (!inoutres1535) {
        ...
        if ((prev.numbers.size() - 2) == next.numbers.size() && prev.numbers.size() > 2) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11536 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1537 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 3), 0, null, wrapn11536);
            n1 = (wrapn11536.value != null ? wrapn11536.value : 0);
            if (!inoutres1537) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
        ...
        if ((prev.numbers.size() - 3) == next.numbers.size() && prev.numbers.size() > 3) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11538 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1539 = com.pullenti.unisharp.Utils.parseInteger(prev.numbers.get(prev.numbers.size() - 4), 0, null, wrapn11538);
            n1 = (wrapn11538.value != null ? wrapn11538.value : 0);
            if (!inoutres1539) 
                return 0;
            if ((n1 + 1) != n2) 
                return 0;
    ...
    public static void createNumber(FragToken owner, InstrToken1 itok) {
        if (itok.numBeginToken == null || itok.numEndToken == null) 
            return;
        FragToken num = FragToken._new1540(itok.numBeginToken, itok.numEndToken, com.pullenti.ner.instrument.InstrumentKind.NUMBER, true, itok);
    ...
    public static java.util.ArrayList<String> createDiap(String s1, String s2) {
        ...
        if (s2.startsWith(s1)) {
            ...
            if (((i + 1) < s2.length()) && s2.charAt(i) == '.' && Character.isDigit(s2.charAt(i + 1))) {
                com.pullenti.unisharp.Outargwrapper<Integer> wrapn21541 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1542 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21541);
                n2 = (wrapn21541.value != null ? wrapn21541.value : 0);
                if (inoutres1542) {
        ...
        if ((((i = s1.lastIndexOf('.')))) > 0) {
            ...
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11545 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1546 = com.pullenti.unisharp.Utils.parseInteger(s1.substring(i + 1), 0, null, wrapn11545);
            n1 = (wrapn11545.value != null ? wrapn11545.value : 0);
            if (!inoutres1546) 
                return null;
            if (!s2.startsWith(pref)) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21543 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1544 = com.pullenti.unisharp.Utils.parseInteger(s2.substring(i + 1), 0, null, wrapn21543);
            n2 = (wrapn21543.value != null ? wrapn21543.value : 0);
            if (!inoutres1544) 
                return null;
        }
        else {
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn11549 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1550 = com.pullenti.unisharp.Utils.parseInteger(s1, 0, null, wrapn11549);
            n1 = (wrapn11549.value != null ? wrapn11549.value : 0);
            if (!inoutres1550) 
                return null;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapn21547 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1548 = com.pullenti.unisharp.Utils.parseInteger(s2, 0, null, wrapn21547);
            n2 = (wrapn21547.value != null ? wrapn21547.value : 0);
            if (!inoutres1548) 
                return null;
        }
        if (n2 <= n1) 

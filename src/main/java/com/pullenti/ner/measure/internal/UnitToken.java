...
public class UnitToken extends com.pullenti.ner.MetaToken {
    ...
    public static UnitToken tryParse(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection addUnits, UnitToken prev, boolean parseUnknownUnits) {
        ...
        if (toks != null) {
            ...
            for (com.pullenti.ner.core.TerminToken tok : toks) {
                UnitToken res = _new1602(t0, tok.getEndToken(), (Unit)com.pullenti.unisharp.Utils.cast(tok.termin.tag, Unit.class));
                res.pow = _pow;
                if (isNeg) 
                    res.pow = -_pow;
        ...
        if (t1 != null) {
            UnitToken res = _new1602(t0, t1, UnitsHelper.UGRADUS);
            res._checkDoubt();
            t = t1.getNext();
            if (t != null && t.isComma()) 
                t = t.getNext();
        ...
        if (t.isChar('%')) {
            ...
            if ((tt1 instanceof com.pullenti.ner.TextToken) && (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt1, com.pullenti.ner.TextToken.class))).term.startsWith("ОБ")) {
                UnitToken re = _new1602(t, tt1, UnitsHelper.UALCO);
            ...
            return _new1602(t, t, UnitsHelper.UPERCENT);
        }
        if (addUnits != null) {
            com.pullenti.ner.core.TerminToken tok = addUnits.tryParse(t, com.pullenti.ner.core.TerminParseAttr.NO);
            if (tok != null) {
                UnitToken res = _new1707(t0, tok.getEndToken(), (com.pullenti.ner.measure.UnitReferent)com.pullenti.unisharp.Utils.cast(tok.termin.tag, com.pullenti.ner.measure.UnitReferent.class));
        ...
        if (mc.isUndefined()) {
            ...
            return null;
        UnitToken res1 = _new1708(t0, t1, _pow, true);
    ...
    public static UnitToken _new1602(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Unit _arg3) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.unit = _arg3;
        return res;
    }

    public static UnitToken _new1707(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, com.pullenti.ner.measure.UnitReferent _arg3) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.extOnto = _arg3;
        return res;
    }

    public static UnitToken _new1708(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, int _arg3, boolean _arg4) {
        UnitToken res = new UnitToken(_arg1, _arg2);
        res.pow = _arg3;
        res.isDoubt = _arg4;
        return res;

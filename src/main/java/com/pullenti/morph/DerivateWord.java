...
public class DerivateWord {
    ...
    public static DerivateWord _new42(DerivateGroup _arg1, String _arg2, MorphLang _arg3, MorphClass _arg4, MorphAspect _arg5, boolean _arg6, MorphTense _arg7, MorphVoice _arg8, ExplanWordAttr _arg9) {

...
public class DecreeChangeToken extends com.pullenti.ner.MetaToken {
    ...
    public static DecreeChangeToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.decree.DecreeChangeReferent main, boolean ignoreNewlines, java.util.ArrayList<com.pullenti.ner.Referent> changeStack, boolean isInEdition) {
        ...
        if (((tt instanceof com.pullenti.ner.TextToken) && t.isNewlineBefore() && !ignoreNewlines) && tt.isValue("ВНЕСТИ", "УНЕСТИ") && ((((tt.getNext() != null && tt.getNext().isValue("В", "ДО"))) || com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term, "ВНЕСТИ") || com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.TextToken.class))).term, "УНЕСТИ")))) {
            res = _new785(tt, tt, DecreeChangeTokenTyp.STARTMULTU);
        ...
        if (((!ignoreNewlines && t.isNewlineBefore() && ((tt.isValue("ПРИЗНАТЬ", "ВИЗНАТИ") || tt.isValue("СЧИТАТЬ", "ВВАЖАТИ")))) && tt.getNext() != null && tt.getNext().isValue("УТРАТИТЬ", "ВТРАТИТИ")) && tt.getNext().getNext() != null && tt.getNext().getNext().isValue("СИЛА", "ЧИННІСТЬ")) {
            res = _new786(tt, tt.getNext().getNext(), DecreeChangeTokenTyp.ACTION, com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        ...
        if ((!ignoreNewlines && ((t.isNewlineBefore() || tt == t)) && tt.isValue("УТРАТИТЬ", "ВТРАТИТИ")) && tt.getNext() != null && tt.getNext().isValue("СИЛА", "ЧИННІСТЬ")) {
            res = _new785(tt, tt.getNext(), DecreeChangeTokenTyp.UNDEFINED);
            for (tt = tt.getNext(); tt != null; tt = tt.getNext()) {
                res.setEndToken(tt);
        ...
        if (!ignoreNewlines && t.isNewlineBefore()) {
            ...
            res = _new785(tt, tt, DecreeChangeTokenTyp.STARTSINGLE);
            for (; tt != null; tt = tt.getNext()) {
                ...
                if (li == null && tt.isValue("ПРИМЕЧАНИЕ", "ПРИМІТКА")) {
                    ...
                    li.add(PartToken._new789(tt, tt, PartToken.ItemType.NOTICE));
                }
                ...
                if (tt == res.getBeginToken() && main != null) {
                    ...
                    if (npt != null) {
                        ...
                        if ((tt1 != null && tt1.isValue("ИЗЛОЖИТЬ", "ВИКЛАСТИ") && tt1.getNext() != null) && tt1.getNext().isValue("В", null)) {
                            PartToken pt = PartToken._new789(tt, npt.getEndToken(), PartToken.ItemType.APPENDIX);
        ...
        if (tok != null) {
            if (tok.termin.tag instanceof com.pullenti.ner.decree.DecreeChangeKind) {
                res = _new786(tt, tok.getEndToken(), DecreeChangeTokenTyp.ACTION, (com.pullenti.ner.decree.DecreeChangeKind)tok.termin.tag);
            ...
            if (tok.termin.tag instanceof com.pullenti.ner.decree.DecreeChangeValueKind) {
                res = _new785(tt, tok.getEndToken(), DecreeChangeTokenTyp.VALUE);
                res.changeVal = new com.pullenti.ner.decree.DecreeChangeValueReferent();
        ...
        if (((isNexChange > 0 && com.pullenti.ner.core.BracketHelper.isBracket(t, true))) || ((isNexChange > 1 && t.isValue("ПРИЛОЖЕНИЕ", "ДОДАТОК")))) {
            res = _new785(t, t, DecreeChangeTokenTyp.VALUE);
            res.changeVal = com.pullenti.ner.decree.DecreeChangeValueReferent._new794(com.pullenti.ner.decree.DecreeChangeValueKind.TEXT);
            if (isInEdition) 
                return res;
    ...
    private static java.util.ArrayList<DecreeChangeToken> tryAttachList(com.pullenti.ner.Token t) {
        ...
        for (; t != null; t = t.getNext()) {
            ...
            if (d == null) {
                ...
                if (pts != null) 
                    d = _new795(pts.get(0).getBeginToken(), pts.get(pts.size() - 1).getEndToken(), DecreeChangeTokenTyp.UNDEFINED, pts);
                else {
    ...
    public static void initialize() {
        ...
        t = com.pullenti.ner.core.Termin._new119("ИЗЛОЖИТЬ В СЛЕДУЮЩЕЙ РЕДАКЦИИ", com.pullenti.ner.decree.DecreeChangeKind.NEW);
        t.addVariant("ИЗЛОЖИВ ЕГО В СЛЕДУЮЩЕЙ РЕДАКЦИИ", false);
        t.addVariant("ИЗЛОЖИТЬ В РЕДАКЦИИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ВИКЛАСТИ В НАСТУПНІЙ РЕДАКЦІЇ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.NEW);
        ...
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПРИЗНАТЬ УТРАТИВШИМ СИЛУ", com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        t.addVariant("СЧИТАТЬ УТРАТИВШИМ СИЛУ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ВИЗНАТИ таким, що ВТРАТИВ ЧИННІСТЬ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.EXPIRE);
        t.addVariant("ВВАЖАТИ таким, що ВТРАТИВ ЧИННІСТЬ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ИСКЛЮЧИТЬ", com.pullenti.ner.decree.DecreeChangeKind.REMOVE);
        t.addVariant("ИСКЛЮЧИВ ИЗ НЕГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ВИКЛЮЧИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.REMOVE);
        t.addVariant("ВИКЛЮЧИВШИ З НЬОГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("СЧИТАТЬ", com.pullenti.ner.decree.DecreeChangeKind.CONSIDER);
        t.addVariant("СЧИТАТЬ СООТВЕТСТВЕННО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ВВАЖАТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.CONSIDER);
        t.addVariant("ВВАЖАТИ ВІДПОВІДНО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЗАМЕНИТЬ", com.pullenti.ner.decree.DecreeChangeKind.EXCHANGE);
        t.addVariant("ЗАМЕНИВ В НЕМ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ЗАМІНИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.EXCHANGE);
        t.addVariant("ЗАМІНИВШИ В НЬОМУ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ДОПОЛНИТЬ", com.pullenti.ner.decree.DecreeChangeKind.APPEND);
        t.addVariant("ДОПОЛНИВ ЕГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ДОПОВНИТИ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeKind.APPEND);
        t.addVariant("ДОПОВНИВШИ ЙОГО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("СЛОВО", com.pullenti.ner.decree.DecreeChangeValueKind.WORDS);
        t.addVariant("АББРЕВИАТУРА", false);
        t.addVariant("АБРЕВІАТУРА", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЦИФРА", com.pullenti.ner.decree.DecreeChangeValueKind.NUMBERS);
        t.addVariant("ЧИСЛО", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПРЕДЛОЖЕНИЕ", com.pullenti.ner.decree.DecreeChangeValueKind.SEQUENCE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ПРОПОЗИЦІЯ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.SEQUENCE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("СНОСКА", com.pullenti.ner.decree.DecreeChangeValueKind.FOOTNOTE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("ВИНОСКА", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.FOOTNOTE);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЛОК", com.pullenti.ner.decree.DecreeChangeValueKind.BLOCK);
        t.addVariant("БЛОК СО СЛОВАМИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("БЛОК", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.BLOCK);
        t.addVariant("БЛОК ЗІ СЛОВАМИ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new119("В СООТВЕТСТВУЮЩИХ ЧИСЛЕ И ПАДЕЖЕ", com.pullenti.ner.decree.DecreeChangeValueKind.ROBUSTWORDS);
        t.addVariant("В СООТВЕТСТВУЮЩЕМ ПАДЕЖЕ", false);
        t.addVariant("В СООТВЕТСТВУЮЩЕМ ЧИСЛЕ", false);
        m_Terms.add(t);
        t = com.pullenti.ner.core.Termin._new457("У ВІДПОВІДНОМУ ЧИСЛІ ТА ВІДМІНКУ", com.pullenti.morph.MorphLang.UA, com.pullenti.ner.decree.DecreeChangeValueKind.ROBUSTWORDS);
                    ...
                    for (PartToken np : tok.newParts) {
                        ...
                        if (np.values.size() == 0) {
                            if (eqLevVal == null) 
                                ...
                                int n;
                                com.pullenti.unisharp.Outargwrapper<Integer> wrapn818 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                                boolean inoutres819 = com.pullenti.unisharp.Utils.parseInteger(eqLevVal, 0, null, wrapn818);
                                n = (wrapn818.value != null ? wrapn818.value : 0);
                                if (inoutres819) 
    ...
    public static DecreeChangeToken _new785(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static DecreeChangeToken _new786(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3, com.pullenti.ner.decree.DecreeChangeKind _arg4) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.actKind = _arg4;
        return res;
    ...
    public static DecreeChangeToken _new795(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DecreeChangeTokenTyp _arg3, java.util.ArrayList<PartToken> _arg4) {
        DecreeChangeToken res = new DecreeChangeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.parts = _arg4;
        return res;

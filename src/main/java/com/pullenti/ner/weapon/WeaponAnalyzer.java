                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), WeaponReferent.ATTR_MODEL)) {
                            ...
                            for (int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2775 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                                    boolean inoutres2776 = com.pullenti.unisharp.Utils.tryGetValue(objsByModel, mod, wrapli2775);
                                    li = wrapli2775.value;
                                    if (!inoutres2776) 
                            ...
                            objByNames.add(com.pullenti.ner.core.Termin._new119(s.getValue().toString(), rt.referent));
                    }
                }
            }
        }

...
public class BookLinkReferent extends com.pullenti.ner.Referent {
    ...
    public int getYear() {
        int _year;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapyear397 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres398 = com.pullenti.unisharp.Utils.parseInteger((String)com.pullenti.unisharp.Utils.notnull(this.getStringValue(ATTR_YEAR), ""), 0, null, wrapyear397);
        _year = (wrapyear397.value != null ? wrapyear397.value : 0);
        if (inoutres398) 
            return _year;
        else 
            return 0;

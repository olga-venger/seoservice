                        ...
                        if (com.pullenti.unisharp.Utils.stringsEq(s.getTypeName(), TransportReferent.ATTR_MODEL)) {
                            ...
                            for (int k = 0; k < 2; k++) {
                                if (!Character.isDigit(mod.charAt(0))) {
                                    ...
                                    com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>> wrapli2675 = new com.pullenti.unisharp.Outargwrapper<java.util.ArrayList<com.pullenti.ner.Referent>>();
                                    boolean inoutres2676 = com.pullenti.unisharp.Utils.tryGetValue(objsByModel, mod, wrapli2675);
                                    li = wrapli2675.value;
                                    if (!inoutres2676) 

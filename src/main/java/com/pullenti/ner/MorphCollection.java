...
public class MorphCollection extends com.pullenti.morph.MorphBaseInfo {
    ...
    public void deserialize(com.pullenti.unisharp.Stream stream) throws java.io.IOException {
        m_Class = com.pullenti.morph.MorphClass._new64(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream));
        m_Case = com.pullenti.morph.MorphCase._new49(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream));
    ...
    private com.pullenti.morph.MorphBaseInfo deserializeItem(com.pullenti.unisharp.Stream stream) throws java.io.IOException {
        ...
        res._setClass(com.pullenti.morph.MorphClass._new64(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream)));
        res.setCase(com.pullenti.morph.MorphCase._new49(com.pullenti.ner.core.internal.SerializerHelper.deserializeShort(stream)));
    ...
    public static MorphCollection _new576(com.pullenti.morph.MorphClass _arg1) {
        MorphCollection res = new MorphCollection(null);
        res._setClass(_arg1);
        return res;
    }

    public static MorphCollection _new2285(com.pullenti.morph.MorphGender _arg1) {
        MorphCollection res = new MorphCollection(null);
        res.setGender(_arg1);
        return res;
    }

    public static MorphCollection _new2389(com.pullenti.morph.MorphCase _arg1) {
        MorphCollection res = new MorphCollection(null);
        res.setCase(_arg1);
        return res;
    }

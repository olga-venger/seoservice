...
public class ReferentClass {
    ...
    public Feature addFeature(String attrName, String attrCaption, int lowBound, int upBound) {
        Feature res = Feature._new2830(attrName, attrCaption, lowBound, upBound);
        m_Features.add(res);
    ...
    public Feature findFeature(String _name) {
        Feature res;
        com.pullenti.unisharp.Outargwrapper<Feature> wrapres2831 = new com.pullenti.unisharp.Outargwrapper<Feature>();
        boolean inoutres2832 = com.pullenti.unisharp.Utils.tryGetValue(m_Attrs, _name, wrapres2831);

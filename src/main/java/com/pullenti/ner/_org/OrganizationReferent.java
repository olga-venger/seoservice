...
public class OrganizationReferent extends com.pullenti.ner.Referent {
    ...
    private String correctName(String name, com.pullenti.unisharp.Outargwrapper<Integer> num) {
        ...
        if (Character.isDigit(name.charAt(0)) && name.indexOf(' ') > 0) {
            int i;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapi2329 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres2330 = com.pullenti.unisharp.Utils.parseInteger(name.substring(0, 0 + name.indexOf(' ')), 0, null, wrapi2329);
            i = (wrapi2329.value != null ? wrapi2329.value : 0);
            if (inoutres2330) {
                if (i > 1) {
                    num.value = i;
            ...
            if (i >= 0 && name.charAt(i) == '.') {
                ...
                boolean inoutres2331 = com.pullenti.unisharp.Utils.parseInteger(name.substring(i + 1), 0, null, num);
                if (i > 0 && inoutres2331 && num.value > 0) {
                    if (i < 1) 
                        return null;
    ...
    public void addName(String name, boolean removeLongGovNames, com.pullenti.ner.Token t) {
        int num;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2332 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        String s = this.correctName(name, wrapnum2332);
        num = (wrapnum2332.value != null ? wrapnum2332.value : 0);
        if (s == null) {
    ...
    public void addNameStr(String name, com.pullenti.ner._org.internal.OrgItemTypeToken typ, int cou) {
        ...
        if (name == null) {
            ...
            if (typ.name != null && com.pullenti.unisharp.Utils.stringsCompare(typ.name, typ.typ, true) != 0 && ((typ.name.length() > typ.typ.length() || this.findSlot(ATTR_NAME, null, true) == null))) {
                int num = 0;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2333 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                String s = this.correctName(typ.name, wrapnum2333);
                num = (wrapnum2333.value != null ? wrapnum2333.value : 0);
            ...
            if (typ == null || typ.isNotTyp) 
                ...
                if (typ.name != null) {
                    int num = 0;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapnum2334 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    String ss = this.correctName(typ.name, wrapnum2334);
                    num = (wrapnum2334.value != null ? wrapnum2334.value : 0);
                    if (ss != null) {
                        this.addTypeStr(ss);
            ...
            if (((eqNumber || eqEponyms)) && ((this.findSlot(ATTR_NAME, null, true) == null || __org.findSlot(ATTR_NAME, null, true) == null))) {
                ...
                for (java.util.Map.Entry<String, Boolean> v : getNameVars().entrySet()) {
                    if (typ == com.pullenti.ner.Referent.EqualType.DIFFERENTTEXTS && v.getValue()) 
                        continue;
                    boolean b;
                    com.pullenti.unisharp.Outargwrapper<Boolean> wrapb2336 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
                    boolean inoutres2337 = com.pullenti.unisharp.Utils.tryGetValue(__org.getNameVars(), v.getKey(), wrapb2336);
                    b = (wrapb2336.value != null ? wrapb2336.value : false);
                    if (!inoutres2337) 
                        continue;

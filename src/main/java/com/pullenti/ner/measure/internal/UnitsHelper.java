...
public class UnitsHelper {
    ...
    public static void initialize() {
        ...
        u = Unit._new1623("м", "m", "метр", "meter", com.pullenti.ner.measure.MeasureKind.LENGTH);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("МЕТР", u);
        ...
        uu = Unit._new1623("миль", "mile", "морская миля", "mile", com.pullenti.ner.measure.MeasureKind.LENGTH);
        uu.baseUnit = u;
        uu.baseMultiplier = 1852.0;
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("МИЛЯ", uu);
        t.addVariant("МОРСКАЯ МИЛЯ", false);
        t.addAbridge("NMI");
        t.addVariant("MILE", false);
        t.addVariant("NAUTICAL MILE", false);
        TERMINS.add(t);
        uu = Unit._new1627("фут", "ft", "фут", "foot", u, 0.304799472, com.pullenti.ner.measure.MeasureKind.LENGTH);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ФУТ", uu);
        t.addAbridge("FT.");
        t.addVariant("FOOT", false);
        TERMINS.add(t);
        uu = Unit._new1627("дюйм", "in", "дюйм", "inch", u, 0.0254, com.pullenti.ner.measure.MeasureKind.LENGTH);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ДЮЙМ", uu);
        t.addAbridge("IN");
        t.addVariant("INCH", false);
        TERMINS.add(t);
        u = Unit._new1623("ар", "are", "ар", "are", com.pullenti.ner.measure.MeasureKind.AREA);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("АР", u);
        t.addVariant("ARE", false);
        t.addVariant("СОТКА", false);
        TERMINS.add(t);
        uu = Unit._new1623("га", "ga", "гектар", "hectare", com.pullenti.ner.measure.MeasureKind.AREA);
        uu.baseUnit = u;
        uu.baseMultiplier = 100.0;
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ГЕКТАР", uu);
        t.addVariant("HECTARE", false);
        t.addAbridge("ГА");
        t.addAbridge("GA");
        TERMINS.add(t);
        u = Unit._new1623("г", "g", "грамм", "gram", com.pullenti.ner.measure.MeasureKind.WEIGHT);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ГРАММ", u);
        t.addAbridge("Г.");
        t.addAbridge("ГР.");
        t.addAbridge("G.");
        t.addAbridge("GR.");
        ...
        uu = Unit._new1637("ц", "centner", "центнер", "centner", u, 100000.0);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ЦЕНТНЕР", uu);
        t.addVariant("CENTNER", false);
        t.addVariant("QUINTAL", false);
        t.addAbridge("Ц.");
        TERMINS.add(t);
        uu = Unit._new1627("т", "t", "тонна", "tonne", u, 1000000.0, com.pullenti.ner.measure.MeasureKind.WEIGHT);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ТОННА", uu);
        ...
        u = Unit._new1623("л", "l", "литр", "liter", com.pullenti.ner.measure.MeasureKind.VOLUME);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ЛИТР", u);
        t.addAbridge("Л.");
        t.addAbridge("L.");
        ...
        uu = Unit._new1627("галлон", "gallon", "галлон", "gallon", u, 4.5461, com.pullenti.ner.measure.MeasureKind.VOLUME);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ГАЛЛОН", u);
        t.addVariant("ГАЛОН", false);
        t.addVariant("GALLON", false);
        t.addAbridge("ГАЛ");
        TERMINS.add(t);
        uu = Unit._new1627("баррель", "bbls", "баррель нефти", "barrel", u, 158.987, com.pullenti.ner.measure.MeasureKind.VOLUME);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("БАРРЕЛЬ", uu);
        t.addAbridge("BBLS");
        t.addVariant("БАРРЕЛЬ НЕФТИ", false);
        t.addVariant("BARRREL", false);
        TERMINS.add(t);
        USEC = (u = Unit._new1623("сек", "sec", "секунда", "second", com.pullenti.ner.measure.MeasureKind.TIME));
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("СЕКУНДА", u);
        t.addAbridge("С.");
        t.addAbridge("C.");
        t.addAbridge("СЕК");
        t.addAbridge("СЕК");
        ...
        uu = Unit._new1623("мин", "min", "минута", "minute", com.pullenti.ner.measure.MeasureKind.TIME);
        uu.baseUnit = u;
        uu.baseMultiplier = 60.0;
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("МИНУТА", uu);
        t.addAbridge("МИН.");
        t.addAbridge("MIN.");
        ...
        TERMINS.add(t);
        u = uu;
        UHOUR = (uu = Unit._new1627("ч", "h", "час", "hour", u, 60.0, com.pullenti.ner.measure.MeasureKind.TIME));
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ЧАС", uu);
        t.addAbridge("Ч.");
        t.addAbridge("H.");
        ...
        TERMINS.add(t);
        u = Unit._new1623("дн", "d", "день", "day", com.pullenti.ner.measure.MeasureKind.TIME);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ДЕНЬ", u);
        t.addAbridge("ДН.");
        t.addAbridge("Д.");
        t.addVariant("DAY", false);
        TERMINS.add(t);
        uu = Unit._new1627("нед", "week", "неделя", "week", u, 7.0, com.pullenti.ner.measure.MeasureKind.TIME);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("НЕДЕЛЯ", uu);
        t.addAbridge("НЕД");
        t.addVariant("WEEK", false);
        t.addVariant("ТИЖДЕНЬ", false);
        TERMINS.add(t);
        uu = Unit._new1627("мес", "mon", "месяц", "month", u, 30.0, com.pullenti.ner.measure.MeasureKind.TIME);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("МЕСЯЦ", uu);
        t.addAbridge("МЕС");
        t.addAbridge("MON");
        t.addVariant("MONTH", false);
        t.addVariant("МІСЯЦЬ", false);
        TERMINS.add(t);
        uu = Unit._new1627("г", "year", "год", "year", u, 365.0, com.pullenti.ner.measure.MeasureKind.TIME);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ГОД", uu);
        t.addAbridge("Г.");
        t.addAbridge("ГД");
        ...
        UNITS.add(UGRADUS);
        t = com.pullenti.ner.core.Termin._new119("ГРАДУС", UGRADUS);
        ...
        UNITS.add(UGRADUSC);
        t = com.pullenti.ner.core.Termin._new119("ГРАДУС ЦЕЛЬСИЯ", UGRADUSC);
        ...
        UNITS.add(UGRADUSF);
        t = com.pullenti.ner.core.Termin._new119("ГРАДУС ФАРЕНГЕЙТА", UGRADUSF);
        t.addVariant("ГРАДУС ПО ФАРЕНГЕЙТУ", false);
        t.addVariant("FAHRENHEIT DEGREE", false);
        TERMINS.add(t);
        UPERCENT = new Unit("%", "%", "процент", "percent");
        UNITS.add(UPERCENT);
        t = com.pullenti.ner.core.Termin._new119("ПРОЦЕНТ", UPERCENT);
        ...
        UNITS.add(UALCO);
        t = com.pullenti.ner.core.Termin._new119("ОБЪЕМНЫЙ ПРОЦЕНТ", UALCO);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ОБОРОТ", u);
        t.addAbridge("ОБ.");
        t.addAbridge("ROT.");
        t.addAbridge("REV.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ВОЛЬТ", u);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ВАТТ", u);
        t.addAbridge("Вт");
        t.addAbridge("W");
        ...
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ЛОШАДИНАЯ СИЛА", uu);
        t.addAbridge("Л.С.");
        t.addAbridge("ЛОШ.С.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ДЖОУЛЬ", u);
        t.addAbridge("ДЖ");
        t.addAbridge("J");
        ...
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("БРИТАНСКАЯ ТЕРМИНАЛЬНАЯ ЕДИНИЦА", uu);
        t.addAbridge("БТЕ");
        t.addAbridge("BTU");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("КЕЛЬВИН", u);
        t.addAbridge("К.");
        t.addAbridge("K.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ГЕРЦ", u);
        t.addAbridge("HZ");
        t.addAbridge("ГЦ");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ОМ", UOM);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("АМПЕР", u);
        t.addAbridge("A");
        t.addAbridge("А");
        ...
        TERMINS.add(t);
        uu = Unit._new1677("Ач", "Ah", "ампер-час", "ampere-hour", u, UHOUR);
        ...
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("АМПЕР ЧАС", uu);
        t.addAbridge("АЧ");
        t.addAbridge("AH");
        ...
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("ВОЛЬТ-АМПЕР", uu);
        t.addAbridge("BA");
        t.addAbridge("BA");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("БЕЛЛ", u);
        t.addAbridge("Б.");
        t.addAbridge("B.");
        t.addAbridge("В.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("DBI", u);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("DBM", u);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ФАРАД", u);
        t.addAbridge("Ф.");
        t.addAbridge("ФА");
        t.addAbridge("F");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("НЬЮТОН", u);
        t.addAbridge("Н.");
        t.addAbridge("H.");
        t.addAbridge("N.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("МОЛЬ", u);
        t.addAbridge("МЛЬ");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("БЕККЕРЕЛЬ", u);
        t.addAbridge("БК.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("СИМЕНС", u);
        t.addAbridge("СМ.");
        t.addAbridge("CM.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("КАНДЕЛА", u);
        t.addAbridge("КД.");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ПАСКАЛЬ", u);
        t.addAbridge("ПА");
        t.addAbridge("РА");
        ...
        uu = Unit._new1637("бар", "bar", "бар", "bar", u, 100000.0);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("БАР", uu);
        t.addVariant("BAR", false);
        TERMINS.add(t);
        uu = Unit._new1637("мм.рт.ст.", "mm Hg", "миллиметр ртутного столба", "millimeter of mercury", u, 133.332);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("МИЛЛИМЕТР РТУТНОГО СТОЛБА", uu);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("БИТ", u);
        ...
        uu.keywords = u.keywords;
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("БАЙТ", uu);
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("БОД", u);
        t.addAbridge("BD");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("ГРАММ СИЛА", u);
        t.addAbridge("ГС");
        ...
        TERMINS.add(t);
        uu = Unit._new1637("кгс", "kgf", "килограмм-сила", "kilogram-force", u, 1000.0);
        UNITS.add(uu);
        t = com.pullenti.ner.core.Termin._new119("КИЛОГРАММ СИЛА", uu);
        t.addAbridge("КГС");
        ...
        UNITS.add(u);
        t = com.pullenti.ner.core.Termin._new119("DOTS PER INCH", u);
    ...
    private static Unit _addFactor(UnitsFactors f, Unit u0, String abbrCyr, String abbrLat, String namesRu, String namesUa, String namesEn) {
        ...
        Unit u = Unit._new1701(prefCyr.toLowerCase() + u0.nameCyr, prefLat.toLowerCase() + u0.nameLat, prefRu.toLowerCase() + u0.fullnameCyr, prefEn.toLowerCase() + u0.fullnameLat, f, mult, u0, u0.kind, u0.keywords);
        ...
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new119(prefRu + nams[0], u);

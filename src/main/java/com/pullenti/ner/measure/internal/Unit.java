...
public class Unit {
    ...
    public static Unit _new1623(String _arg1, String _arg2, String _arg3, String _arg4, com.pullenti.ner.measure.MeasureKind _arg5) {
        Unit res = new Unit(_arg1, _arg2, _arg3, _arg4);
        res.kind = _arg5;
        return res;
    }

    public static Unit _new1627(String _arg1, String _arg2, String _arg3, String _arg4, Unit _arg5, double _arg6, com.pullenti.ner.measure.MeasureKind _arg7) {
        Unit res = new Unit(_arg1, _arg2, _arg3, _arg4);
        res.baseUnit = _arg5;
    ...
    public static Unit _new1637(String _arg1, String _arg2, String _arg3, String _arg4, Unit _arg5, double _arg6) {
        Unit res = new Unit(_arg1, _arg2, _arg3, _arg4);
        res.baseUnit = _arg5;
        res.baseMultiplier = _arg6;
        return res;
    ...
    public static Unit _new1677(String _arg1, String _arg2, String _arg3, String _arg4, Unit _arg5, Unit _arg6) {
        Unit res = new Unit(_arg1, _arg2, _arg3, _arg4);
        res.baseUnit = _arg5;
        res.multUnit = _arg6;
        return res;
    ...
    public static Unit _new1701(String _arg1, String _arg2, String _arg3, String _arg4, UnitsFactors _arg5, double _arg6, Unit _arg7, com.pullenti.ner.measure.MeasureKind _arg8, java.util.ArrayList<String> _arg9) {
        Unit res = new Unit(_arg1, _arg2, _arg3, _arg4);
        res.factor = _arg5;
        res.baseMultiplier = _arg6;
        res.baseUnit = _arg7;

...
public class DefinitionAnalyzer extends com.pullenti.ner.Analyzer {
            ...
            for (com.pullenti.ner.ExtOntologyItem it : kit.ontology.items) {
                if (it.referent instanceof DefinitionReferent) {
                    ...
                    if (!oh.containsKey(termin)) {
                        oh.put(termin, true);
                        onto.add(com.pullenti.ner.core.Termin._new1106(termin, termin));
                    }
                }
            }
    ...
    private java.util.ArrayList<com.pullenti.ner.ReferentToken> tryAttachEnd(com.pullenti.ner.Token t, com.pullenti.ner.core.TerminCollection onto, int maxChar) {
        ...
        if ((((l1.endChar - l0.endChar)) * 2) > ((r1.endChar - r0.endChar))) 
            return null;
        DefinitionReferent dr = DefinitionReferent._new1107(DefinitionKind.DEFINITION);
    ...
    private static com.pullenti.ner.MetaToken _tryAttachMiscToken(com.pullenti.ner.Token t) {
        ...
        if (t.isValue("КАК", null)) {
            ...
            if (t1 != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new828(t, t1, com.pullenti.ner.core.MiscHelper.getTextValue(t, t1, com.pullenti.ner.core.GetTextAttr.KEEPQUOTES));
        ...
        if (npt != null) {
            if (m_MiscFirstWords.tryParse(npt.noun.getBeginToken(), com.pullenti.ner.core.TerminParseAttr.NO) != null) {
                com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new828(t, npt.getEndToken(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false));
        ...
        if (t.isValue("В", null)) {
            ...
            if (npt != null) {
                if (npt.noun.isValue("СМЫСЛ", null)) {
                    com.pullenti.ner.MetaToken res = com.pullenti.ner.MetaToken._new828(t, npt.getEndToken(), com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.NO));
                    res.getMorph()._setClass(com.pullenti.morph.MorphClass.NOUN);
                    return res;
                }
            }

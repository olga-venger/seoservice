...
public class ParticipantToken extends com.pullenti.ner.MetaToken {
    ...
    public static ParticipantToken tryAttach(com.pullenti.ner.Token t, com.pullenti.ner.instrument.InstrumentParticipant p1, com.pullenti.ner.instrument.InstrumentParticipant p2, boolean isContract) {
                ...
                if (com.pullenti.unisharp.Utils.stringsEq(r1.getTypeName(), r2.getTypeName())) {
                    ...
                    for (; ttt != null; ttt = ttt.getNext()) {
                        ...
                        if (npt != null && npt.noun.isValue("СТОРОНА", null) && npt.getMorph().getNumber() != com.pullenti.morph.MorphNumber.SINGULAR) {
                            ParticipantToken re = _new1551(t, npt.getEndToken(), Kinds.NAMEDASPARTS);
                            re.parts = refs;
                            return re;
                        }
                        break;
            ...
            if ((r1 instanceof com.pullenti.ner._org.OrganizationReferent) || (r1 instanceof com.pullenti.ner.person.PersonReferent)) {
                ...
                for (com.pullenti.ner.Token ttt = (((com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class))).getBeginToken(); ttt != null && (ttt.endChar < t.endChar); ttt = ttt.getNext()) {
                    if (ttt.isChar('(')) 
                        ...
                        ParticipantToken re = _new1551(t, t, Kinds.NAMEDAS);
                ...
                for (com.pullenti.ner.Token ttt = t.getNext(); ttt != null; ttt = ttt.getNext()) {
                    ...
                    if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(ttt, false, false)) {
                        ...
                        ParticipantToken re = _new1551(t, ttt, Kinds.NAMEDAS);
                ...
                if (endSide != null || ((addRefs != null && t.getPrevious() != null && t.getPrevious().isAnd()))) {
                    ParticipantToken re = _new1551(t, (endSide != null ? endSide : t), Kinds.NAMEDAS);
                    re.typ = null;
                    re.parts = new java.util.ArrayList<com.pullenti.ner.Referent>();
                    re.parts.add(r1);
                    if (addRefs != null) 
            ...
            if (too != null && too.termin.tag != null && com.pullenti.unisharp.Utils.stringsNe(too.termin.getCanonicText(), "СТОРОНА")) {
                ...
                if (tt1 instanceof com.pullenti.ner.ReferentToken) {
                    ...
                    if ((r1 instanceof com.pullenti.ner.person.PersonReferent) || (r1 instanceof com.pullenti.ner._org.OrganizationReferent)) {
                        ParticipantToken re = _new1551(t, tt1, Kinds.NAMEDAS);
        ...
        if (br && t1.getNext() != null && com.pullenti.ner.core.BracketHelper.canBeEndOfSequence(t1.getNext(), false, null, false)) 
            t1 = t1.getNext();
        ParticipantToken res = _new1556(t, t1, (named ? Kinds.NAMEDAS : Kinds.PURE), _typ);
        if (t.isChar(':')) 
    ...
    public static void initialize() {
        ...
        for (String s : new String[] {"АРЕНДОДАТЕЛЬ", "АРЕНДАТОР", "СУБАРЕНДАТОР", "НАЙМОДАТЕЛЬ", "НАНИМАТЕЛЬ", "АГЕНТ", "ПРИНЦИПАЛ", "ПРОДАВЕЦ", "ПОКУПАТЕЛЬ", "ЗАКАЗЧИК", "ИСПОЛНИТЕЛЬ", "ПОСТАВЩИК", "ПОДРЯДЧИК", "СУБПОДРЯДЧИК", "СТОРОНА", "ЛИЦЕНЗИАР", "ЛИЦЕНЗИАТ", "СТРАХОВЩИК", "СТРАХОВАТЕЛЬ", "ПРОВАЙДЕР", "АБОНЕНТ", "ЗАСТРОЙЩИК", "УЧАСТНИК ДОЛЕВОГО СТРОИТЕЛЬСТВА", "КЛИЕНТ", "ЗАЕМЩИК", "УПРАВЛЯЮЩИЙ"}) {
            m_Ontology.add(com.pullenti.ner.core.Termin._new119(s, m_Ontology));
        }
        t = com.pullenti.ner.core.Termin._new119("ГЕНПОДРЯДЧИК", m_Ontology);
        t.addVariant("ГЕНЕРАЛЬНЫЙ ПОДРЯДЧИК", false);
        m_Ontology.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЗАИМОДАТЕЛЬ", m_Ontology);
    ...
    public static ParticipantToken _new1381(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static ParticipantToken _new1551(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        return res;
    }

    public static ParticipantToken _new1556(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, Kinds _arg3, String _arg4) {
        ParticipantToken res = new ParticipantToken(_arg1, _arg2);
        res.kind = _arg3;
        res.typ = _arg4;
        return res;

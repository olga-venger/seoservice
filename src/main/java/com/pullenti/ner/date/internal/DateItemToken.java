...
public class DateItemToken extends com.pullenti.ner.MetaToken {
    ...
    private static DateItemToken _TryAttach(com.pullenti.ner.Token t, java.util.ArrayList<DateItemToken> prev) {
        ...
        if (nt != null) {
            ...
            DateItemToken res = _new672(begin, end, DateItemType.NUMBER, nt.getIntValue(), nt.getMorph());
        ...
        if ((txt.charAt(0) == 'I' || txt.charAt(0) == 'X' || txt.charAt(0) == 'Х') || txt.charAt(0) == 'V') {
            ...
            if (lat != null && lat.getEndToken().getNext() != null && lat.getIntValue() != null) {
                ...
                if (tt.isValue("КВАРТАЛ", null) && val > 0 && val <= 4) 
                    return _new673(t, tt, DateItemType.QUARTAL, val);
                if (tt.isValue("ПОЛУГОДИЕ", "ПІВРІЧЧЯ") && val > 0 && val <= 2) 
                    return _new673(t, lat.getEndToken().getNext(), DateItemType.HALFYEAR, val);
                if (tt.isValue("ВЕК", "ВІК") || tt.isValue("СТОЛЕТИЕ", "СТОЛІТТЯ")) 
                    return _new673(t, lat.getEndToken().getNext(), DateItemType.CENTURY, val);
                if (tt.isValue("В", null) && tt.getNext() != null && tt.getNext().isChar('.')) {
                    if (prev != null && prev.size() > 0 && prev.get(prev.size() - 1).typ == DateItemType.POINTER) 
                        return _new673(t, tt.getNext(), DateItemType.CENTURY, val);
                ...
                if (tt.isHiphen()) {
                    ...
                    if ((lat2 != null && lat2.getIntValue() != null && lat2.getIntValue() > val) && lat2.getEndToken().getNext() != null) {
                        if (lat2.getEndToken().getNext().isValue("ВЕК", "ВІК") || lat2.getEndToken().getNext().isValue("СТОЛЕТИЕ", "СТОЛІТТЯ")) 
                            return _new673(t, lat.getEndToken(), DateItemType.CENTURY, val);
                    }
                }
            }
        }
        if (t != null && t.isValue("НАПРИКІНЦІ", null)) 
            return _new679(t, t, DateItemType.POINTER, "конец");
        if (t != null && t.isValue("ДОНЕДАВНА", null)) 
            return _new679(t, t, DateItemType.POINTER, "сегодня");
        ...
        if (tok != null) 
            return _new673(t, tok.getEndToken(), DateItemType.POINTER, ((com.pullenti.ner.date.DatePointerType)tok.termin.tag).value());
            ...
            if (_typ != DateItemType.NUMBER) {
                ...
                if (npt.adjectives.size() > 0) {
                    if (npt.adjectives.get(0).isValue("ПОСЛЕДНИЙ", null) || npt.adjectives.get(0).isValue("ОСТАННІЙ", null)) 
                        return _new673(t0, npt.getEndToken(), _typ, (_typ == DateItemType.QUARTAL ? 4 : 2));
                ...
                for (com.pullenti.ner.Token tt = t.getPrevious(); tt != null; tt = tt.getPrevious()) {
                    ...
                    if (_typ == DateItemType.QUARTAL) {
                        ...
                        if ((ii < 1) || ii > 4) 
                            continue;
                        return _new673(t0, npt.getEndToken(), _typ, ii);
                    }
        ...
        if (!Character.isLetterOrDigit(term.charAt(0))) {
            if (t0.isCharOf(".\\/:") || t0.isHiphen()) 
                return _new679(t0, t0, DateItemType.DELIM, term);
            else if (t0.isChar(',')) 
                return _new679(t0, t0, DateItemType.DELIM, term);
            else 
                return null;
        ...
        if (com.pullenti.unisharp.Utils.stringsEq(term, "O") || com.pullenti.unisharp.Utils.stringsEq(term, "О")) {
            if ((t.getNext() instanceof com.pullenti.ner.NumberToken) && !t.isWhitespaceAfter() && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getValue().length() == 1) 
                return _new673(t, t.getNext(), DateItemType.NUMBER, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getIntValue());
        }
        if (Character.isLetter(term.charAt(0))) {
            ...
            if (inf != null && (inf.termin.tag instanceof Integer)) 
                return _new694(inf.getBeginToken(), inf.getEndToken(), DateItemType.MONTH, (int)inf.termin.tag, inf.termin.lang);
        }
        return null;
    }
    ...
    public static void initialize() {
        ...
        com.pullenti.ner.core.Termin tt = com.pullenti.ner.core.Termin._new695("НОВАЯ ЭРА", com.pullenti.morph.MorphLang.RU, true, "НОВОЙ ЭРЫ");
        tt.addVariant("НАША ЭРА", true);
        tt.addAbridge("Н.Э.");
        m_NewAge.add(tt);
        tt = com.pullenti.ner.core.Termin._new695("НОВА ЕРА", com.pullenti.morph.MorphLang.UA, true, "НОВОЇ ЕРИ");
        ...
        m_Seasons.add(com.pullenti.ner.core.Termin._new593("ЗИМА", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.WINTER));
        m_Seasons.add(com.pullenti.ner.core.Termin._new593("WINTER", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.WINTER));
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new593("ВЕСНА", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.SPRING);
        t.addVariant("ПРОВЕСНА", true);
        m_Seasons.add(t);
        m_Seasons.add(com.pullenti.ner.core.Termin._new593("SPRING", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.SPRING));
        t = com.pullenti.ner.core.Termin._new593("ЛЕТО", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.SUMMER);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new593("ЛІТО", com.pullenti.morph.MorphLang.UA, true, com.pullenti.ner.date.DatePointerType.SUMMER);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new593("ОСЕНЬ", com.pullenti.morph.MorphLang.RU, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new593("AUTUMN", com.pullenti.morph.MorphLang.EN, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        t = com.pullenti.ner.core.Termin._new593("ОСІНЬ", com.pullenti.morph.MorphLang.UA, true, com.pullenti.ner.date.DatePointerType.AUTUMN);
        m_Seasons.add(t);
        ...
        for (int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new593(months[i], com.pullenti.morph.MorphLang.RU, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"СІЧЕНЬ", "ЛЮТИЙ", "БЕРЕЗЕНЬ", "КВІТЕНЬ", "ТРАВЕНЬ", "ЧЕРВЕНЬ", "ЛИПЕНЬ", "СЕРПЕНЬ", "ВЕРЕСЕНЬ", "ЖОВТЕНЬ", "ЛИСТОПАД", "ГРУДЕНЬ"};
        for (int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new593(months[i], com.pullenti.morph.MorphLang.UA, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"};
        for (int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new593(months[i], com.pullenti.morph.MorphLang.EN, true, i + 1);
            m_Monthes.add(t);
        }
        months = new String[] {"GENNAIO", "FEBBRAIO", "MARZO", "APRILE", "MAGGIO", "GUINGO", "LUGLIO", "AGOSTO", "SETTEMBRE", "OTTOBRE", "NOVEMBRE", "DICEMBRE"};
        for (int i = 0; i < months.length; i++) {
            t = com.pullenti.ner.core.Termin._new593(months[i], com.pullenti.morph.MorphLang.IT, true, i + 1);
            m_Monthes.add(t);
        }
        ...
        com.pullenti.ner.core.Termin te = com.pullenti.ner.core.Termin._new593("SUNDAY", com.pullenti.morph.MorphLang.EN, true, 7);
        te.addAbridge("SUN");
        ...
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("MONDAY", com.pullenti.morph.MorphLang.EN, true, 1);
        te.addAbridge("MON");
        te.addVariant("ПОНЕДЕЛЬНИК", true);
        te.addAbridge("ПОН");
        te.addVariant("ПОНЕДІЛОК", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("TUESDAY", com.pullenti.morph.MorphLang.EN, true, 2);
        te.addAbridge("TUE");
        te.addVariant("ВТОРНИК", true);
        te.addAbridge("ВТ");
        te.addVariant("ВІВТОРОК", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("WEDNESDAY", com.pullenti.morph.MorphLang.EN, true, 3);
        te.addAbridge("WED");
        te.addVariant("СРЕДА", true);
        te.addAbridge("СР");
        te.addVariant("СЕРЕДА", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("THURSDAY", com.pullenti.morph.MorphLang.EN, true, 4);
        te.addAbridge("THU");
        te.addVariant("ЧЕТВЕРГ", true);
        te.addAbridge("ЧТ");
        te.addVariant("ЧЕТВЕР", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("FRIDAY", com.pullenti.morph.MorphLang.EN, true, 5);
        te.addAbridge("FRI");
        te.addVariant("ПЯТНИЦА", true);
        te.addAbridge("ПТ");
        te.addVariant("ПЯТНИЦЯ", true);
        DAYSOFWEEK.add(te);
        te = com.pullenti.ner.core.Termin._new593("SATURDAY", com.pullenti.morph.MorphLang.EN, true, 6);
        te.addAbridge("SAT");
    ...
    public static DateItemToken _new672(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4, com.pullenti.ner.MorphCollection _arg5) {
    ...
    public static DateItemToken _new673(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.intValue = _arg4;
        return res;
    ...
    public static DateItemToken _new679(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, String _arg4) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
    ...
    public static DateItemToken _new694(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, DateItemType _arg3, int _arg4, com.pullenti.morph.MorphLang _arg5) {
        DateItemToken res = new DateItemToken(_arg1, _arg2);
        res.typ = _arg3;
        res.intValue = _arg4;
        res.lang = _arg5;

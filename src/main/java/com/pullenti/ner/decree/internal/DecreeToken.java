...
public class DecreeToken extends com.pullenti.ner.MetaToken {
    ...
    public static DecreeToken tryAttach(com.pullenti.ner.Token t, DecreeToken prev, boolean mustByTyp) {
        ...
        if (res == null) {
            ...
            if (npt != null) {
                if ((npt.getEndToken().isValue("СОБРАНИЕ", null) || npt.getEndToken().isValue("УЧАСТНИК", null) || npt.getEndToken().isValue("СОБСТВЕННИК", null)) || npt.getEndToken().isValue("УЧРЕДИТЕЛЬ", null)) {
                    res = _new834(t, npt.getEndToken(), ItemType.OWNER);
        ...
        if (res.typ == ItemType.NUMBER) {
            for (com.pullenti.ner.Token tt = res.getEndToken().getNext(); tt != null; tt = tt.getNext()) {
                ...
                if (res.children == null) 
                    res.children = new java.util.ArrayList<DecreeToken>();
                DecreeToken add = _new837(tt, tee, ItemType.NUMBER, tmp.toString());
    ...
    private static DecreeToken _TryAttach(com.pullenti.ner.Token t, DecreeToken prev, int lev, boolean mustByTyp) {
        ...
        if ((!mustByTyp && t.isValue("МЕЖДУ", "МІЖ") && (t.getNext() instanceof com.pullenti.ner.ReferentToken)) && t.getNext().getNext() != null) {
            ...
            if (t11 != null && t11.isCommaAnd() && (t11.getNext() instanceof com.pullenti.ner.ReferentToken)) {
                DecreeToken rr = _new834(t, t11.getNext(), ItemType.BETWEEN);
                rr.children = new java.util.ArrayList<DecreeToken>();
                rr.children.add(_new839(t.getNext(), t.getNext(), ItemType.OWNER, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class)));
                rr.children.add(_new839(t11.getNext(), t11.getNext(), ItemType.OWNER, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t11.getNext(), com.pullenti.ner.ReferentToken.class)));
        ...
        if (r != null && !mustByTyp) {
            if (r instanceof com.pullenti.ner.geo.GeoReferent) 
                return _new843(t, t, ItemType.TERR, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class), r.toString(true, t.kit.baseLanguage, 0));
            if (r instanceof com.pullenti.ner.date.DateReferent) {
                ...
                if (t.getPrevious() != null && t.getPrevious().getMorph()._getClass().isPreposition() && t.getPrevious().isValue("ДО", null)) 
                    return null;
                return _new839(t, t, ItemType.DATE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class));
            }
            if (r instanceof com.pullenti.ner._org.OrganizationReferent) {
                if ((t.getNext() != null && t.getNext().isValue("В", "У") && t.getNext().getNext() != null) && t.getNext().getNext().isValue("СОСТАВ", "СКЛАДІ")) 
                    return null;
                return _new843(t, t, ItemType.ORG, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.ReferentToken.class), r.toString());
            }
            if (r instanceof com.pullenti.ner.person.PersonReferent) {
                ...
                if (ok) {
                    ...
                    if (prop != null && prop.getKind() == com.pullenti.ner.person.PersonPropertyKind.BOSS) 
                        return _new839(t, t, ItemType.OWNER, new com.pullenti.ner.ReferentToken(prop, t, t, null));
                }
            }
            if (r instanceof com.pullenti.ner.person.PersonPropertyReferent) 
                return _new839(t, t, ItemType.OWNER, new com.pullenti.ner.ReferentToken(r, t, t, null));
            if (r instanceof com.pullenti.ner.denomination.DenominationReferent) {
                ...
                if (s.length() > 1 && ((s.charAt(0) == 'A' || s.charAt(0) == 'А')) && Character.isDigit(s.charAt(1))) 
                    return _new837(t, t, ItemType.NUMBER, s);
            }
            return null;
        }
        if (!mustByTyp) {
            ...
            if (tdat != null) {
                ...
                if (tdat.getReferent() instanceof com.pullenti.ner.date.DateReferent) 
                    return _new839(t, tdat, ItemType.DATE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(tdat, com.pullenti.ner.ReferentToken.class));
                com.pullenti.ner.ReferentToken dr = t.kit.processReferent("DATE", tdat);
                if (dr != null) 
                    return _new839(t, dr.getEndToken(), ItemType.DATE, dr);
            }
            if (t.isValue("НА", null) && t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner.date.DateRangeReferent)) 
                return _new839(t, t.getNext(), ItemType.DATERANGE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class));
            if (t.isChar('(')) {
                ...
                if (tt != null) {
                    ...
                    if (br != null) 
                        return _new834(t, br.getEndToken(), ItemType.EDITION);
                }
                if (t.getNext() != null && t.getNext().isValue("ПРОЕКТ", null)) 
                    return _new837(t.getNext(), t.getNext(), ItemType.TYP, "ПРОЕКТ");
                if ((t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner.date.DateRangeReferent) && t.getNext().getNext() != null) && t.getNext().getNext().isChar(')')) 
                    return _new839(t, t.getNext().getNext(), ItemType.DATERANGE, (com.pullenti.ner.ReferentToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.ReferentToken.class));
            }
            else {
                ...
                if (tt != null) {
                    ...
                    if (xxx != null) 
                        return _new834(t, tt.getPrevious(), ItemType.EDITION);
                }
            }
            if (t instanceof com.pullenti.ner.NumberToken) {
                if (prev != null && ((prev.typ == ItemType.TYP || prev.typ == ItemType.DATE))) {
                    ...
                    if (t11 != null) {
                        ...
                        if (ne != null && ((ne.typ == ItemType.DATE || ne.typ == ItemType.OWNER || ne.typ == ItemType.NAME))) 
                            return _new837(t, t11, ItemType.NUMBER, valnum);
                        ...
                        if (prev.typ == ItemType.TYP) {
                            ...
                            if (prev.typKind == com.pullenti.ner.decree.DecreeKind.STANDARD) {
                                ...
                                for (int ii = valnum.length() - 1; ii >= 0; ii--) {
                                    if (!Character.isDigit(valnum.charAt(ii))) {
                                        ...
                                        if (ss.charAt(0) == '0' && ss.length() == 2) 
                                            ...
                                            com.pullenti.unisharp.Outargwrapper<Integer> wrapnn858 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                                            boolean inoutres859 = com.pullenti.unisharp.Utils.parseInteger(ss, 0, null, wrapnn858);
                                            nn = (wrapnn858.value != null ? wrapnn858.value : 0);
                                            if (inoutres859) {
                                                if (nn > 50 && nn <= 99) 
                                                    nn += 1900;
                                ...
                                ok = true;
                            if (ok) 
                                return _new860(t, t11, ItemType.NUMBER, valnum, year);
                        }
                    }
                    if ((((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                        ...
                        if (val > 1910 && (val < 2030)) 
                            return _new837(t, t, ItemType.DATE, ((Integer)val).toString());
                    }
                }
                ...
                if (rt != null) {
                    ...
                    if (pr != null) 
                        return _new862(rt.getBeginToken(), rt.getEndToken(), ItemType.OWNER, rt, rt.getMorph());
                }
        ...
        if (toks != null) {
            for (com.pullenti.ner.core.TerminToken tok : toks) {
                    ...
                    for (com.pullenti.ner.Token tt = t.getPrevious(); tt != null && (cou < 500); tt = tt.getPrevious(),cou++) {
                        ...
                        for (com.pullenti.ner.core.TerminToken tok1 : toks) {
                            if (dr.findSlot(com.pullenti.ner.decree.DecreeReferent.ATTR_NAME, tok1.termin.getCanonicText(), true) != null) 
                                return _new863(tok.getBeginToken(), tok.getEndToken(), (ItemType)tok1.termin.tag, tok1.termin.getCanonicText(), tok1.getMorph());
                        }
                    }
                ...
                DecreeToken res = _new864(tok.getBeginToken(), tok.getEndToken(), (ItemType)tok.termin.tag, tok.termin.getCanonicText(), tok.getMorph(), doubt);
            ...
            if ((((tok = m_Termins.tryParse(t11, com.pullenti.ner.core.TerminParseAttr.NO)))) != null) {
                if ((((tok.getMorph().getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) == (com.pullenti.morph.MorphNumber.UNDEFINED.value()) || ((nnn != null && nnn.getMorph().getNumber() == com.pullenti.morph.MorphNumber.SINGULAR))) {
                    ...
                    if (npt != null && (((npt.getMorph().getNumber().value()) & (com.pullenti.morph.MorphNumber.PLURAL.value()))) != (com.pullenti.morph.MorphNumber.UNDEFINED.value())) {
                        ...
                        if (te != null) 
                            return _new839(t, tok.getEndToken(), ItemType.DECREEREF, te);
                    }
                }
            }
        }
        if (t.getMorph()._getClass().isAdjective() && t.isValue("НАСТОЯЩИЙ", "СПРАВЖНІЙ")) {
            ...
            if ((((tok = m_Termins.tryParse(t.getNext(), com.pullenti.ner.core.TerminParseAttr.NO)))) != null) 
                return _new839(t, tok.getEndToken(), ItemType.DECREEREF, null);
        }
        if (mustByTyp) 
            return null;
        if (t.getMorph()._getClass().isAdjective()) {
            ...
            if (npt != null && ((npt.getEndToken().isValue("ДОГОВОР", null) || npt.getEndToken().isValue("КОНТРАКТ", null)))) {
                dt = _new834(t, npt.getEndToken(), ItemType.TYP);
                dt.value = npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false);
            ...
            if (tryNpt) {
                if (npt != null) {
                    if (npt.getEndToken().isValue("ГАЗЕТА", null) || npt.getEndToken().isValue("БЮЛЛЕТЕНЬ", "БЮЛЕТЕНЬ")) 
                        return _new863(t, npt.getEndToken(), ItemType.TYP, npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
                    if (npt.adjectives.size() > 0 && npt.getEndToken().getMorphClassInDictionary().isNoun()) {
                        if ((((tok = m_Termins.tryParse(npt.getEndToken(), com.pullenti.ner.core.TerminParseAttr.NO)))) != null) {
                            if (npt.getBeginToken().isValue("ОБЩИЙ", "ЗАГАЛЬНИЙ")) 
                                return null;
                            return _new869(npt.getBeginToken(), tok.getEndToken(), npt.getNormalCaseText(null, true, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
                        }
                    }
                    if (prev != null && prev.typ == ItemType.TYP) {
                        if (npt.getEndToken().isValue("КОЛЛЕГИЯ", "КОЛЕГІЯ")) {
                            DecreeToken res1 = _new863(t, npt.getEndToken(), ItemType.OWNER, npt.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false), npt.getMorph());
        ...
        if (t1 != null) {
            if ((t1.getWhitespacesBeforeCount() < 15) && ((!t1.isNewlineBefore() || (t1 instanceof com.pullenti.ner.NumberToken) || _isJusNumber(t1)))) {
                ...
                if (t11 != null) {
                    ...
                    return _new837(t0, t11, ItemType.NUMBER, tmp.toString());
                }
            }
            if (t1.isNewlineBefore() && num) 
                return _new834(t0, t1.getPrevious(), ItemType.NUMBER);
        }
        if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, false, false)) {
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false) && ((((t.getNext().isValue("О", null) || t.getNext().isValue("ОБ", null) || t.getNext().isValue("ПРО", null)) || t.getNext().isValue("ПО", null) || t.chars.isCapitalUpper()) || ((prev != null && (t.getNext() instanceof com.pullenti.ner.TextToken) && ((prev.typ == ItemType.DATE || prev.typ == ItemType.NUMBER))))))) {
                ...
                if (br != null) {
                    ...
                    return _new837(br.getBeginToken(), br.getEndToken(), ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValueOfMetaToken(br, com.pullenti.ner.core.GetTextAttr.NO));
                }
                else {
                    com.pullenti.ner.Token tt1 = _tryAttachStdChangeName(t.getNext());
                    if (tt1 != null) 
                        return _new837(t, tt1, ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, tt1, com.pullenti.ner.core.GetTextAttr.NO));
                }
            }
            else if (t.isChar('(')) {
                com.pullenti.ner.core.BracketSequenceToken br = com.pullenti.ner.core.BracketHelper.tryParse(t, com.pullenti.ner.core.BracketParseAttr.NO, 100);
                if (br != null) {
                    if (!t.getNext().isValue("ДАЛЕЕ", "ДАЛІ")) {
                        if ((br.endChar - br.beginChar) < 30) 
                            return _new837(br.getBeginToken(), br.getEndToken(), ItemType.MISC, com.pullenti.ner.core.MiscHelper.getTextValueOfMetaToken(br, com.pullenti.ner.core.GetTextAttr.NO));
                    }
                }
            }
        }
        ...
        if (t.isValue("О", null) || t.isValue("ОБ", null) || t.isValue("ПРО", null)) {
            ...
            if (et != null && et.getNext() != null) {
                ...
                if (dts2 != null && dts2.get(0).typ == ItemType.TYP) {
                    ...
                    return _new837(t, et, ItemType.NAME, com.pullenti.ner.core.MiscHelper.getTextValue(t, et, com.pullenti.ner.core.GetTextAttr.NO));
                }
        ...
        if (prev != null && prev.typ == ItemType.TYP) {
            if (t.isValue("ПРАВИТЕЛЬСТВО", "УРЯД") || t.isValue("ПРЕЗИДЕНТ", null)) 
                return _new880(t, t, ItemType.OWNER, t.getMorph(), t.getNormalCaseText(null, false, com.pullenti.morph.MorphGender.UNDEFINED, false));
        }
        ...
        if (t.isValue("ВЕСТНИК", "ВІСНИК") || t.isValue("БЮЛЛЕТЕНЬ", "БЮЛЕТЕНЬ")) {
            ...
            if (npt != null) 
                return _new837(t, npt.getEndToken(), ItemType.TYP, com.pullenti.ner.core.MiscHelper.getTextValue(t, npt.getEndToken(), com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE));
            else if (t.getNext() != null && (t.getNext().getReferent() instanceof com.pullenti.ner._org.OrganizationReferent)) 
                return _new837(t, t.getNext(), ItemType.TYP, com.pullenti.ner.core.MiscHelper.getTextValue(t, t.getNext(), com.pullenti.ner.core.GetTextAttr.FIRSTNOUNGROUPTONOMINATIVE));
        }
        ...
        if ((t instanceof com.pullenti.ner.TextToken) && t.getLengthChar() == 1 && t.getNext() != null) {
            if ((com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.TextToken.class))).term, "Б") && t.getNext().isCharOf("\\/") && (t.getNext().getNext() instanceof com.pullenti.ner.TextToken)) && com.pullenti.unisharp.Utils.stringsEq((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t.getNext().getNext(), com.pullenti.ner.TextToken.class))).term, "Н")) 
                return _new837(t, t.getNext().getNext(), ItemType.NUMBER, "Б/Н");
        }
        return null;
    }
    ...
    private static com.pullenti.ner.Token _tryAttachNumber(com.pullenti.ner.Token t, StringBuilder tmp, boolean afterNum) {
        ...
        if ((res.getNext() != null && res.getNext().isHiphen() && (res.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(res.getNext().getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
            int min;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapmin886 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres887 = com.pullenti.unisharp.Utils.parseInteger(tmp.toString(), 0, null, wrapmin886);
            min = (wrapmin886.value != null ? wrapmin886.value : 0);
            if (inoutres887) {
            ...
            if (p0 == null) {
                ...
                if ((tt instanceof com.pullenti.ner.NumberToken) && res.get(res.size() - 1).typ == ItemType.DATE) {
                    if (tt.getPrevious() != null && tt.getPrevious().getMorph()._getClass().isPreposition()) {
                        ...
                        if (t11 != null) 
                            p0 = _new837(tt, t11, ItemType.NUMBER, tmp.toString());
                    }
                }
                if (p0 == null) 
                    break;
    ...
    public static DecreeToken tryAttachName(com.pullenti.ner.Token t, String _typ, boolean veryProbable, boolean inTitleDocRef) {
            ...
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t, true, false)) {
                ...
                if (br != null && br.isQuoteType()) {
                    ...
                    if ((s0.length() < 10) && com.pullenti.unisharp.Utils.stringsNe(_typ, "ПРОГРАММА") && com.pullenti.unisharp.Utils.stringsNe(_typ, "ПРОГРАМА")) 
                        return null;
                    return _new837(t, t1, ItemType.NAME, s0);
                }
        ...
        if (com.pullenti.unisharp.Utils.isNullOrEmpty(s) || (s.length() < 10)) 
            return null;
        return _new837(t, t1, ItemType.NAME, s);
    }
    ...
    public static void initialize() {
        ...
        for (String s : m_MiscTypesUA) {
            m_Keywords.add(com.pullenti.ner.core.Termin._new891(s, com.pullenti.morph.MorphLang.UA));
        }
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new114("ТЕХНИЧЕСКОЕ ЗАДАНИЕ", "ТЗ");
        t.addVariant("ТЕХЗАДАНИЕ", false);
        t.addAbridge("ТЕХ. ЗАДАНИЕ");
        m_Keywords.add(t);
        t = com.pullenti.ner.core.Termin._new114("ТЕХНИКО КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", "ТКП");
        t.addVariant("КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", false);
        m_Keywords.add(t);
        for (String s : m_AllTypesRU) {
            m_Termins.add(com.pullenti.ner.core.Termin._new119(s, ItemType.TYP));
            m_Keywords.add(com.pullenti.ner.core.Termin._new119(s, ItemType.TYP));
        }
        for (String s : m_AllTypesUA) {
            m_Termins.add(com.pullenti.ner.core.Termin._new120(s, ItemType.TYP, com.pullenti.morph.MorphLang.UA));
            m_Keywords.add(com.pullenti.ner.core.Termin._new120(s, ItemType.TYP, com.pullenti.morph.MorphLang.UA));
        }
        m_Termins.add(com.pullenti.ner.core.Termin._new119("ОТРАСЛЕВОЕ СОГЛАШЕНИЕ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new457("ГАЛУЗЕВА УГОДА", com.pullenti.morph.MorphLang.UA, ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new119("МЕЖОТРАСЛЕВОЕ СОГЛАШЕНИЕ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new457("МІЖГАЛУЗЕВА УГОДА", com.pullenti.morph.MorphLang.UA, ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new121("ОСНОВЫ ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new903("ОСНОВИ ЗАКОНОДАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new121("ОСНОВЫ ГРАЖДАНСКОГО ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        m_Termins.add(com.pullenti.ner.core.Termin._new903("ОСНОВИ ЦИВІЛЬНОГО ЗАКОНОДАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX));
        t = com.pullenti.ner.core.Termin._new145("ФЕДЕРАЛЬНЫЙ ЗАКОН", ItemType.TYP, "ФЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new907("ФЕДЕРАЛЬНИЙ ЗАКОН", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ФЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПРОЕКТ ЗАКОНА", ItemType.TYP);
        t.addVariant("ЗАКОНОПРОЕКТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ПАСПОРТ ПРОЕКТА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new457("ПРОЕКТ ЗАКОНУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        t.addVariant("ЗАКОНОПРОЕКТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new457("ПАСПОРТ ПРОЕКТУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new143("ГОСУДАРСТВЕННАЯ ПРОГРАММА", "ПРОГРАММА", ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new913("ДЕРЖАВНА ПРОГРАМА", "ПРОГРАМА", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new145("ФЕДЕРАЛЬНЫЙ КОНСТИТУЦИОННЫЙ ЗАКОН", ItemType.TYP, "ФКЗ");
        t.addVariant("КОНСТИТУЦИОННЫЙ ЗАКОН", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new907("ФЕДЕРАЛЬНИЙ КОНСТИТУЦІЙНИЙ ЗАКОН", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ФКЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("УГОЛОВНЫЙ КОДЕКС", ItemType.TYP, "УК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КРИМИНАЛЬНЫЙ КОДЕКС", ItemType.TYP, "КК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КРИМІНАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("УГОЛОВНО-ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "УПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КРИМІНАЛЬНО-ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("УГОЛОВНО-ИСПОЛНИТЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "УИК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КРИМІНАЛЬНО-ВИКОНАВЧИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ГРАЖДАНСКИЙ КОДЕКС", ItemType.TYP, "ГК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ЦИВІЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЦК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ГРАЖДАНСКИЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "ГПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ЦИВІЛЬНИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЦПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ГРАДОСТРОИТЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "ГРК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("МІСТОБУДІВНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "МБК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ХОЗЯЙСТВЕННЫЙ КОДЕКС", ItemType.TYP, "ХК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ГОСПОДАРСЬКИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ГК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ХОЗЯЙСТВЕННЫЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, "ХПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ГОСПОДАРСЬКИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ГПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("АРБИТРАЖНЫЙ ПРОЦЕССУАЛЬНЫЙ КОДЕКС", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addAbridge("АПК");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new903("АРБІТРАЖНИЙ ПРОЦЕСУАЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addAbridge("АПК");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КОДЕКС ВНУТРЕННЕГО ВОДНОГО ТРАНСПОРТА", ItemType.TYP, "КВВТ", com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addVariant("КВ ВТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ТРУДОВОЙ КОДЕКС", ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ТРУДОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("КОДЕКС ЗАКОНОВ О ТРУДЕ", "КЗОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КОДЕКС ЗАКОНІВ ПРО ПРАЦЮ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КЗПП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ЖИЛИЩНЫЙ КОДЕКС", ItemType.TYP, "ЖК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ЖИТЛОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЖК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ЗЕМЕЛЬНЫЙ КОДЕКС", ItemType.TYP, "ЗК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ЗЕМЕЛЬНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЗК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ЛЕСНОЙ КОДЕКС", ItemType.TYP, "ЛК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ЛІСОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ЛК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("БЮДЖЕТНЫЙ КОДЕКС", ItemType.TYP, "БК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("БЮДЖЕТНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "БК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("НАЛОГОВЫЙ КОДЕКС", ItemType.TYP, "НК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ПОДАТКОВИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("СЕМЕЙНЫЙ КОДЕКС", ItemType.TYP, "СК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("СІМЕЙНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "СК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ВОДНЫЙ КОДЕКС", ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ВОДНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ВОЗДУШНЫЙ КОДЕКС", ItemType.TYP, "ВК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ПОВІТРЯНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КОДЕКС ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.TYP, "КОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КОДЕКС ПРО АДМІНІСТРАТИВНІ ПРАВОПОРУШЕННЯ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.STDNAME);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new457("ПРО АДМІНІСТРАТИВНІ ПРАВОПОРУШЕННЯ", com.pullenti.morph.MorphLang.UA, ItemType.STDNAME);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КОДЕКС ОБ АДМИНИСТРАТИВНЫХ ПРАВОНАРУШЕНИЯХ", ItemType.TYP, "КРКОАП", com.pullenti.ner.decree.DecreeKind.KODEX);
        t.addVariant("КРК ОБ АП", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КОДЕКС АДМИНИСТРАТИВНОГО СУДОПРОИЗВОДСТВА", ItemType.TYP, "КАС", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КОДЕКС АДМІНІСТРАТИВНОГО СУДОЧИНСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КАС", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ТАМОЖЕННЫЙ КОДЕКС", ItemType.TYP, "ТК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("МИТНИЙ КОДЕКС", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "МК", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("КОДЕКС ТОРГОВОГО МОРЕПЛАВАНИЯ", ItemType.TYP, "КТМ", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("КОДЕКС ТОРГОВЕЛЬНОГО МОРЕПЛАВСТВА", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "КТМ", com.pullenti.ner.decree.DecreeKind.KODEX);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new916("ПРАВИЛА ДОРОЖНОГО ДВИЖЕНИЯ", ItemType.TYP, "ПДД", "ПРАВИЛА");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new918("ПРАВИЛА ДОРОЖНЬОГО РУХУ", com.pullenti.morph.MorphLang.UA, ItemType.TYP, "ПДР", "ПРАВИЛА");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("СОБРАНИЕ ЗАКОНОДАТЕЛЬСТВА", ItemType.TYP);
        t.addAbridge("СЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ОФИЦИАЛЬНЫЙ ВЕСТНИК", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new457("ОФІЦІЙНИЙ ВІСНИК", com.pullenti.morph.MorphLang.UA, ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("СВОД ЗАКОНОВ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЮЛЛЕТЕНЬ НОРМАТИВНЫХ АКТОВ ФЕДЕРАЛЬНЫХ ОРГАНОВ ИСПОЛНИТЕЛЬНОЙ ВЛАСТИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЮЛЛЕТЕНЬ МЕЖДУНАРОДНЫХ ДОГОВОРОВ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЮЛЛЕТЕНЬ ВЕРХОВНОГО СУДА", ItemType.TYP);
        t.addVariant("БЮЛЛЕТЕНЬ ВС", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ВЕСТНИК ВЫСШЕГО АРБИТРАЖНОГО СУДА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ВЕСТНИК БАНКА РОССИИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("РОССИЙСКАЯ ГАЗЕТА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("РОССИЙСКИЕ ВЕСТИ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("СОБРАНИЕ АКТОВ ПРЕЗИДЕНТА И ПРАВИТЕЛЬСТВА", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ВЕДОМОСТИ ВЕРХОВНОГО СОВЕТА", ItemType.TYP);
        t.addVariant("ВЕДОМОСТИ ВС", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ВЕДОМОСТИ СЪЕЗДА НАРОДНЫХ ДЕПУТАТОВ И ВЕРХОВНОГО СОВЕТА", ItemType.TYP);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("БЮЛЛЕТЕНЬ НОРМАТИВНЫХ АКТОВ МИНИСТЕРСТВ И ВЕДОМСТВ", ItemType.TYP);
        m_Termins.add(t);
        m_Termins.add(com.pullenti.ner.core.Termin._new119("СВОД ЗАКОНОВ", ItemType.TYP));
        m_Termins.add(com.pullenti.ner.core.Termin._new119("ВЕДОМОСТИ", ItemType.TYP));
        t = com.pullenti.ner.core.Termin._new143("ЗАРЕГИСТРИРОВАТЬ", "РЕГИСТРАЦИЯ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new987("ЗАРЕЄСТРУВАТИ", com.pullenti.morph.MorphLang.UA, "РЕЄСТРАЦІЯ", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("СТАНДАРТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("МЕЖДУНАРОДНЫЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new145("ЕДИНЫЙ ОТРАСЛЕВОЙ СТАНДАРТ ЗАКУПОК", ItemType.TYP, "ЕОСЗ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new119("ЕДИНЫЙ ОТРАСЛЕВОЙ ПОРЯДОК", ItemType.TYP);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("ГОСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        ...
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("ОСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ОТРАСЛЕВОЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("ПНСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПРЕДВАРИТЕЛЬНЫЙ НАЦИОНАЛЬНЫЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("РСТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("РЕСПУБЛИКАНСКИЙ СТАНДАРТ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("ПБУ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПОЛОЖЕНИЕ ПО БУХГАЛТЕРСКОМУ УЧЕТУ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("ISO", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ИСО", false);
        t.addVariant("ISO/IEC", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ТЕХНИЧЕСКИЕ УСЛОВИЯ", "ТУ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ТЕХУСЛОВИЯ", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ФЕДЕРАЛЬНЫЕ НОРМЫ И ПРАВИЛА", "ФНП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("НОРМАТИВНЫЕ ПРАВИЛА", "НП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("СТРОИТЕЛЬНЫЕ НОРМЫ И ПРАВИЛА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("СНИП", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("СТРОИТЕЛЬНЫЕ НОРМЫ", "СН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("CH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ВЕДОМСТВЕННЫЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "ВСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("BCH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("РЕСПУБЛИКАНСКИЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "РСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("PCH", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ПРАВИЛА БЕЗОПАСНОСТИ", "ПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("НОРМЫ РАДИАЦИОННОЙ БЕЗОПАСНОСТИ", "НРБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ПРАВИЛА РАДИАЦИОННОЙ БЕЗОПАСНОСТИ", "ПРБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("НОРМЫ ПОЖАРНОЙ БЕЗОПАСНОСТИ", "НПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ПРАВИЛА ПОЖАРНОЙ БЕЗОПАСНОСТИ", "ППБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("СТРОИТЕЛЬНЫЕ ПРАВИЛА", "СП", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("МОСКОВСКИЕ ГОРОДСКИЕ СТРОИТЕЛЬНЫЕ НОРМЫ", "МГСН", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("АВОК", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ABOK", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ТЕХНИЧЕСКИЙ РЕГЛАМЕНТ", "ТР", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ОБЩИЕ ПРАВИЛА БЕЗОПАСНОСТИ", "ОПБ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ПРАВИЛА ЯДЕРНОЙ БЕЗОПАСНОСТИ", "ПБЯ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("СТАНДАРТ ОРГАНИЗАЦИИ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("СТО", false);
        t.addVariant("STO", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ПРАВИЛА ПО ОХРАНЕ ТРУДА", "ПОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ПРАВИЛА ОХРАНЫ ТРУДА", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("ИНСТРУКЦИЯ ПО ОХРАНЕ ТРУДА", "ИОТ", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("ИНСТРУКЦИЯ ОХРАНЫ ТРУДА", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new938("РУКОВОДЯЩИЙ ДОКУМЕНТ", "РД", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new121("САНИТАРНЫЕ НОРМЫ И ПРАВИЛА", ItemType.TYP, com.pullenti.ner.decree.DecreeKind.STANDARD);
        t.addVariant("САНПИН", false);
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new145("ТЕХНИЧЕСКОЕ ЗАДАНИЕ", ItemType.TYP, "ТЗ");
        t.addVariant("ТЕХЗАДАНИЕ", false);
        t.addAbridge("ТЕХ. ЗАДАНИЕ");
        m_Termins.add(t);
        t = com.pullenti.ner.core.Termin._new114("ТЕХНИКО КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ", "ТКП");
    ...
    public static void addNewType(String _typ, String acronym) {
        com.pullenti.ner.core.Termin t = com.pullenti.ner.core.Termin._new145(_typ, ItemType.TYP, acronym);
        m_Termins.add(t);
        m_Keywords.add(com.pullenti.ner.core.Termin._new119(_typ, ItemType.TYP));
    }
    ...
    public static DecreeToken _new834(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static DecreeToken _new837(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        return res;
    ...
    public static DecreeToken _new839(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        return res;
    ...
    public static DecreeToken _new843(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4, String _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.value = _arg5;
    ...
    public static DecreeToken _new860(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, int _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.numYear = _arg5;
    ...
    public static DecreeToken _new862(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.ReferentToken _arg4, com.pullenti.ner.MorphCollection _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.ref = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new863(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new864(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, String _arg4, com.pullenti.ner.MorphCollection _arg5, boolean _arg6) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.value = _arg4;
        res.setMorph(_arg5);
    ...
    public static DecreeToken _new869(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3, com.pullenti.ner.MorphCollection _arg4) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.value = _arg3;
        res.setMorph(_arg4);
        return res;
    ...
    public static DecreeToken _new880(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, com.pullenti.ner.MorphCollection _arg4, String _arg5) {
        DecreeToken res = new DecreeToken(_arg1, _arg2);
        res.typ = _arg3;
        res.setMorph(_arg4);
        res.value = _arg5;

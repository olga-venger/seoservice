...
public class PartToken extends com.pullenti.ner.MetaToken {
    ...
    public static class PartValue extends com.pullenti.ner.MetaToken {
        ...
        public int getIntValue() {
            if (com.pullenti.unisharp.Utils.isNullOrEmpty(value)) 
                return 0;
            int num;
            com.pullenti.unisharp.Outargwrapper<Integer> wrapnum1024 = new com.pullenti.unisharp.Outargwrapper<Integer>();
            boolean inoutres1025 = com.pullenti.unisharp.Utils.parseInteger(value, 0, null, wrapnum1024);
            num = (wrapnum1024.value != null ? wrapnum1024.value : 0);
            if (inoutres1025) 
                return num;
            return 0;
        }
        ...
        public void correctValue() {
            ...
            for (com.pullenti.ner.Token t = getEndToken().getNext(); t != null; t = t.getNext()) {
                ...
                if ((t.isHiphen() && !t.isWhitespaceAfter() && (t.getNext() instanceof com.pullenti.ner.NumberToken)) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t.getNext(), com.pullenti.ner.NumberToken.class))).getIntValue() != null) {
                    int n1;
                    com.pullenti.unisharp.Outargwrapper<Integer> wrapn11026 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                    boolean inoutres1027 = com.pullenti.unisharp.Utils.parseInteger(value, 0, null, wrapn11026);
                    n1 = (wrapn11026.value != null ? wrapn11026.value : 0);
                    if (inoutres1027) {
        ...
        public static PartValue _new1028(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, String _arg3) {
    ...
    public static PartToken tryAttach(com.pullenti.ner.Token t, PartToken prev, boolean inBracket, boolean ignoreNumber) {
        ...
        if ((t instanceof com.pullenti.ner.NumberToken) && t.getNext() != null && (t.getWhitespacesAfterCount() < 3)) {
            ...
            if (re != null) {
                ...
                if (ok1 || inBracket) {
                    re.setBeginToken(t);
                    re.values.add(PartValue._new1028(t, t, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue().toString()));
                    return re;
                }
            }
        }
        if (((t instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && prev == null) && t.getPrevious() != null) {
                ...
                if (t0.isChar('(') && t.getNext() != null) {
                    if (t.getNext().isValue("ЧАСТЬ", null) || t.getNext().isValue("Ч", null)) {
                        ...
                        if (te.getNext() != null && te.getNext().isChar('.')) 
                            te = te.getNext();
                        res = _new789(t, te, ItemType.PART);
                        res.values.add(PartValue._new1028(t, t, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue().toString()));
                        return res;
                    }
                }
                return null;
            ...
            if (dr.getClause() == null) 
                return null;
            res = _new1031(t, t, ItemType.CLAUSE, !delim);
            PartValue pv = PartValue._new1028(t, t, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).getValue().toString());
            res.values.add(pv);
        ...
        if (((t instanceof com.pullenti.ner.NumberToken) && (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t, com.pullenti.ner.NumberToken.class))).typ == com.pullenti.ner.NumberSpellingType.DIGIT && prev != null) && prev.typ == ItemType.PREFIX && (t.getWhitespacesBeforeCount() < 3)) {
            ...
            if (ne != null && ne.typ == DecreeToken.ItemType.TYP) 
                ...
                ok = true;
            if (ok) {
                res = _new789(t, pv.getEndToken(), ItemType.ITEM);
                res.values.add(pv);
                return res;
            }
        }
        ...
        if (res != null) 
            ...
            if (t1.isValue("СИЛУ", null) && t1.getPrevious() != null && t1.getPrevious().getMorph()._getClass().isVerb()) 
                return null;
            res = _new789(t1, t1, ItemType.PREFIX);
            ...
            if (t1.getNext() != null && t1.getNext().isValue("ПО", null)) 
                t1 = t1.getNext();
            return _new789(t, t1, ItemType.PREFIX);
        }
            ...
            PartToken rr = _new789(t1, t1.getNext(), ItemType.PART);
            rr.values.add(PartValue._new1028(t1, t1, (t1.isValue("МОТИВИРОВОЧНЫЙ", null) || t1.isValue("МОТИВУВАЛЬНИЙ", null) ? "мотивировочная" : "резолютивная")));
            return rr;
        }
        if (res == null) 
            return null;
        ...
        while (t1 != null) {
            ...
            if (com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t1, false, false)) {
                ...
                for (com.pullenti.ner.Token ttt = t1.getNext(); ttt != null; ttt = ttt.getNext()) {
                    ...
                    if (ttt instanceof com.pullenti.ner.NumberToken) {
                        ...
                        newP.add(PartValue._new1028(ttt, ttt, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(ttt, com.pullenti.ner.NumberToken.class))).getValue().toString()));
                        continue;
                    }
                    ...
                    if (newP == null) 
                        newP = new java.util.ArrayList<PartValue>();
                    PartValue pv = PartValue._new1028(ttt, ttt, to.term);
                ...
                if (t1 != null && t1.isHiphen() && com.pullenti.ner.core.BracketHelper.canBeStartOfSequence(t1.getNext(), false, false)) {
                    ...
                    if ((br1 != null && (t1.getNext().getNext() instanceof com.pullenti.ner.TextToken) && t1.getNext().getNext().getLengthChar() == 1) && t1.getNext().getNext().getNext() == br1.getEndToken()) {
                        res.values.add(PartValue._new1028(br1.getBeginToken(), br1.getEndToken(), (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t1.getNext().getNext(), com.pullenti.ner.TextToken.class))).term));
            ...
            if (((t1 instanceof com.pullenti.ner.TextToken) && t1.getLengthChar() == 1 && t1.chars.isLetter()) && res.values.size() == 0) {
                if (t1.chars.isAllUpper() && res.typ == ItemType.SUBPROGRAM) {
                    res.values.add(PartValue._new1028(t1, t1, (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t1, com.pullenti.ner.TextToken.class))).term));
                    res.setEndToken(t1);
                    return res;
                }
                boolean ok = true;
                ...
                if (ok && t1.getNext() != null && t1.getNext().isChar(')')) {
                    res.values.add(PartValue._new1028(t1, t1.getNext(), (((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t1, com.pullenti.ner.TextToken.class))).term));
                    res.setEndToken(t1.getNext());
                ...
                if (((ok && t1.getNext() != null && t1.getNext().isChar('.')) && !t1.getNext().isWhitespaceAfter() && (t1.getNext().getNext() instanceof com.pullenti.ner.NumberToken)) && t1.getNext().getNext().getNext() != null && t1.getNext().getNext().getNext().isChar(')')) {
                    res.values.add(PartValue._new1028(t1, t1.getNext().getNext().getNext(), ((((com.pullenti.ner.TextToken)com.pullenti.unisharp.Utils.cast(t1, com.pullenti.ner.TextToken.class))).term + "." + (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t1.getNext().getNext(), com.pullenti.ner.NumberToken.class))).getValue())));
            ...
            if (t1 instanceof com.pullenti.ner.NumberToken) {
                ...
                PartValue val = PartValue._new1028(tt0, t1, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(t1, com.pullenti.ner.NumberToken.class))).getValue().toString());
                val.correctValue();
                res.values.add(val);
            ...
            if (nt != null) {
                PartValue pv = PartValue._new1028(t1, nt.getEndToken(), nt.getValue().toString());
                res.values.add(pv);
                pv.correctValue();
            ...
            if ((t1 == tt1 && ((res.typ == ItemType.APPENDIX || res.typ == ItemType.ADDAGREE)) && t1.isValue("К", null)) && t1.getNext() != null && (t1.getNext().getReferent() instanceof com.pullenti.ner.decree.DecreeReferent)) {
                res.values.add(PartValue._new1028(t1, t1, ""));
                break;
            }
            if (res.typ == ItemType.ADDAGREE && firstNumPrefix != null && res.values.size() == 0) {
                ...
                if (ddd != null && ddd.typ == DecreeToken.ItemType.NUMBER && ddd.value != null) {
                    res.values.add(PartValue._new1028(t1, ddd.getEndToken(), ddd.value));
            ...
            if (t1.isHiphen()) {
                ...
                if ((max - min) > 200) 
                    break;
                PartValue val = PartValue._new1028(t1.getNext(), t1.getNext(), ((Integer)max).toString());
                val.correctValue();
                res.values.add(val);
                res.setEndToken(val.getEndToken());
                t1 = res.getEndToken().getNext();
    ...
    private static PartToken _createPartTyp0(com.pullenti.ner.Token t1, PartToken prev) {
        boolean isShort;
        com.pullenti.unisharp.Outargwrapper<Boolean> wrapisShort1050 = new com.pullenti.unisharp.Outargwrapper<Boolean>();
        PartToken pt = __createPartTyp(t1, prev, wrapisShort1050);
        isShort = (wrapisShort1050.value != null ? wrapisShort1050.value : false);
        if (pt == null) 
            return null;
    ...
    private static PartToken __createPartTyp(com.pullenti.ner.Token t1, PartToken prev, com.pullenti.unisharp.Outargwrapper<Boolean> isShort) {
        ...
        if (t1.isValue("ЧАСТЬ", "ЧАСТИНА")) 
            return _new789(t1, t1, ItemType.PART);
        ...
        if (t1.isValue("ГЛАВА", null) || t1.isValue("ГЛ", null)) {
            ...
            return _new789(t1, t1, ItemType.CHAPTER);
        }
        if (t1.isValue("ПРИЛОЖЕНИЕ", "ДОДАТОК") || t1.isValue("ПРИЛ", null)) {
            ...
            return _new789(t1, t1, ItemType.APPENDIX);
        }
        if (t1.isValue("ПРИМЕЧАНИЕ", "ПРИМІТКА") || t1.isValue("ПРИМ", null)) {
            isShort.value = t1.getLengthChar() < 5;
            return _new789(t1, t1, ItemType.NOTICE);
        }
        if (t1.isValue("СТАТЬЯ", "СТАТТЯ") || t1.isValue("СТ", null)) {
            isShort.value = t1.getLengthChar() < 3;
            return _new789(t1, t1, ItemType.CLAUSE);
        }
        if (t1.isValue("ПУНКТ", null) || t1.isValue("П", null) || t1.isValue("ПП", null)) {
            isShort.value = t1.getLengthChar() < 3;
            return _new1057(t1, t1, ItemType.ITEM, (t1.isValue("ПП", null) ? ItemType.SUBITEM : ItemType.UNDEFINED));
        }
        if (t1.isValue("ПОДПУНКТ", "ПІДПУНКТ")) 
            return _new789(t1, t1, ItemType.SUBITEM);
        if (t1.isValue("ПРЕАМБУЛА", null)) 
            return _new789(t1, t1, ItemType.PREAMBLE);
        ...
        if (t1.isValue("РАЗДЕЛ", "РОЗДІЛ") || t1.isValue("РАЗД", null)) {
            isShort.value = t1.getLengthChar() < 5;
            return _new789(t1, t1, ItemType.SECTION);
        }
        ...
        if (((t1.isValue("ДОП", null) || t1.isValue("ДОПОЛНИТЕЛЬНЫЙ", "ДОДАТКОВА"))) && t1.getNext() != null) {
            ...
            if (tt.isValue("СОГЛАШЕНИЕ", "УГОДА")) 
                return _new789(t1, tt, ItemType.ADDAGREE);
        }
        return null;
    }
    ...
    public static java.util.ArrayList<PartToken> tryAttachList(com.pullenti.ner.Token t, boolean inBracket, int maxCount) {
                            ...
                            if (li.get(li.size() - 1).getEndToken().getNext() == br.getEndToken()) {
                                if (p.values.size() > 1) {
                                    for (int ii = 1; ii < p.values.size(); ii++) {
                                        PartToken pp = _new789(p.values.get(ii).getBeginToken(), (ii == (p.values.size() - 1) ? p.getEndToken() : p.values.get(ii).getEndToken()), p.typ);
            ...
            if (p0 == null) {
                ...
                if ((tt instanceof com.pullenti.ner.NumberToken) && delim) {
                    ...
                    if (p.typ == ItemType.CLAUSE || inBracket) 
                        p0 = _new789(tt, tt, ItemType.CLAUSE);
                        ...
                        p0 = _new789(tt, tt, res.get(res.size() - 1).typ);
                    if (p0 == null) 
                        break;
                    PartValue vv = PartValue._new1028(tt, tt, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).getValue().toString());
                    p0.values.add(vv);
                    vv.correctValue();
                    ...
                    if (tt != null && tt.isHiphen() && ((tt.getNext() instanceof com.pullenti.ner.NumberToken))) {
                        tt = tt.getNext();
                        vv = PartValue._new1028(tt, tt, (((com.pullenti.ner.NumberToken)com.pullenti.unisharp.Utils.cast(tt, com.pullenti.ner.NumberToken.class))).getValue().toString());
                        vv.correctValue();
                        p0.values.add(vv);
                        p0.setEndToken(vv.getEndToken());
                        tt = p0.getEndToken().getNext();
        ...
        for (int i = 0; i < (res.size() - 1); i++) {
            if (res.get(i).typ == ItemType.PART && res.get(i + 1).typ == ItemType.PART && res.get(i).values.size() > 1) {
                ...
                if ((v2 - v1) < 10) 
                    continue;
                PartToken pt = _new789(res.get(i).getEndToken(), res.get(i).getEndToken(), ItemType.CLAUSE);
                pt.values.add(PartValue._new1028(res.get(i).getEndToken(), res.get(i).getEndToken(), ((Integer)v2).toString()));
    ...
    public static int getNumber(String str) {
        if (com.pullenti.unisharp.Utils.isNullOrEmpty(str)) 
            return 0;
        int i;
        com.pullenti.unisharp.Outargwrapper<Integer> wrapi1085 = new com.pullenti.unisharp.Outargwrapper<Integer>();
        boolean inoutres1086 = com.pullenti.unisharp.Utils.parseInteger(str, 0, null, wrapi1085);
        i = (wrapi1085.value != null ? wrapi1085.value : 0);
        if (inoutres1086) 
            return i;
        ...
        if (((int)ch) < 0x80) {
            ...
            if ((ch == 'Z' && str.length() > 2 && str.charAt(1) == '.') && Character.isDigit(str.charAt(2))) {
                int n;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapn1081 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1082 = com.pullenti.unisharp.Utils.parseInteger(str.substring(2), 0, null, wrapn1081);
                n = (wrapn1081.value != null ? wrapn1081.value : 0);
                if (inoutres1082) 
                    i += n;
            }
        }
            ...
            if ((ch == 'Я' && str.length() > 2 && str.charAt(1) == '.') && Character.isDigit(str.charAt(2))) {
                int n;
                com.pullenti.unisharp.Outargwrapper<Integer> wrapn1083 = new com.pullenti.unisharp.Outargwrapper<Integer>();
                boolean inoutres1084 = com.pullenti.unisharp.Utils.parseInteger(str.substring(2), 0, null, wrapn1083);
                n = (wrapn1083.value != null ? wrapn1083.value : 0);
                if (inoutres1084) 
                    i += n;
            }
        }
    ...
    public static PartToken _new789(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3) {
        PartToken res = new PartToken(_arg1, _arg2);
        res.typ = _arg3;
        return res;
    }

    public static PartToken _new1031(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, boolean _arg4) {
        PartToken res = new PartToken(_arg1, _arg2);
        res.typ = _arg3;
        res.isDoubt = _arg4;
        return res;
    ...
    public static PartToken _new1057(com.pullenti.ner.Token _arg1, com.pullenti.ner.Token _arg2, ItemType _arg3, ItemType _arg4) {
        PartToken res = new PartToken(_arg1, _arg2);
        res.typ = _arg3;
        res.altTyp = _arg4;
        return res;
